...
## <a name="deploy-an-office-add-in-using-the-admin-center"></a>نشر وظيفة Office إضافية باستخدام مركز الإدارة 
...
تجمع Office الوظائف الإضافية ملف بيان XML الذي يحتوي على بعض بيانات التعريف حول الوظيفة الإضافية، ولكن الأهم من ذلك يشير إلى تطبيق ويب يحتوي على جميع التعليمات البرمجية والمنطق. يمكن أن تتراوح الوظائف الإضافية بين إمكانياتها. على سبيل المثال، يمكن للوظائف الإضافية:
- عرض البيانات. 
