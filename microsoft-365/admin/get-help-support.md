...
استخدم القائمة المنسدلة أدناه للعثور على الرقم الخاص ببلدك أو منطقتك.

[!INCLUDE [country-region-support-dropdown-list](../admin/includes/country-region-support-dropdown-list.md)]

يتم سرد ساعات دعم الفوترة والدعم التقني (واللغات) في صفحة كل بلد محددة من القائمة المنسدلة.
