...
تتمثل إحدى أفضل الطرق لإعداد تخزين الملفات ومشاركتها لعملك في استخدام OneDrive وموقع فريق معا. يعد هذا مثاليا إذا كان لديك شركة صغيرة مع عدد قليل من الموظفين.
...
يوفر كل من OneDrive ومواقع الفريق وصولا إلى أي مكان لك ولموظفيك.
  
![رسم تخطيطي يوضح كيفية استخدام منتجات Microsoft 365 OneDrive أو مواقع الفريق.](../../media/7493131e-665f-4dbd-9a60-f5612aea7e42.png)
...
يحصل كل شخص في شركتك لديه ترخيص Microsoft 365 معين (SharePoint Online محدد) على OneDrive التخزين السحابي. يمكنهم تخزين الملفات المتعلقة بالأعمال هنا للوصول إليها من أي جهاز، وهي متوفرة فقط لهذا المستخدم. على سبيل المثال، قد يخزنون مسودة اقتراح أو ملاحظات اجتماعهم أو البرنامج النصي لعرض توضيحي سيتم تقديمه.
  
يمكن للموظفين أيضا مشاركة OneDrive الملفات والمجلدات. إذا كان أحد الموظفين بالخارج أو غادر الشركة، يمكن للآخرين الوصول إلى الملفات المشتركة المخزنة في OneDrive (OneDrive مشاركة مجلد الفريق).
...
3. إذا تمت مطالبتك بتبديل التطبيقات، فاختر **"نعم**". OneDrive هي العملية التي تقوم بالمزامنة.
...
5. إذا لم تكن قد قمت بعد بمزامنة OneDrive، فقد ترى **أن هذه هي شاشة مجلد OneDrive**. تحقق من المسار الموجود أسفل **مجلد OneDrive الخاص بك هنا**. اختر **"تغيير الموقع** " إذا كنت تريد استخدام مسار مختلف، ثم حدد **"التالي**".
...
- **الملكية المشتركة**: يستخدم المالكان OneDrive ومشاركة الملفات ذهابا وإيابا.
...
عند تخزين ملف في OneDrive يمكن الوصول إليه فقط من قبلك، إلا إذا قمت بمشاركته مع الآخرين. عند مشاركة الملفات، يمكنك اختيار إنشاء ارتباط يمكن إعادة توجيهه، أو مشاركته مع أشخاص محددين فقط. يمكنك أيضا إنشاء مجلدات منفصلة في OneDrive لأغراض مختلفة مثل المشاريع العامة أو الشخصية أو الفردية. يمكن مشاركة كل مجلد مع شخص أو مجموعة مختلفة، أو لا يمكن لأي شخص آخر على الإطلاق.
...
لمعرفة مقدار مساحة التخزين التي تركتها في OneDrive، راجع [إدارة مساحة التخزين OneDrive for Business](https://support.microsoft.com/office/31519161-059C-4764-B6F8-F5CD29F7FE68).
...
2. انتقل إلى صفحة إعدادات **الإعدادات** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=2053743" target="_blank">**Org**</a>.
...
- **إعداد تطبيقات Office على أجهزة الكمبيوتر اللوحية والهواتف.** تحتاج إلى القيام بذلك حتى تتمكن من **تحرير** الملفات المخزنة في OneDrive وعلى مواقع الفريق من الكمبيوتر اللوحي أو الهاتف. إذا لم تقم بتثبيت تطبيقات Office للكمبيوتر اللوحي أو الهاتف، فستتمكن من عرض الملفات ولكن ليس تحريرها.
  ...
  - [تثبيت Office وإعدادها على نظام Android باستخدام Microsoft 365](https://support.microsoft.com/office/cafe9d6f-8b0c-4b03-b20a-12438a82a22d)

  - [تثبيت Office وإعدادها على iPhone أو iPad باستخدام Microsoft 365](https://support.microsoft.com/office/9df6d10c-7281-4671-8666-6ca8e339b628)
