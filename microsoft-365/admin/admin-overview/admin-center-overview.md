...
|**المجموعات**|إنشاء المجموعات في مؤسستك وإدارتها، مثل مجموعه Microsoft 365 أومجموعة التوزيع أو مجموعة الأمان أو علبة البريد المشتركة. تعرف على كيفية [إنشاء](../create-groups/create-groups.md) المجموعات و[إدارتها](../create-groups/manage-groups.md).|
...
|**التقارير**|إلقاء نظرة سريعة على كيفية استخدام Microsoft 365 في مؤسستك مع الاطلاع على تقارير مفصّلة حول استخدام البريد الإلكتروني وعمليات تنشيط Office والمزيد غير ذلك. تعرّف على كيفية استخدام [تقارير النشاط](../activity-reports/activity-reports.md) الجديدة.|
