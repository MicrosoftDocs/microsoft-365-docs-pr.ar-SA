...
|:-----|:-----|:-----|
|الخدمات والتطبيقات المتوفرة  <br/> |استخدم Word، Excel، PowerPoint، OneDrive، Teams، Access. هذه المجموعة من التطبيقات هي الأفضل للشركات الصغيرة جدا التي لا تحتاج إلى البريد الإلكتروني الذي تحمل علامة تجارية مباشرة، أو التي تستخدم البريد الإلكتروني الذي تحمل علامة تجارية من موفر آخر ولا تنوي التبديل لاستخدام Microsoft Exchange.  سوف تستخدم Outlook مع حساب بريدك الإلكتروني الموجود (outlook.com أو Hotmail أو Yahoo أو Gmail أو غير ذلك).  <br/> |استخدم Word، Excel، PowerPoint، OneDrive، Teams، Access. Microsoft 365 Business Standard مع الخيار 2 أيضا الوصول إلى مجموعة واسعة من الخدمات الإضافية: حسابات البريد الإلكتروني الجديدة ذات العلامة التجارية للأعمال باستخدام Outlook والتقويمات المشتركة داخل شركتك وجدولة مواعيد Bookings وتسجيلات الاجتماعات. توفر مواقع تخزين المستندات SharePoint ومواقع Microsoft Planner قوائم Microsoft Microsoft 365 Business Standard Microsoft 365 Apps for business خدمات إضافية باستخدام الخيار 2. مشاركة المستندات بشكل أسهل داخل شركتك، ودعم متطلبات التوافق لطاقتك، والوصول والتحكم في استخدام الموظفين للخدمات، وأوسع نطاق من عمليات التكامل للتطبيقات غير الخاصة ب Microsoft (على سبيل المثال، Salesforce و Adobe) التي تعمل ضمن Teams Office. <br/> |
