...
description: تعرف على كيفية قيام المسؤول العام Microsoft 365 بتغيير عنوان البريد الإلكتروني للمستخدم وعرض الاسم عند تغيير اسمه.
ms.openlocfilehash: f48cbf3428988ce50b9f8913dd4f6c4e47858b2d
ms.sourcegitcommit: da6b3cb3b2ccfcdcd5091efce8290b6c486547db
ms.translationtype: MT
ms.contentlocale: ar-SA
ms.lasthandoff: 05/18/2022
ms.locfileid: "65466713"
---
...
3. حدد **"تعيين كعنوان أساسي** " لعنوان البريد الإلكتروني الذي تريد تعيينه كعنوان البريد الإلكتروني الأساسي لذلك الشخص.
   ...
   > [!IMPORTANT]
   > لن ترى هذا الخيار لتعيينه ك "أساسي" إذا اشتريت Microsoft 365 من GoDaddy أو خدمة شريك أخرى توفر وحدة تحكم إدارة. بدلا من ذلك، سجل الدخول إلى وحدة تحكم إدارة GoDaddy / الشريك لتعيين الاسم المستعار الأساسي.
   >
...
5. امنح الشخص المعلومات التالية:
   ...
   - إذا كانوا يستخدمون OneDrive، فقد تم تغيير URL إلى هذا الموقع. إذا كان لديهم دفاتر ملاحظات OneNote في OneDrive الخاصة بهم، فقد يحتاجون إلى إغلاقها وإعادة فتحها في OneNote. إذا كانت لديهم ملفات مشتركة من OneDrive الخاصة بهم، فقد لا تعمل الارتباطات إلى الملفات ويمكن للمستخدم إعادة المشاركة.
...
قد يستغرق هذا التغيير ما يصل إلى 24 ساعة حتى يدخل حيز التنفيذ عبر جميع الخدمات. بعد أن يصبح التغيير ساري المفعول، سيتعين على الشخص تسجيل الدخول إلى Outlook Skype for Business SharePoint باستخدام اسم المستخدم المحدث.
...
إذا كانوا يستخدمون Exchange Online أو إذا كان حسابهم مرتبطا ببيئة Exchange المحلية لمؤسستك، فقد ترى هذا الخطأ عند محاولة تغيير اسم مستخدم وعنوان بريد إلكتروني: "تتم مزامنة هذا المستخدم مع Active Directory المحلي. يمكن تحرير بعض التفاصيل فقط من خلال Active Directory المحلي."
