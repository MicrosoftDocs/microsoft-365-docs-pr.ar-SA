...
للحصول على إرشادات حول كيفية حظر تسجيل الدخول للحسابات باستخدام Azure AD PowerShell (بما في ذلك العديد من الحسابات في نفس الوقت)، راجع [حسابات المستخدمين المحظورة باستخدام Office 365 PowerShell](../../enterprise/block-user-accounts-with-microsoft-365-powershell.md).
