...
ms.locfileid: "67085542"
---
# <a name="gdpr-simplified-a-guide-for-your-small-business"></a>القانون العام لحماية البيانات (GDPR) المبسط: دليل لشركتك الصغيرة

 *استخدام Microsoft 365 للأعمال لمساعدتك على التخفيف من الامتثال للناتج العام لحماية البيانات وإدارته* 
...
يمكنك البدء من خلال مراجعة هذه المقالة، التي تهدف إلى مساعدتك على فهم ما هو القانون العام لحماية البيانات( GDPR) وسبب إنشائه وكيف يمكن أن يساعد Microsoft 365 للأعمال مؤسستك على الامتثال للقانون العام لحماية البيانات ( GDPR).
...
> [!IMPORTANT]
> حلول وتوصيات Microsoft 365 الواردة في هذه المقالة هي أدوات وموارد يمكن أن تساعدك على إدارة بياناتك وحمايتها، ولكنها ليست ضمانا لتوافق القانون العام لحماية البيانات. الأمر متروك لك لتقييم حالة التوافق الخاصة بك. استشر مستشاريك القانونيين و/أو المحترفين عند الحاجة. 
...
- **كائن:** يمكن للفرد أن ي عنصر على استخدام بياناته لاستخدامات مختلفة بما في ذلك التسويق المباشر. 
...
#### <a name="microsoft-365-features-that-can-help"></a>ميزات Microsoft 365 التي يمكن أن تساعد
...
إذا اخترت تخزين البيانات الشخصية في السحابة، على سبيل المثال من خلال Microsoft 365، فلديك ميزات أمان مثل القدرة على مساعدتك في إدارة أذونات الملفات والمجلدات، والمواقع الآمنة المركزية لحفظ ملفاتك (مكتبات مستندات OneDrive أو SharePoint)، وتشفير البيانات عند إرسال الملفات أو استردادها. 
...
تحقق أيضا من أن قاعدة البيانات التي تخزن البيانات محمية. ستتمكن شركة استضافة الويب أو مورد التخزين السحابي من تقديم المشورة بشأن ذلك. إذا كنت تستخدم Microsoft 365 للأعمال، فإن تخزين البيانات متوافق مع القانون العام لحماية البيانات. 
...
ينطبق القانون العام لحماية البيانات أيضا إذا تحركت بيانات العملاء عبر الحدود. إذا كنت تستخدم حوسبة السحابة لتخزين البيانات، فستحتاج إلى التأكد من أن الخدمة متوافقة تماما مع القانون العام لحماية البيانات. يمكن أن يكون الأمر معقدا إذا كان تخزين البيانات في مواقع لديها سجل ضعيف لحماية البيانات. إذا كنت تستخدم Microsoft 365 للأعمال، فلدينا الوثائق القانونية الصحيحة المعمول بها لتغطية متطلبات القانون العام لحماية البيانات .
...
مثل نظرائهم الأكبر، تحتاج الشركات الصغيرة إلى الراحة دون التضحية بالأمان. تم تصميم Microsoft 365 للأعمال للشركات التي يقل عدد موظفيها عن 300 موظف. يمكن للشركات الصغيرة استخدام الأدوات المستندة إلى السحابة من Microsoft لتحسين إنتاجية الأعمال. باستخدام Microsoft 365 للأعمال، يمكن لشركة صغيرة إدارة رسائل البريد الإلكتروني والوثائق وحتى الاجتماعات والأحداث. كما أن لديها تدابير أمنية مدمجة وإدارة الأجهزة، وهي حيوية لتوافق القانون العام لحماية البيانات .
  
يمكن أن يساعدك Microsoft 365 للأعمال في عملية القانون العام لحماية البيانات بالطرق التالية:
  
- **اكتشف:** من الخطوات المهمة لتوافق القانون العام لحماية البيانات (GDPR) معرفة البيانات التي لديك. 
    
- **أدار:** يعد التحكم في الوصول إلى البيانات وإدارة استخدامها جزءا لا يتجزأ من القانون العام لحماية البيانات ( GDPR). يحمي Microsoft 365 للأعمال بيانات الأعمال استنادا إلى النهج التي تريد تطبيقها على الأجهزة. إدارة الأجهزة أمر حيوي في عصر حيث يعمل الموظفون عن بعد. يتضمن Microsoft 365 للأعمال ميزات إدارة الأجهزة التي تضمن حماية البيانات عبر جميع الأجهزة. على سبيل المثال، يمكنك تحديد أن جميع أجهزة Windows 10 في شركتك محمية عبر Windows Defender. 
    
- **حمى:** تم تصميم Microsoft 365 للأعمال للأمان. تعمل عناصر التحكم في إدارة الأجهزة وحماية البيانات عبر شبكة عملك، بما في ذلك الأجهزة البعيدة، للمساعدة في الحفاظ على أمان البيانات. يوفر Microsoft 365 للأعمال عناصر تحكم مثل إعدادات الخصوصية في تطبيقات Office وتشفير المستندات. باستخدام Microsoft 365 للأعمال، يمكنك إجراء مراقبة التوافق مع القانون العام لحماية البيانات (GDPR) للتأكد من أن لديك المستوى الصحيح من مجموعة الحماية. 
    
- **تقرير:** يركز القانون العام لحماية البيانات (GDPR) كثيرا على إعداد التقارير. حتى الأعمال التي لديها موظف واحد، إذا كانت هذه الشركة تعالج كميات كبيرة من البيانات، مطلوبة لتوثيق الإجراءات الخاصة بها وإعداد تقرير بشأنها. يتولى Microsoft 365 للأعمال مسؤولية متطلبات إعداد التقارير للمؤسسات الأصغر. 
...
أصبح العملاء والموظفين والعملاء أكثر إدراكا لأهمية خصوصية البيانات ويتوقعون الآن من شركة أو مؤسسة احترام هذه الخصوصية. يوفر لك Microsoft 365 للأعمال الأدوات اللازمة لتحقيق الامتثال للناتج العام لحماية البيانات والحفاظ عليه دون إجراء عمليات ضخمة لأعمالك.
...
- التحقيق في [Microsoft 365 للأعمال](/microsoft-365/business) كحل لتحقيق التوافق مع القانون العام لحماية البيانات والحفاظ عليه. 
