...
ms.locfileid: "66489135"
---
# <a name="upgrade-to-a-different-microsoft-plan"></a>الترقية إلى خطة Microsoft مختلفة
...
عند ترقية الخطط، يتم عرض الخطط المتوفرة لك للترقية إليها استنادا إلى الخدمات الموجودة في خطتك الحالية. يمكنك فقط الترقية إلى خطة لها نفس الخدمات المتعلقة بالبيانات، مثل Exchange Online أو SharePoint Online، أو إلى إصدار أعلى منها. يضمن هذا عدم فقدان المستخدمين\'للبيانات المتعلقة بهذه الخدمات أثناء الترقية.
...
إذا كان اشتراكك القديم يتضمن خدمات متعددة، وإذا قمت بتغيير أي من هذه الخدمات التي تم تعيين المستخدمين إليها، فقد ترغب في تدوين هذا قبل ترقية الخطط بحيث يمكنك إعادة إنشاء هذه التغييرات بعد ذلك. سيتم منح جميع المستخدمين حق الوصول إلى جميع الخدمات في الاشتراك الجديد. على سبيل المثال، إذا اشتريت مسبقا Microsoft 365 Business Premium لجميع المستخدمين البالغ عددهم 100 مستخدم، ولكنك لم تقم بإعادة تعيين خدمة SharePoint Online من 50 منهم، فلن يتم الاحتفاظ بهذا التغيير بعد ترقية الخطط.
...
سيتم الاحتفاظ بكافة بيانات المستخدم أثناء الترقية، بما في ذلك علب بريد Exchange ومستندات SharePoint Online والقوائم ومعلومات أخرى.
...
[النسخ الاحتياطي للبيانات قبل تبديل خطط Microsoft 365 للأعمال](back-up-data-before-switching-plans.md) (مقالة)
