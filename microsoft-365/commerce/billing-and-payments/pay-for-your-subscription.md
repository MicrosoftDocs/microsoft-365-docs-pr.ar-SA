...
- يجب أن تكون مسؤولا عموميا أو مسؤول فوترة لتنفيذ الخطوات الموضحة في هذه المقالة. لمزيد من المعلومات، راجع [حول أدوار المسؤولين](../../admin/add-users/about-admin-roles.md).
- طريقة الدفع التي تختارها أثناء السداد مع الخروج هي طريقة الدفع التي نستخدمها لجميع فترات الفوترة المستقبلية. يمكنك تغييره في أي وقت.
...
[تحقق من الفاتورة](view-your-bill-or-invoice.md) للحصول على إرشادات الدفع لبلدك أو منطقتك. إذا لم تكن متأكدا من المبلغ الذي تدين به، فيمكنك التحقق من محفوظات الفوترة عبر الإنترنت على علامة تبويب **الفواتير** من صفحة <a href="https://go.microsoft.com/fwlink/p/?linkid=2102895" target="_blank">الفواتير والمدفوعات</a>.
