...
في الصفحة الأولى من الفاتورة، **يكون المنتج** هو "الخدمات عبر الإنترنت"، وهو المصطلح العام الذي نستخدمه لوصف اشتراكك. تسرد الصفحة الثانية المنتجات الفردية في طلبك.

**رقم أمر الشراء للعميل** هو رقم أمر الشراء الذي تحدده. لا يمكنك إضافة رقم أمر شراء لفاتورة موجودة حاليًا. إذا قمت بتحديث رقم أمر الشراء، يتم تضمينه في الفواتير المستقبلية. لتغيير رقم أمر الشراء، راجع [تغيير رقم أمر الشراء](#change-your-purchase-order-number).
...
إذا اخترت "فاتورة" كطريقة دفع اشتراكك، تحتوي الصفحة الأولى على قسم **تحويل الأموال الإلكتروني** الذي يعرض معلومات حساب Microsoft البنكي للمدفوعات الإلكترونية (السلكية و ACH وSPA وغيرها). عادة، يحتوي البنك الخاص بك على حقل مرجعي تكمله عند إرسال دفعة. تأكد من الإشارة إلى رقم الفاتورة في هذا الحقل.
