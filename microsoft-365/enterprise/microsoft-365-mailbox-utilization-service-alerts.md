...
f1.keywords:
- NOCSH
description: استخدم تنبيهات خدمة استخدام علبة البريد لمراقبة علب البريد قيد الاحتجاز التي تصل إلى الحصة النسبية لعلبة البريد الخاصة بها.
...
---
# <a name="service-alerts-for-mailbox-utilization-in-exchange-online-monitoring"></a>تنبيهات الخدمة لاستخدام علبة البريد في مراقبة Exchange Online

لقد أصدرنا تنبيه خدمة Exchange Online جديد يعلمك بعلب البريد الموجودة قيد الاحتجاز والمعرضة لخطر الوصول إلى الحصة النسبية أو تجاوزها. توفر تنبيهات الخدمة هذه رؤية لعدد علب البريد في مؤسستك التي قد تتطلب تدخل المسؤول.

يتم عرض تنبيهات الخدمة هذه في مركز مسؤولي Microsoft 365. لعرض تنبيهات الخدمة هذه، انتقل إلى **Health** >  <a href="https://go.microsoft.com/fwlink/p/?linkid=842900" target="_blank">**Service health**</a> >  **Exchange Online** ثم انقر فوق علامة التبويب **"مشاكل نشطة**". فيما يلي مثال على تنبيه خدمة استخدام علبة البريد.
...
لعرض قائمة بعلب البريد التي تقترب من الحصة النسبية للتخزين (تسمى *تقرير استخدام علبة البريد*)، انقر فوق الارتباط المميز في لقطة الشاشة التالية. يتم عرض هذا الارتباط في تنبيه الخدمة.
...
## <a name="how-often-will-i-see-these-service-alerts"></a>كم مرة سأشاهد تنبيهات الخدمة هذه؟

إذا لم تتخذ إجراء لحل مشكلات الحصة النسبية، يمكنك أن تتوقع رؤية هذا النوع من تنبيه الخدمة كل أربعة أيام. قد تحتوي تنبيهات الخدمة اللاحقة على عدد أكبر من علب البريد لعلب البريد الأخرى التي تقترب من الحصة النسبية الخاصة بها. إذا اتخذت إجراء لحل مشاكل الحصة النسبية، فلن يحدث تنبيه الخدمة هذا إلا عند تحديد علبة بريد أخرى بها مشاكل في الحصة النسبية.
