...
لا يوصى بتكوينات ذات تعليمات برمجية مبرمجة أو استخدام قائمة السماح استنادا إلى Office 365 FQDN غير المباشر، ولا تدعمها Microsoft، ومن المعروف أنها تسبب مشاكل في اتصال العملاء. يمكن حل حلول DNS التي تحظر إعادة توجيه CNAME، أو التي تقوم بحل إدخالات DNS Office 365 بشكل غير صحيح، عبر معاد توجيه DNS مع تمكين إعادة DNS أو باستخدام تلميحات جذر DNS. تدمج العديد من منتجات محيط الشبكة الخارجية أصلا نقطة نهاية Office 365 الموصى بها لتضمين قائمة السماح في تكوينها باستخدام [عنوان IP Office 365 وخدمة URL على الويب](microsoft-365-ip-web-service.md).
