---
title: مخطط المستأجر Microsoft 365
f1.keywords:
- NOCSH
ms.author: kvice
...
ms.custom: it-pro
description: مخطط إعداد المستأجرين Microsoft 365.
...
بعد التأكد من تحسين شبكاتك للوصول إلى Microsoft 365 لكل من العاملين المحليين والعاملين عن بعد، تخطط مهامك الكبيرة التالية ثم تقوم بتكوين مستأجر Microsoft 365 لأسماء مجالات DNS والخدمات الشائعة والبنية الأساسية للهوية التي تدعم تسجيل دخول المستخدم الآمن.
...
- [التخطيط لترقيات Office 2007 و Office 2010](plan-upgrade-previous-versions-office.md)
...
- استخدم [إرشادات الإعداد في مركز مسؤولي Microsoft 365](setup-guides-for-microsoft-365.md).
...
لمزيد من المعلومات، راجع [نقل البيانات الأساسية إلى جيو مركز بيانات Microsoft 365 جديد](moving-data-to-new-datacenter-geos.md).


## <a name="deploy-microsoft-365-multi-geo"></a>توزيع Microsoft 365 متعدد المناطق الجغرافية

باستخدام Microsoft 365 Multi-Geo، يمكن لمؤسستك توسيع وجودها Microsoft 365 إلى مناطق جغرافية متعددة و/أو بلدان داخل المستأجر الحالي.

لمزيد من المعلومات، راجع [Microsoft 365 Multi-Geo](microsoft-365-multi-geo.md).

## <a name="manage-multiple-microsoft-365-tenants"></a>إدارة مستأجرين متعددين Microsoft 365 
...
إذا كان لديك عدة مستأجرين Microsoft 365، فراجع هذه المقالات للحصول على مزيد من المعلومات حول:
