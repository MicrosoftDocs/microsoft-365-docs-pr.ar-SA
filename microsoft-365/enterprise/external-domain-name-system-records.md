...
**Go back إلى** [تخطيط الشبكة وضبط الأداء Office 365](./network-planning-and-performance.md).
...
إن سجل TXT مطلوب لإثبات أنك تملك المجال ومطلوب لجميع العملاء.

إن سجل CNAME مطلوب فقط للعملاء الذين يستخدمون Office 365 [التي يتم تشغيلها بواسطة 21Vianet](/microsoft-365/admin/services-in-china/services-in-china). وهو يضمن إمكانية Office 365 توجيه محطات العمل للمصادقة باستخدام النظام الأساسي المناسب للهوية. 


  
|**سجل DNS** <br/> |**الغرض** <br/> |**القيمة التي يجب استخدامها** <br/> |**ينطبق على**|
|----------|-----------|------------|------------|
|**TXT** <br/> **(التحقق من المجال)** <br/> |يستخدمه Office 365 للتحقق فقط من أنك تملك مجالك. ولا يؤثر ذلك على أي شيء آخر.  <br/> |**المضيف:** @ (أو، لبعض موفري استضافة DNS، اسم مجالك)  <br/> **قيمة TXT:** _سلسلة نصية توفرها Office 365_  <br/> يوفر Office 365 **إعداد** المجال القيم التي تستخدمها لإنشاء هذا السجل.  <br/> |جميع العملاء|
|**CNAME** <br/> **(Suite)** <br/> |يستخدمه Office 365 لتوجيه المصادقة إلى النظام الأساسي الصحيح للهوية. [معلومات إضافية](../admin/services-in-china/purpose-of-cname.md?viewFallbackFrom=o365-worldwide) <br/> **لاحظ** أن CNAME هذا ينطبق فقط على Office 365 التي يتم تشغيلها بواسطة 21Vianet. إذا كان موجودا ولم يتم تشغيل Office 365 بواسطة 21Vianet، سيحصل المستخدمون على مجالك المخصص على *خطأ "المجال* المخصص غير موجود في نظامنا" ولن يتمكنوا من تنشيط ترخيص Office 365 الخاص بهم. [معلومات إضافية](/office365/servicedescriptions/office-365-platform-service-description/office-365-operated-by-21vianet) |**الاسم المستعار:** msoid  <br/> **الهدف: clientconfig.partner.microsoftonline-p.net.cn**  <br/> | عملاء 21Vianet فقط|
...
|**سجل DNS** <br/> |**الغرض** <br/> |**القيمة التي يجب استخدامها** <br/> |
|----------|-----------|------------|
|**المضيف (A)** <br/> |يستخدم تسجيل الدخول الفردي (SSO). فهو يوفر نقطة النهاية للمستخدمين غير المحليين (والمستخدمين المحليين، إذا أردت ذلك) للاتصال بتكوين خوادم خوادم Active Directory 联合身份验证服务 (AD FS) أو IP ظاهري (VIP) متوازن للتحميل.  <br/> |**الهدف:** على سبيل المثال، sts.contoso.com  <br/> |
