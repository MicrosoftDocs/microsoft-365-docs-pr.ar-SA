...
- الترحيل إلى إصدار محلي أحدث من Project Server (يفضل Project Server 2016)
...
> [!NOTE]
> لمزيد من المعلومات حول خيارات الانتقال من خوادم Office 2007، راجع ["الموارد" لمساعدتك على الترقية من خوادم Office 2007 وعملائه](upgrade-from-office-2007-servers-and-products.md). لاحظ أن Project Server لا يدعم التكوين المختلط، لأن Project Server و Project Online لا يمكنهما مشاركة نفس تجمع الموارد. 
...
تمنع الاختلافات الهيكلية بين Project Server 2007 و Project Server 2016 مسار ترحيل مباشر. لذلك يجب ترحيل بيانات Project Server 2007 إلى كل إصدار متتابع من Project Server حتى تصل إلى Project Server 2016.
...
- [اعتبارات الترقية لأجزاء ويب Project Web App](/previous-versions/office/project-server-2010/gg314581(v=office.14))
