---
title: إرشادات الإعداد لخدمات Microsoft 365 و Office 365
ms.author: kvice
...
ms.locfileid: "66491646"
---
# <a name="setup-guides-for-microsoft-365-and-office-365-services"></a>إرشادات الإعداد لخدمات Microsoft 365 و Office 365

توفر لك إرشادات إعداد Microsoft 365 Office 365 إرشادات وموارد مخصصة لتخطيط المستأجر والتطبيقات والخدمات وتوزيعها. يتم إنشاء هذه الإرشادات باستخدام أفضل الممارسات نفسها التي يشاركها متخصصو إلحاق [Microsoft 365 FastTrack](https://www.microsoft.com/fasttrack/microsoft-365) في التفاعلات الفردية، وهي متوفرة لجميع المسؤولين داخل مركز مسؤولي Microsoft 365. وهي توفر معلومات حول إعداد المنتج، وتمكين ميزات الأمان، ونشر أدوات التعاون، وتوفير البرامج النصية لتسريع عمليات النشر المتقدمة.
...
عند ترحيل علبة بريد مستخدم Gmail إلى Microsoft 365، يتم ترحيل رسائل البريد الإلكتروني، ولكن لا يتم ترحيل جهات الاتصال وعناصر التقويم. يوفر [مستشار التقويم وجهات اتصال Gmail](https://aka.ms/gmailcontactscalendar) خطوات لاستيراد جهات اتصال Google وعناصر تقويم Google إلى Microsoft 365 باستخدام أساليب الاستيراد والتصدير مع Outlook.com أو عميل Outlook أو PowerShell.

### <a name="microsoft-365-setup-guide"></a>دليل إعداد Microsoft 365

يوفر لك [دليل إعداد Microsoft 365](https://aka.ms/microsoft365setupguide) إرشادات عند إعداد أدوات الإنتاجية ونهج الأمان وقدرات إدارة الأجهزة. باستخدام Microsoft 365 Business Premium أو Microsoft 365 لاشتراك المؤسسة، يمكنك استخدام هذا المستشار لإعداد أجهزة مؤسستك وتكوينها.
...
تمت إعادة إنشاء Microsoft Edge من الألف إلى الياء لتوفير التوافق والأداء على مستوى عالمي والأمان والخصوصية التي تستحقها والميزات الجديدة المصممة لتجلب لك أفضل ما في الويب.
...
### <a name="configure-ie-mode-for-microsoft-edge"></a>تكوين وضع IE ل Microsoft Edge

إذا قمت بالفعل بنشر Microsoft Edge وتريد فقط تكوين وضع IE، فسيمنحك [وضع تكوين IE لدليل Microsoft Edge](https://aka.ms/configureiemodeadmin) برامج نصية لأتمتة تكوين اكتشاف موقع المؤسسة. ستحصل أيضا على توصيات وضع IE من أداة مستندة إلى السحابة ستساعدك على إنشاء قائمة مواقع وضع المؤسسة للنشر للمستخدمين.

### <a name="microsoft-search-setup-guide"></a>دليل إعداد البحث من Microsoft

يساعد Microsoft Search مؤسستك في العثور على ما يحتاجون إليه لإكمال ما يعملون عليه. سواء كان البحث عن أشخاص أو ملفات أو مخططات هيكلية أو مواقع أو إجابات على الأسئلة الشائعة، يمكن لمؤسستك استخدام Microsoft Search طوال يوم العمل للحصول على إجابات.

يساعدك [دليل إعداد Microsoft Search](https://aka.ms/MicrosoftSearchSetup) على تكوين Microsoft Search سواء كنت تريد إصداره تجريبيا إلى مجموعة من المستخدمين أو طرحه لجميع الأشخاص في مؤسستك. ستقوم بتعيين مسؤولي البحث ومحرري البحث ثم تخصيص تجربة البحث للمستخدمين باستخدام الإجابات والمزيد من الخيارات، مثل إضافة ملحق Bing إلى Chrome أو تعيين Bing كمحرك بحث افتراضي.

### <a name="block-use-of-internet-explorer-in-your-organization"></a>حظر استخدام Internet Explorer في مؤسستك

سينتهي دعم Microsoft ل Internet Explorer 11 قريبا لمعظم إصدارات Windows 10. يضمن [استخدام حظر Internet Explorer في دليل المؤسسة الخاص بك](https://aka.ms/retireinternetexplorer) أنه لا يزال بإمكان المستخدمين تشغيل تطبيقات الويب القديمة التي تعتمد على Internet Explorer. يساعدك هذا الدليل أيضا على نقل هؤلاء المستخدمين إلى Microsoft Edge باستخدام وضع IE.
...
### <a name="identity-security-for-teams"></a>أمان الهوية ل Teams
...
[يرشدك "مزامنة المستخدمين" من دليل Windows Server Active Directory](https://aka.ms/directorysyncsetup) إلى تشغيل مزامنة الدليل. تجمع مزامنة الدليل الهويات المحلية والسحابية معا لتسهيل الوصول والإدارة المبسطة. قم بإلغاء تأمين قدرات جديدة، مثل تسجيل الدخول الأحادي وخيارات الخدمة الذاتية وتوفير الحساب التلقائي وعناصر التحكم في الوصول المشروط ونهج التوافق. تضمن هذه القدرات للمستخدمين إمكانية الوصول إلى الموارد التي يحتاجون إليها من أي مكان.
...
يوفر لك [مستشار نشر AD FS](https://aka.ms/adfsguidance) إرشادات مفصلة خطوة بخطوة حول نشر بنية أساسية محلية ل AD FS تصادق المستخدمين لخدمات Microsoft 365 Office 365. باستخدام هذا الدليل، يمكن لمؤسستك مراجعة مكونات AD FS ومتطلباته، والحصول على شهادات SSL الضرورية للنشر وتثبيت خادم وكيل تطبيق ويب مطلوب وتثبيتها.
...
يوفر لك [دليل إعداد إدارة دورة البيانات في Microsoft Purview](https://aka.ms/migsetupguide) المعلومات التي ستحتاجها لإعداد استراتيجية الحوكمة الخاصة بمؤسستك وإدارتها، لضمان تصنيف بياناتك وإدارتها وفقا لإرشادات دورة الحياة المحددة التي قمت بتعيينها. باستخدام هذا الدليل، ستتعلم كيفية إنشاء تسميات الاستبقاء ونهج تسميات الاستبقاء ونهج الاستبقاء المطبقة على سجلات المحتوى والتوافق الخاصة بمؤسستك أو تطبيقها تلقائيا أو نشرها. ستحصل أيضا على معلومات حول استيراد ملفات CSV مع خطة ملف للسيناريوهات المجمعة أو لتطبيقها يدويا على المستندات الفردية.
...
### <a name="audit-solutions-setup-guide"></a>دليل إعداد حلول التدقيق

يوفر [دليل حلول تدقيق Microsoft 365](https://aka.ms/auditsolutionsetup) حلا متكاملا لمساعدة المؤسسات على الاستجابة الفعالة للأحداث الأمنية والتحقيقات الجنائية والتزامات الامتثال. عند استخدام حلول التدقيق في Microsoft 365، يمكنك البحث في سجل التدقيق عن الأنشطة التي يتم تنفيذها في خدمات Microsoft 365 المختلفة.

### <a name="ediscovery-solutions-setup-guide"></a>دليل إعداد حلول eDiscovery

eDiscovery هو عملية تحديد وتقديم المعلومات الإلكترونية التي يمكن استخدامها كدليل في الحالات القانونية. يساعد دليل إعداد حلول eDiscovery في استخدام أدوات eDiscovery في Microsoft Purview التي تسمح لك بالبحث عن المحتوى في مجتمعات Exchange Online OneDrive for Business وSharePoint Online وMicrosoft Teams مجموعات Microsoft 365 وYamer.

## <a name="guides-for-collaboration"></a>إرشادات التعاون

### <a name="build-your-employee-experience"></a>بناء خبرة الموظف

تحويل كيفية عمل موظفيك مع [لوحة معلومات تجربة الموظفين](https://aka.ms/EmployeeExperienceDashboard). للعمل الجماعي السلس، استخدم Microsoft 365 لإنشاء فرق منتجة ومحاذاة والحفاظ على تفاعل الموظفين مع القيادة وباقي المؤسسة. ساعد موظفيك على أن يكونوا فعالين في جميع أنشطة العمل. ستوفر هذه الإرشادات إرشادات حول كيفية استخدام SharePoint وTeams وYamer لبناء التعاون عبر مؤسستك للمساعدة في تعزيز الإنتاجية.

### <a name="microsoft-365-apps-setup-guide"></a>دليل إعداد Microsoft 365 Apps

يساعدك [دليل إعداد Microsoft 365 Apps](https://aka.ms/OPPquickstartguide) على تشغيل أجهزة المستخدمين لديك على أحدث إصدار من منتجات Office مثل Word وExcel وPowerPoint وOneNote. ستحصل على إرشادات حول أساليب النشر المختلفة التي تتضمن خيارات التثبيت الذاتي السهلة لعمليات نشر المؤسسة باستخدام أدوات الإدارة. ستساعدك الإرشادات على تقييم بيئتك، ومعرفة متطلبات النشر المحددة، وتنفيذ أدوات الدعم اللازمة لضمان نجاح التثبيت.

### <a name="mobile-apps-setup-guide"></a>دليل إعداد تطبيقات الأجهزة المحمولة

يوفر [دليل إعداد تطبيقات الأجهزة المحمولة](https://aka.ms/officeappguidance) إرشادات لتنزيل تطبيقات Office وتثبيتها على الأجهزة المحمولة التي تعمل بنظام التشغيل Windows وiOS وAndroid. يوفر لك هذا الدليل معلومات مفصلة خطوة بخطوة لتنزيل تطبيقات Microsoft 365 وتطبيقات Office 365 وتثبيتها على الهاتف والأجهزة اللوحية.

### <a name="microsoft-teams-setup-guide"></a>دليل إعداد Microsoft Teams

يوفر [دليل إعداد Microsoft Teams](https://aka.ms/teamsguidance) لمؤسستك إرشادات لإعداد مساحات عمل الفريق التي تستضيف المحادثات في الوقت الحقيقي من خلال المراسلة والمكالمات واجتماعات الصوت أو الفيديو لكل من الفريق والاتصالات الخاصة. استخدم الأدوات الموجودة في هذا الدليل لتكوين وصول الضيف، وتعيين من يمكنه إنشاء فرق، وإضافة أعضاء الفريق من ملف .csv، كل ذلك دون الحاجة إلى فتح جلسة عمل PowerShell. ستحصل أيضا على أفضل الممارسات لتحديد متطلبات الشبكة لمؤسستك وضمان نشر Teams بنجاح.

### <a name="teams-phone-setup-guide"></a>دليل إعداد Teams Phone

يساعدك [دليل إعداد Teams Phone](https://aka.ms/teamsphonesetupguide) على البقاء على اتصال باستخدام حلول المكالمات الحديثة. تطبيق القدرات الرئيسية باستخدام نظام التحكم في المكالمات المستند إلى السحابة الذي يدعم حمل عمل الهتفية ل Teams. يمكنك اختيار الميزات وتوزيعها من خيارات اتصال شبكة الهاتف العامة (PSTN) المتوفرة. يمكنك أيضا العثور على مساعدة لميزات أخرى، مثل الرد التلقائي وقوائم انتظار المكالمات والمؤتمرات الصوتية ومعرف المتصل والأحداث المباشرة.

### <a name="sharepoint-setup-guide"></a>دليل إعداد SharePoint

يساعدك [دليل إعداد SharePoint](https://aka.ms/spoguidance) على إعداد تخزين مستندات SharePoint وإدارة المحتوى، وإنشاء مواقع، وتكوين المشاركة الخارجية، وترحيل البيانات وتكوين الإعدادات المتقدمة، ودفع مشاركة المستخدم والتواصل داخل مؤسستك. ستتبع خطوات لتكوين نهج أذونات مشاركة المحتوى واختيار أدوات مزامنة الترحيل وتمكين إعدادات الأمان لبيئة SharePoint.

### <a name="onedrive-setup-guide"></a>دليل إعداد OneDrive

استخدم [دليل إعداد OneDrive](https://aka.ms/ODfBquickstartguide) لبدء استخدام إمكانيات تخزين ملفات OneDrive ومشاركتها وتعاونها ومزامنتها. يوفر OneDrive موقعا مركزيا حيث يمكن للمستخدمين مزامنة ملفاتهم Microsoft 365 Apps وتكوين المشاركة الخارجية وترحيل بيانات المستخدم وتكوين إعدادات الأمان والوصول إلى الأجهزة المتقدمة. يمكن نشر دليل إعداد OneDrive باستخدام اشتراك OneDrive أو خطة OneDrive مستقلة.

### <a name="yammer-deployment-advisor"></a>مستشار نشر Yammer

تواصل مع Yammer واتفاعل معه عبر مؤسستك. يقوم [مستشار نشر Yammer](https://aka.ms/yammerdeploymentguide) بإعداد شبكة Yammer عن طريق إضافة المجالات وتحديد المسؤولين ودمج شبكات Yammer. ستحصل على إرشادات لنشر Yammer ثم تخصيص الشكل وتكوين الأمان والتوافق وتحسين الإعدادات.
...
يمكنك نشر تطبيقات Office من السحابة مع إمكانية تخصيص التثبيت باستخدام أداة نشر Office. يساعدك [دليل نشر Office للمستخدمين على](https://aka.ms/proplusodt) إنشاء تكوين Office مخصص مع إعدادات متقدمة، أو يمكنك استخدام تكوين موصى به مسبقا. سواء كان المستخدمون يقومون بإجراء تثبيت ذاتي أو كنت تقوم بالنشر للمستخدمين بشكل فردي أو مجمع، يوفر لك هذا الدليل المتقدم إرشادات خطوة بخطوة لمنح المستخدمين تثبيت Office مصمما خصيصا لمؤسستك.

### <a name="deploy-office-to-remote-users"></a>نشر Office للمستخدمين البعيدين

الآن بعد أن أصبح العمل عن بعد هو القاعدة، يحتاج المستخدمون إلى تلقي إعدادات Office الخاصة بمؤسستك عندما لا يكونون متصلين بشبكتك الداخلية أو عند استخدام أجهزتهم الخاصة.

استخدم [دليل نشر Office للمستخدمين البعيدين](https://aka.ms/officeremoteinstall) لإنشاء تثبيت Office مخصص ثم أرسل للمستخدمين برنامج PowerShell نصيا تم إنشاؤه من أجل تثبيت Office بسلاسة باستخدام التكوين الخاص بك.
...
بالنسبة للمؤسسات التي تستخدم Configuration Manager، يمكنك استخدام [Microsoft 365 Apps النشر والتحديث مع مستشار Configuration Manager](https://aka.ms/oppinstall) لإنشاء برنامج نصي يقوم بتكوين Microsoft 365 Apps  النشر باستخدام أفضل الممارسات الموصى بها من قبل مهندسي FastTrack. استخدم هذا الدليل لإنشاء مجموعات النشر، وتخصيص تطبيقات Office وميزاته، وتكوين عمليات التثبيت الديناميكية أو الخالية، ثم تشغيل البرنامج النصي لإنشاء التطبيقات وقواعد النشر التلقائي ومجموعات الأجهزة التي تحتاجها لاستهداف عملية النشر.
...
### <a name="school-data-sync-rollover-setup-guide"></a>دليل إعداد تجاوز مزامنة بيانات المدرسة

يوفر [دليل إعداد SDS Rollover](https://aka.ms/sdsrolloversetupguide) الخطوات لمساعدة مؤسستك على مزامنة بيانات معلومات الطلاب إلى Azure Active Directory Office 365. يبسط هذا الدليل عملية إدارة دورة حياة المصطلح من خلال إنشاء مجموعات Office 365 ل Exchange Online وSharePoint Online، وفرق الصفوف ل Microsoft Teams وOneNote، بالإضافة إلى Intune للتعليم، وإعداد القوائم وتكامل تسجيل الدخول الأحادي لتطبيقات الجهات الخارجية. ستقوم بإغلاق نهاية العام، وتنظيف المستأجر وأرشفته، وإعداد السنة الدراسية الجديدة، وبدء العام الدراسي الجديد. ثم يمكنك إنشاء ملفات تعريف جديدة باستخدام أسلوب نشر المزامنة الذي يناسب مؤسستك.
