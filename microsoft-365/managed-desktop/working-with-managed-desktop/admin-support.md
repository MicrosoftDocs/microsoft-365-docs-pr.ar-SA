...
عندما تكون جهة الاتصال الأساسية في طلب دعم، ستتلقى رسالة بريد إلكتروني من عمليات سطح المكتب المدارة من Microsoft. سيسألك البريد الإلكتروني عن تجربتك بعد حل المشكلة. يتم مراقبة الملاحظات بشكل نشط ومشاركتها مع الهندسة لتحسين الخدمة وتحديد أولويات الميزات المستقبلية. تأكد من التركيز على تجربتك ومن عدم تضمين معلومات شخصية في نموذج الملاحظات. لمزيد من المعلومات حول الخصوصية، راجع بيان [خصوصية Microsoft](https://privacy.microsoft.com/privacystatement).

## <a name="support-request-severity-definitions"></a>تعريفات خطورة طلبات الدعم

وقت الاستجابة الأولي هو الفترة التي ترسل فيها طلب الدعم حتى يجري مهندس Microsoft Managed Desktop اتصالا بك، ويبدأ العمل على طلب الدعم. يختلف وقت الاستجابة الأولي باختلاف تأثير العمل للطلب. وهي تستند إلى خطورة الطلب.

> [!NOTE]
> في هذا الجدول، تعني "ساعات دعم المسؤول" أن دعم Microsoft Managed Desktop للمسؤولين متوفر لمعظم البلدان على مدار الساعة من **الاثنين إلى الجمعة**. الخطورة يمكن حل المشاكل على مدار الساعة طوال أيام الأسبوع السبعة.
