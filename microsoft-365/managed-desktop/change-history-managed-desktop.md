---
title: تغيير محفوظات Microsoft Managed Desktop المستندات
...
مقالة جديدة أو تم تغييرها | الوصف
--- | ---
| [صور الجهاز](service-description/device-images.md) | مقطع Windows 10 Pro مضاف |
| [دعم المسؤول](working-with-managed-desktop/admin-support.md) | ملاحظة الخطورة المضافة إلى المقطع "تحرير تفاصيل حالة الاتصال" |
...
[Microsoft Managed Desktop دورة حياة المنتج](service-description/device-lifecycle.md) | المقالة المحدثة
...
[معاينة Windows 11 باستخدام Microsoft Managed Desktop](working-with-managed-desktop/test-win11-mmd.md) | مقالة جديدة
...
[Microsoft Managed Desktop عمليات ومراقبة](service-description/operations-and-monitoring.md) | المقالة المحدثة
...
[Microsoft Managed Desktop الجديدة](intro/technologies.md) | المقالة المحدثة
[المتطلبات الأساسية الخاصة وحسابات الضيوف](get-ready/guest-accounts.md) | المقالة المحدثة
[العمل على التقارير](working-with-managed-desktop/reports.md) | المقالة المحدثة
...
[إعداد أجهزة Microsoft Managed Desktop](get-started/prepare-devices.md) | المقالة المحدثة
[Microsoft Managed Desktop دورة حياة المنتج](service-description/device-lifecycle.md) | المقالة المحدثة
[Microsoft Managed Desktop الأجهزة](service-description/device-list.md) |المقالة المحدثة
...
[Microsoft Managed Desktop المناطق المعتمدة](service-description/regions-languages.md) | المقالة المحدثة
...
[إعداد محركات أقراص تم تعيينها Microsoft Managed Desktop](get-ready/mapped-drives.md) | المقالة المحدثة
[الحصول على تعليمات للمستخدمين](working-with-managed-desktop/end-user-support.md) | المقالة المحدثة
...
[تحضير موارد الطباعة Microsoft Managed Desktop](get-ready/printing.md) | المقالة المحدثة
[تجربة التشغيل الأول مع Autopilot وصفحة حالة التسجيل](get-started/esp-first-run.md) | المقالة المحدثة
[تسجيل الأجهزة الجديدة بنفسك](get-started/manual-registration.md) | المقالة المحدثة
[إعداد الشهادات وملفات تعريف الشبكة Microsoft Managed Desktop](get-ready/certs-wifi-lan.md) | المقالة المحدثة
[المتطلبات الأساسية Microsoft Managed Desktop](get-ready/prerequisites.md) | المقالة المحدثة
...
[تسجيل الأجهزة الجديدة بنفسك](get-started/manual-registration.md) | المقالة المحدثة
[تسجيل الأجهزة الموجودة بنفسك] (get-started/manual-registration-existing-devices .md) | المقالة [المحدثة المتطلبات الأساسية Microsoft Managed Desktop](get-ready/prerequisites.md) | المقالة [المحدثة عمليات الأمان في Microsoft Managed Desktop](service-description/security-operations.md) | مقالة جديدة [الوصول إلى مدخل |](get-started/access-admin-portal.md) المقالة [المحدثة Microsoft 365 Apps for enterprise](get-started/m365-apps.md) | مقالة جديدة [الخصوصية والبيانات الشخصية |](service-description/privacy-personal-data.md) مقالة جديدة

## <a name="july-2020"></a>تموز/يوليه 2020

مقالة جديدة أو تم تغييرها | الوصف
--- | ---
[Microsoft Managed Desktop التطبيق](service-description/mmd-app-requirements.md) | المقالة المحدثة
[التوافق](intro/compliance.md) | المقالة المحدثة
...
[تثبيت Microsoft Project أو Microsoft Visio على Microsoft Managed Desktop الأجهزة](get-started/project-visio.md) | المقالة المحدثة
...
[Microsoft Managed Desktop ولغات المناطق المعتمدة](service-description/regions-languages.md) | المقالة المحدثة
...
[خطوات للشركاء لتسجيل الأجهزة](get-started/partner-registration.md)| المقالة المحدثة
[تسجيل الأجهزة الجديدة بنفسك](get-started/manual-registration.md) | المقالة المحدثة
[تحضير موارد الطباعة Microsoft Managed Desktop](get-ready/printing.md) | مقالة جديدة
...
[كيفية معالجة التحديثات في Microsoft Managed Desktop](service-description/updates.md) | المقالة المحدثة
[Microsoft Managed Desktop الأجهزة](service-description/device-services.md) | المقالة المحدثة
...
[دعم المسؤول Microsoft Managed Desktop](working-with-managed-desktop/admin-support.md) | المقالة المحدثة
[Microsoft Managed Desktop الأجهزة](service-description/device-list.md) | المقالة المحدثة
[Microsoft Managed Desktop المؤرشفة](service-description/archived-device-list.md) | المقالة المحدثة
...
[Microsoft Managed Desktop الأجهزة](service-description/device-list.md) | المقالة المحدثة
[Microsoft Managed Desktop الرئيسية](./index.yml) | المقالة المحدثة
[ما هو Microsoft Managed Desktop؟](./intro/index.md) | المقالة المحدثة
[اجهز المستخدمين لاستخدام الأجهزة](get-started/get-started-devices.md) | المقالة المحدثة
...
[Microsoft Managed Desktop الأدوار والمسؤوليات](intro/roles-and-responsibilities.md) | المقالة المحدثة
[Microsoft Managed Desktop دورة حياة المنتج](service-description/device-lifecycle.md) | مقالة جديدة
...
[Microsoft Managed Desktop ولغات المناطق المعتمدة](service-description/regions-languages.md) | المقالة المحدثة
[Microsoft Managed Desktop الأجهزة](service-description/device-list.md) | المقالة المحدثة
[Microsoft Managed Desktop المؤرشفة](service-description/archived-device-list.md) | مقالة جديدة
[إعداد محركات أقراص تم تعيينها Microsoft Managed Desktop](get-ready/mapped-drives.md) | مقالة جديدة
[إعداد الشهادات وملفات تعريف الشبكة Microsoft Managed Desktop](get-ready/certs-wifi-lan.md) | مقالة جديدة
[طلب Microsoft Managed Desktop الأجهزة](get-started/devices.md) | المقالة المحدثة
...
مقالة جديدة أو تم تغييرها | الوصف
--- | ---
[تثبيت Intune Company Portal على Microsoft Managed Desktop الأجهزة](get-started/company-portal.md) | مقالة جديدة
[تثبيت Microsoft Project و Microsoft Visio على Microsoft Managed Desktop الأجهزة](get-started/project-visio.md) | مقالة جديدة
...
[نشر التطبيقات Microsoft Managed Desktop الأجهزة](get-started/deploy-apps.md) | المقالة المحدثة
...
مقالة جديدة أو تم تغييرها | الوصف
--- | ---
[نشر التطبيقات للأجهزة Microsoft Managed Desktop الأجهزة](get-started/deploy-apps.md) | مقالة جديدة.
[إدارة التطبيقات Microsoft Managed Desktop](working-with-managed-desktop/manage-apps.md) | تم التحديث مع معلومات حول كيفية التحديث أو العودة إلى إصدار سابق من تطبيقات خط العمل.

## <a name="december-2018"></a>ديسمبر 2018

مقالة جديدة أو تم تغييرها | الوصف
--- | ---
[العمليات ومراقبة Microsoft Managed Desktop](service-description/operations-and-monitoring.md) | إضافة جدول توازن المسؤولية وتحديث جداول أخرى.
...
مقالة جديدة أو تم تغييرها | الوصف
--- | ---
[دعم Microsoft Managed Desktop](service-description/support.md)<br />ودعم [المستخدمين Microsoft Managed Desktop](working-with-managed-desktop/end-user-support.md) | تم التحديث لتضمين أستراليا.

## <a name="october-30-2018"></a>30 أكتوبر 2018

المحتوى الذي تم إعادة تنظيمه: القسم المضاف Microsoft Managed Desktop [وصف الخدمة](service-description/index.md).
