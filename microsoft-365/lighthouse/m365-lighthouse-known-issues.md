...
## <a name="delegated-admin-privilegesdap"></a>امتيازات المسؤول المفوض (DAP)
...
## <a name="granular-delegated-admin-privilegesgdap"></a>امتيازات المسؤول المفوض (GDAP)
...
حاليا، DAP مطلوب لتكئب العملاء على المنارة. نوصي أيضا بإنشاء GDAP مع العملاء لتمكين وصول مفوض أكثر أمانا. بينما يكون DAP و GDAP مترابطين، فإن GDAP سيكون له الأسبقية للعملاء حيث يكون النموذجان في مكانهما. قريبا، سيتمكن العملاء الذين لا يوجد معهم سوى GDAP (بدون DAP) من التمكن من الوصول إلى المنارة.<br><br>

| المشكلة | الوصف | الحل |
| ---------------- | ---------------- | ---------------- |
| **مشاكل أذونات GDAP المتنوعة عبر "المنارة"** | لا تمنح بعض أدوار GDAP نفسها مستوى الوصول إلى بيانات العملاء في "المنارة" نفسه الذي تمنحه في تجربة مستأجر واحد. إذا تم تعيين أي من الأدوار التالية بشكل فردي (هذا ليس مع أدوار GDAP الأخرى) لتقنيي MSP، فقد يواجهون أخطاء، بما في ذلك:<ul><li>يتعذر على مسؤولي أمان GDAP عرض المستخدمين الخطرين أو استبعاد المخاطر أو تأكيد المستخدمين المعرضين للخطر ضمن المنارة.</li><li>يتعذر على "قراء أمان GDAP" عرض المستخدمين الخطرين ضمن "المنارة".</li><li>يرى المسؤولون العامون في GDAP رسالة خطأ عند محاولة عرض حالة الخدمة ضمن المنارة.</li><li>يختبر المسؤولون العامون في GDAP مشاكل في نشر خطوات خطة النشر ضمن "المنارة".</li></ul> | الحل البديل هو تعيين مجموعة من أدوار GDAP لفنيي MSP استنادا إلى مستوى الوصول إلى بيانات العملاء التي يحتاجون إليها. للحصول على قائمة بأدوار GDAP المستحسنة لاستخدام المنارة، راجع نظرة عامة على الأذونات [في Microsoft 365 المنارة](m365-lighthouse-overview-of-permissions.md).<br><br>بالنسبة للقضايا التي لا تسمح فيها أذونات المسؤول العام ل GDAP باستخدام ميزة في "المنارة"، فإن الحل البديل هو الوصول إلى مركز الإدارة المناسب من مستأجر العميل لإدارة العميل (على سبيل المثال، الوصول إلى مركز مسؤولي Microsoft 365 من مستأجر العميل للتحقق من حالة الخدمة). للحصول على إرشادات حول كيفية تعديل علاقة GDAP، راجع الحصول على أذونات المسؤول المفرد لإدارة خدمة العميل [- مركز الشركاء](/partner-center/gdap-obtain-admin-permissions-to-manage-customer). |
