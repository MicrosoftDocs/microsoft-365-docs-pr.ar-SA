...
يتم تشغيل تكامل Moodle مع Microsoft Teams بواسطة مصدر مفتوح [مجموعة مكونات Microsoft 365 Moodle الإضافية](https://moodle.org/plugins/browse.php?list=set&id=72).
...
### <a name="create-azure-app"></a>إنشاء تطبيق Azure
...
### <a name="set-azure-app-details-in-moodle"></a>تعيين تفاصيل تطبيق Azure في Moodle
...
### <a name="configure-connection-between-microsoft-plugins-and-microsoft-services"></a>تكوين الاتصال بين مكونات Microsoft الإضافية وخدمات Microsoft
...
### <a name="configure-user-and-course-synchronization"></a>تكوين مزامنة المستخدم والدورة التدريبية
