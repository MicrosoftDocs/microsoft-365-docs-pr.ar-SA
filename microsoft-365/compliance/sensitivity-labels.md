...
- MOE150
- MET150
description: استخدم تسميات الحساسية من microsoft Purview حماية البيانات لتصنيف المحتوى الحساس وحمايته.
ms.custom:
- seo-marvel-apr2020
- seo-marvel-jun2020
...
تسمح لك تسميات الحساسية من Microsoft Purview حماية البيانات بتصنيف بيانات مؤسستك وحمايتها، مع التأكد من عدم إعاقة إنتاجية المستخدم وقدرته على التعاون.
...
لتطبيق أوصاف الحساسية، يجب تسجيل دخول المستخدمين باستخدام حساب العمل أو المؤسسة التعليمية Microsoft 365.

> [!NOTE]
> بالنسبة لمستأجري حكومة الولايات المتحدة، يتم دعم تسميات الحساسية لجميع الأنظمة الأساسية.
>
> إذا كنت تستخدم Azure حماية البيانات عميل وصف موحد وماسح ضوئي، فراجع [وصف خدمة Azure حماية البيانات Premium Government Service](/enterprise-mobility-security/solutions/ems-aip-premium-govt-service-description).
...
- **حماية المحتوى في تطبيقات Office عبر الأنظمة الأساسية والأجهزة المختلفة.** مدعومة من Word Excel PowerPoint Outlook على تطبيقات سطح المكتب Office Office على الويب. معتمد على Windows وmacOS وiOS وAndroid.
...
- **حماية الحاويات** التي تتضمن مواقع Teams مجموعات Microsoft 365 SharePoint. على سبيل المثال، قم بتعيين إعدادات الخصوصية والوصول الخارجي للمستخدم والمشاركة الخارجية والوصول من الأجهزة غير المدارة.
...
- **ضع علامة على المحتوى** عند استخدام تطبيقات Office، عن طريق إضافة علامات مائية أو رؤوس أو تذييلات إلى البريد الإلكتروني أو المستندات التي تم تطبيق التسمية عليها. يمكن تطبيق العلامات المائية على المستندات ولكن ليس على البريد الإلكتروني. مثال على الرأس والعلامة المائية:
    ...
    هل تحتاج إلى التحقق من وقت تطبيق علامات المحتوى؟ راجع [متى تطبق تطبيقات Office وضع علامة على المحتوى وتشفيره](sensitivity-labels-office-apps.md#when-office-apps-apply-content-marking-and-encryption).
...
- **تطبيق التسمية تلقائيا على الملفات ورسائل البريد الإلكتروني، أو التوصية بتسمية.** اختر كيفية تحديد المعلومات الحساسة التي تريد تسميتها، ويمكن تطبيق التسمية تلقائيا، أو يمكنك مطالبة المستخدمين بتطبيق التسمية التي توصي بها. إذا كنت توصي بتسمية، فإن المطالبة تعرض النص الذي تختاره. على سبيل المثال:
    ...
    لمزيد من المعلومات حول **الوصف التلقائي للملفات وإعدادات رسائل البريد الإلكتروني** عند إنشاء تسمية حساسية أو تحريرها، راجع [تطبيق تسمية حساسية على المحتوى تلقائيا](apply-sensitivity-label-automatically.md) لتطبيقات Office، [والتسمية في Microsoft Purview Data Map](/azure/purview/create-sensitivity-label).

- **تعيين نوع ارتباط المشاركة الافتراضي** لمواقع SharePoint والمستندات الفردية. للمساعدة في منع المستخدمين من المشاركة الزائدة، قم بتعيين [النطاق الافتراضي والأذونات](sensitivity-labels-default-sharing-link.md) الخاصة عندما يشارك المستخدمون المستندات من SharePoint OneDrive.
...
بعد إنشاء أوصاف الحساسية الخاصة بك، تحتاج إلى نشرها لجعلها متاحة للأشخاص والخدمات في مؤسستك. يمكن بعد ذلك تطبيق تسميات الحساسية على Office المستندات ورسائل البريد الإلكتروني والعناصر الأخرى التي تدعم تسميات الحساسية. 
...
- **حدد تسمية افتراضية** للمستندات ورسائل البريد الإلكتروني غير المسماة والحاويات الجديدة (عند [تمكين تسميات الحساسية Microsoft Teams ومجموعات Microsoft 365 ومواقع SharePoint](sensitivity-labels-teams-groups-sites.md)، والآن تسمية افتراضية [لمحتوى Power BI](/power-bi/admin/service-security-sensitivity-label-default-label-policy). يمكنك تحديد نفس التسمية لكافة أنواع العناصر الأربعة أو تسميات مختلفة. يمكن للمستخدمين تغيير تسمية الحساسية الافتراضية المطبقة لمطابقة حساسية المحتوى أو الحاوية بشكل أفضل.
    
    > [!NOTE]
    > في المعاينة لتطبيقات Office التي تستخدم تسميات مضمنة: يدعم هذا الإعداد الآن المستندات الموجودة عند فتحها من قبل المستخدمين، بالإضافة إلى المستندات الجديدة. يوفر هذا التغيير في السلوك التماثل مع عميل التسمية الموحد حماية البيانات Azure. لمزيد من المعلومات حول الإطلاق التدريجي لكل تطبيق والحد الأدنى من الإصدارات، راجع [جدول القدرات](sensitivity-labels-office-apps.md#sensitivity-label-capabilities-in-word-excel-and-powerpoint) ل Word Excel PowerPoint.
...
- **مطالبة المستخدمين بتطبيق تسمية** للمستندات ورسائل البريد الإلكتروني، والمستندات فقط، والحاويات، ومحتوى Power BI. تعرف هذه الخيارات أيضا بالتسمية الإلزامية، وتضمن تطبيق التسمية قبل أن يتمكن المستخدمون من حفظ المستندات وإرسال رسائل البريد الإلكتروني وإنشاء مجموعات أو مواقع جديدة وعندما يستخدمون محتوى غير مسمى ل Power BI.
    ...
    ![المطالبة في Outlook يطلب من المستخدم تطبيق التسمية المطلوبة.](../media/sensitivity-labels-mandatory-prompt-outlook.png)
...
بعد إنشاء نهج تسمية يعين تسميات حساسية جديدة للمستخدمين والمجموعات، يبدأ المستخدمون في رؤية هذه التسميات في تطبيقاتهم Office. السماح بما يصل إلى 24 ساعة لنسخ أحدث التغييرات نسخا متماثلا في جميع أنحاء مؤسستك.
...
تظهر أوصاف الحساسية المضمنة في Microsoft 365 Apps على Windows وmacOS وiOS وAndroid وتتصرف بشكل مشابه عبر هذه الأجهزة لتزويد المستخدمين بتجربة تسمية متسقة. ومع ذلك، على أجهزة الكمبيوتر Windows، يمكنك أيضا استخدام [عميل حماية البيانات Azure (AIP](/azure/information-protection/rms-client/aip-clientv2)). هذا العميل الآن في [وضع الصيانة](https://techcommunity.microsoft.com/t5/security-compliance-and-identity/announcing-aip-unified-labeling-client-maintenance-mode-and/ba-p/3043613).

إذا كنت تستخدم عميل AIP، فراجع [لماذا اختر تسمية مضمنة عبر الوظيفة الإضافية AIP لتطبيقات Office](sensitivity-labels-aip.md) لفهم خيارات التسمية وإدارتها لأجهزة الكمبيوتر Windows.
...
يمكنك أيضا التعرف على [حلول الشركاء المتكاملة مع microsoft Purview حماية البيانات](https://techcommunity.microsoft.com/t5/Azure-Information-Protection/Microsoft-Information-Protection-showcases-integrated-partner/ba-p/262657).
...
لمعرفة كيفية استخدام أوصاف الحساسية للامتثال للوائح خصوصية البيانات، راجع [نشر حماية المعلومات للوائح خصوصية البيانات مع Microsoft 365](../solutions/information-protection-deploy.md) (aka.ms/m365dataprivacy).
