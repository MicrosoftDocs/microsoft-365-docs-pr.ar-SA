...
- MOE150
- MET150
description: تعرف على كيفية حماية تسميات الحساسية من حماية البيانات في Microsoft Purview المحتوى الحساس لمؤسستك، أينما تم تخزينها.
ms.custom:
- seo-marvel-apr2020
- seo-marvel-jun2020
...
عند إنشاء أوصاف الحساسية الخاصة بك في مدخل التوافق في Microsoft Purview، فإنها تظهر في قائمة على علامة التبويب **الحساسية** على صفحة **التسميات**. في هذه القائمة، ترتيب التسميات مهم لأنه يعكس أولويتها. تريد أن تظهر تسمية الحساسية الأكثر تقييدا، مثل "سري للغاية"، في **أسفل** القائمة، وأن تظهر تسمية الحساسية الأقل تقييدا، مثل "عام"، في **الأعلى**.
...
يمكنك جعل تسميات الحساسية الخاصة بك متاحة للمستخدمين عن طريق نشرها في نهج وصف الحساسية الذي يظهر في قائمة على صفحة **نهج التسمية** . تماما مثل تسميات الحساسية (انظر [أولوية التسمية (ترتيب الأمور)،](#label-priority-order-matters)ترتيب نهج وصف الحساسية مهم لأنه يعكس أولويتها: يتم عرض نهج التسمية ذات الأولوية الأقل في أعلى القائمة مع **أقل** رقم ترتيب، ويتم عرض نهج التسمية ذات الأولوية الأعلى في أسفل القائمة مع **أعلى** رقم ترتيب.
...
يمكنك تضمين مستخدم في نهج تسميات متعددة، وسيحصل المستخدم على جميع تسميات الحساسية والإعدادات من تلك النهج. إذا كان هناك تعارض في الإعدادات من نهج متعددة، يتم تطبيق الإعدادات من النهج ذات الأولوية القصوى (أعلى رقم طلب). بمعنى آخر، ستفوز الأولوية القصوى لكل إعداد.

إذا كنت لا ترى سلوك إعداد نهج التسمية الذي تتوقعه لمستخدم أو مجموعة، فتحقق من ترتيب نهج وصف الحساسية. قد تحتاج إلى نقل النهج لأسفل. لإعادة ترتيب نهج التسمية، حدد نهج وصف الحساسية > اختيار علامة الحذف "إجراءات" لهذا الإدخال > **الانتقال لأسفل** أو **الانتقال لأعلى**. على سبيل المثال:

![نقل الخيار على الصفحة لنهج وصف الحساسية.](../media/sensitivity-label-policy-priority.png)

من مثال لقطة الشاشة الذي يعرض ثلاثة نهج تسمية، يتم تعيين نهج التسمية القياسي لجميع المستخدمين، لذلك من المناسب أن يكون له أقل أولوية (أقل عدد ترتيب من 0). يتم تعيين النهج الثاني الذي يحتوي على رقم الطلب 1 فقط للمستخدمين في قسم تكنولوجيا المعلومات. بالنسبة لهؤلاء المستخدمين، إذا كان هناك أي تعارضات في الإعدادات بين النهج الخاص بهم والنهج القياسي، فإن الإعدادات من نهجهم ستربح لأنها تحتوي على رقم ترتيب أعلى. 

وبالمثل بالنسبة للمستخدمين في القسم القانوني، الذين يتم تعيين النهج الثالث بإعدادات مميزة. من المحتمل أن يكون لدى هؤلاء المستخدمين إعدادات أكثر صرامة، لذلك من المناسب أن يكون لنهجهم أعلى رقم طلب. من غير المحتمل أن يكون مستخدم من القسم القانوني في مجموعة تم تعيينها أيضا إلى النهج الخاص بقسم تكنولوجيا المعلومات. ولكن إذا كانت موجودة، فإن الطلب رقم 2 (أعلى رقم طلب) يضمن أن الإعدادات من القسم القانوني تأخذ الأولوية دائما إذا كان هناك تعارض.

> [!NOTE]
> تذكر: إذا كان هناك تعارض في الإعدادات لمستخدم لديه نهج متعددة معينة له، يتم تطبيق الإعداد من النهج المعين مع أعلى رقم طلب.
