...
1. إعداد التدقيق (Premium) للمستخدمين. تتكون هذه الخطوة من المهام التالية:
   ...
   - تمكين تدقيق الأحداث الهامة ثم تشغيل تطبيق/خدمة التدقيق المتقدم لهؤلاء المستخدمين.

2. تمكين تسجيل أحداث التدقيق (Premium) عندما يقوم المستخدمون بإجراء عمليات بحث في Exchange Online SharePoint Online.

3. إعداد نهج استبقاء سجل التدقيق. بالإضافة إلى النهج الافتراضي الذي يحتفظ بسجلات تدقيق Exchange SharePoint وAzure AD لمدة عام واحد، يمكنك إنشاء نهج استبقاء سجل تدقيق إضافية لتلبية متطلبات عمليات الأمان وفرق تكنولوجيا المعلومات والتوافق في مؤسستك.
...
يمكن أن يساعد تدريب فريق عمليات الأمان ومسؤولي تكنولوجيا المعلومات وفريق المحققين في الامتثال على أساسيات التدقيق (القياسي) والتدقيق (Premium) مؤسستك على البدء بسرعة أكبر باستخدام التدقيق للمساعدة في تحقيقاتك. يوفر Microsoft 365 المورد التالي لمساعدة هؤلاء المستخدمين في مؤسستك على البدء في التدقيق: [وصف قدرات eDiscovery والتدقيق Microsoft 365](/learn/modules/describe-ediscovery-capabilities-of-microsoft-365).
