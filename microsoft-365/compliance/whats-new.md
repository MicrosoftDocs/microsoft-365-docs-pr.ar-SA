...
| حماية البيانات في Microsoft | حماية المعلومات في Microsoft Purview | تساعدك حماية المعلومات على اكتشاف المعلومات الحساسة وتصنيفها وحمايتها أينما كانت تعيش أو تنتقل. لمعرفة المزيد، راجع [حماية البيانات في Microsoft Purview](information-protection.md). |
