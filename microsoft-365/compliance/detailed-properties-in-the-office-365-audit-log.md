...
|Objectid|بالنسبة لتسجيل تدقيق مسؤول Exchange، اسم الكائن الذي تم تعديله بواسطة cmdlet.  <br/> بالنسبة لنشاط SharePoint، اسم مسار URL الكامل للملف أو المجلد الذي تم الوصول إليه من قبل مستخدم.  <br/> بالنسبة لنشاط Azure AD، اسم حساب المستخدم الذي تم تعديله.|الكل|
...
|معلمات|بالنسبة لنشاط مسؤول Exchange، الاسم والقيمة لكافة المعلمات التي تم استخدامها مع cmdlet الذي تم تعريفه في خاصية العملية.|Exchange (نشاط المسؤول)|
