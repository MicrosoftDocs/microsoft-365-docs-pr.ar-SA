...
5. أدخل المعلومات التالية عند مطالبتك من قبل البرنامج النصي. اكتب كل جزء من المعلومات ثم اضغط على **مفتاح الإدخال Enter**.
    ...
    يحصل البرنامج النصي على عناوين URL لكل موقع OneDrive for Business ثم ينشئ البحث ويبدأه. يمكنك إما تشغيل **الأمر Get-ComplianceSearch** cmdlet في Security & Compliance PowerShell لعرض إحصائيات البحث ونتائجه، أو يمكنك الانتقال إلى صفحة **البحث في المحتوى** في مدخل التوافق لعرض معلومات حول البحث.
