...
بعد الاتصال ب Security & Compliance Center PowerShell، فإن الخطوة التالية هي إنشاء وتشغيل البرنامج النصي الذي يجمع معلومات حول حالات eDiscovery في مؤسستك.
