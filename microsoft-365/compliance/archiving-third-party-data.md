...
تتوفر موصلات بيانات TeleMessage أيضا في بيئات GCC في سحابة Microsoft 365 US Government. لمزيد من المعلومات، راجع [موصلات البيانات في القسم السحابي لحكومة الولايات المتحدة](#data-connectors-in-the-us-government-cloud) في هذه المقالة.
...
قبل أن تتمكن من أرشفة بيانات الجهات الخارجية في Microsoft 365، يجب عليك العمل مع 17a-4 LLC لإعداد خدمة الأرشفة (تسمى *DataParser*) لمؤسستك. لمزيد من المعلومات، انقر فوق الارتباط الموجود في عمود **بيانات الجهات الخارجية** للانتقال إلى الإرشادات المفصلة خطوة بخطوة لإنشاء موصل لنوع البيانات هذا.

تتوفر أيضا موصلات بيانات 17a-4 في بيئات GCC في سحابة Microsoft 365 US Government. لمزيد من المعلومات، راجع [موصلات البيانات في القسم السحابي لحكومة الولايات المتحدة](#data-connectors-in-the-us-government-cloud) في هذه المقالة.
...
يتوفر موصل بيانات CellTrust SL2 أيضا في بيئات GCC في سحابة Microsoft 365 US Government. لمزيد من المعلومات، راجع [موصلات البيانات في القسم السحابي لحكومة الولايات المتحدة](#data-connectors-in-the-us-government-cloud) في هذه المقالة.
...
أدوات eDiscovery الأساسية الثلاث في Microsoft 365 هي البحث عن المحتوى Microsoft Purview eDiscovery (قياسي) Microsoft Purview eDiscovery (Premium).
...
تتوفر بعض موصلات البيانات في سحابة حكومة الولايات المتحدة. تشير الأقسام التالية إلى البيئات الحكومية المحددة التي تدعم موصلات بيانات الجهات الخارجية. لمزيد من المعلومات حول سحب حكومة الولايات المتحدة، راجع [Microsoft 365 US Government](/office365/servicedescriptions/office-365-platform-service-description/office-365-us-government/microsoft-365-government-how-to-buy).
...
|موصل البيانات  |دول مجلس التعاون الخليجي  |GCC High  |وزاره الدفاع  |
|:---------|:---------|:---------|:---------|
|CellTrust| نعم | لا | لا |
