...
description: بدلا من تصدير النتائج الفعلية للبحث في المحتوى في مدخل التوافق في Microsoft Purview، يمكنك تصدير تقرير نتائج البحث. يحتوي التقرير على ملخص لنتائج البحث ومستند يحتوي على معلومات مفصلة حول كل عنصر سيتم تصديره.
...
ms.locfileid: "66624256"
---
# <a name="export-a-content-search-report"></a>تصدير تقرير البحث في المحتوى

بدلا من تصدير مجموعة كاملة من نتائج البحث من بحث المحتوى في مدخل التوافق في Microsoft Purview (أو من عملية بحث مقترنة بحالة Microsoft Purview eDiscovery (قياسي)، يمكنك تصدير التقارير نفسها التي يتم إنشاؤها عند تصدير نتائج البحث الفعلية.
