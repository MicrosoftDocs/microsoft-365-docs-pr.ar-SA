...
عند البحث عن معلومات حساسة في المحتوى، تحتاج إلى وصف تلك المعلومات في ما يسمى *بالقاعدة*. يتضمن Microsoft Purview Data Loss Prevention (DLP) قواعد لأنواع المعلومات الحساسة الأكثر شيوعا التي يمكنك استخدامها على الفور. لاستخدام هذه القواعد، يجب تضمينها في نهج. قد تجد أنك تريد ضبط هذه القواعد المضمنة لتلبية الاحتياجات الخاصة بالمؤسسة، ويمكنك القيام بذلك عن طريق إنشاء نوع معلومات حساسة مخصص. يوضح لك هذا الموضوع كيفية تخصيص ملف XML الذي يحتوي على مجموعة القواعد الموجودة للكشف عن نطاق أوسع من معلومات بطاقة الائتمان المحتملة.
