---
title: نهج التنبيه Microsoft 365
f1.keywords:
- NOCSH
ms.author: markjjo
author: markjjo
...
1. يقوم المسؤول في مؤسستك بإنشاء نهج تنبيه وتكوينه وتشغيله باستخدام صفحة **نهج التنبيه** في مدخل التوافق أو مدخل Microsoft 365 Defender. يمكنك أيضا إنشاء نهج التنبيه باستخدام [New-ProtectionAlert](/powershell/module/exchange/new-protectionalert) cmdlet في Security & Compliance Center PowerShell.
...
انتقل إلى <a href="https://go.microsoft.com/fwlink/p/?linkid=2077139" target="_blank">مدخل Microsoft 365 Defender</a> وضمن **تعاون & البريد الإلكتروني**، حدد **نهج Policies &** **rulesAlert** > . بدلا من ذلك، يمكنك الانتقال مباشرة إلى <https://security.microsoft.com/alertpolicies>.
...
- **عند تشغيل التنبيه**. يمكنك تكوين إعداد يحدد عدد مرات حدوث نشاط قبل تشغيل تنبيه. يسمح لك هذا بإعداد نهج لإنشاء تنبيه في كل مرة يتطابق فيها النشاط مع شروط النهج، أو عند تجاوز حد معين، أو عندما يصبح حدوث النشاط الذي يتعقبه التنبيه غير عادي لمؤسستك.
    ...
    > [!NOTE]
    > تتطلب القدرة على تكوين نهج التنبيه استنادا إلى حد أو استنادا إلى نشاط غير عادي اشتراك E5/G5، أو اشتراك E1/F1/G1 أو E3/F3/G3 مع Microsoft Defender لـ Office 365 P2 أو التوافق في Microsoft 365 E5 أو Microsoft 365 eDiscovery والتدقيق الإضافي الاشتراك. يمكن للمؤسسات التي لها اشتراك E1/F1/G1 وE3/F3/G3 فقط إنشاء نهج تنبيه حيث يتم تشغيل تنبيه في كل مرة يحدث فيها نشاط.
...
توفر Microsoft نهج تنبيه مضمنة تساعد في تحديد إساءة استخدام أذونات المسؤول Exchange ونشاط البرامج الضارة والتهديدات الخارجية والداخلية المحتملة ومخاطر إدارة المعلومات. في صفحة **نهج التنبيه** ، تكون أسماء هذه النهج المضمنة غامق ويتم تعريف نوع النهج على أنه **نظام**. يتم تشغيل هذه النهج بشكل افتراضي. يمكنك إيقاف تشغيل هذه النهج (أو إعادة تشغيلها مرة أخرى)، وإعداد قائمة بالمستلمين لإرسال إعلامات البريد الإلكتروني إليها، وتعيين حد إعلام يومي. لا يمكن تحرير الإعدادات الأخرى لهذه النهج.
...
|:-----|:-----|:-----|:-----|:-----|
|**تم الكشف عن نقرة URL يحتمل أن تكون ضارة**|ينشئ تنبيها عندما ينقر مستخدم محمي بواسطة [ارتباطات خزينة](../security/office-365-security/safe-links.md) في مؤسستك فوق ارتباط ضار. يتم تشغيل هذا الحدث عند تحديد تغييرات حكم URL بواسطة Microsoft Defender لـ Office 365 أو عندما يتجاوز المستخدمون صفحات ارتباطات خزينة (استنادا إلى نهج الارتباطات Microsoft 365 للأعمال خزينة الخاصة بمؤسستك). نهج التنبيه هذا له إعداد **عالي** الخطورة. بالنسبة لعملاء Defender لـ Office 365 P2 وE5 وG5، يقوم هذا التنبيه تلقائيا بتشغيل [التحقيق التلقائي والاستجابة في Office 365](../security/office-365-security/office-365-air.md). لمزيد من المعلومات حول الأحداث التي تقوم بتشغيل هذا التنبيه، راجع [إعداد نهج الارتباطات خزينة](../security/office-365-security/set-up-safe-links-policies.md).|إدارة المخاطر|نعم|اشتراك الوظيفة الإضافية E5/G5 أو Defender لـ Office 365 P2|
...
|**رفع امتياز المسؤول Exchange**|إنشاء تنبيه عند تعيين أذونات إدارية لشخص ما في مؤسستك Exchange Online. على سبيل المثال، عند إضافة مستخدم إلى مجموعة دور إدارة المؤسسة في Exchange Online. يحتوي هذا النهج على إعداد **منخفض** الخطورة.|الأذونات|لا|E1/F1/G1 أو E3/F3/G3 أو E5/G5|
...
|**تم تسليم التصيد الاحتيالي بسبب تجاوز ETR**|ينشئ تنبيها عندما تكتشف Microsoft قاعدة نقل Exchange (ETR) تسمح بتسليم رسالة تصيد احتيالي عالية الثقة إلى علبة بريد. يحتوي هذا النهج على إعداد خطورة **إعلامية** . لمزيد من المعلومات حول Exchange قواعد النقل (قواعد تدفق البريد)، راجع [قواعد تدفق البريد (قواعد النقل) في Exchange Online](/exchange/security-and-compliance/mail-flow-rules/mail-flow-rules).|إدارة المخاطر|لا|E1/F1/G1 أو E3/F3/G3 أو E5/G5|
...
|**نشاط ملف مستخدم خارجي غير عادي**|ينشئ تنبيها عند تنفيذ عدد كبير بشكل غير عادي من الأنشطة على الملفات في SharePoint أو OneDrive من قبل مستخدمين من خارج مؤسستك. يتضمن ذلك أنشطة مثل الوصول إلى الملفات وتنزيل الملفات وحذف الملفات. يحتوي هذا النهج على إعداد **عالي** الخطورة.|إدارة المعلومات|لا|اشتراك الوظيفة الإضافية E5/G5 أو Microsoft Defender لـ Office 365 P2 أو Microsoft 365 E5|
|**وحدة تخزين غير عادية لمشاركة الملفات الخارجية**|ينشئ تنبيها عند مشاركة عدد كبير بشكل غير عادي من الملفات في SharePoint أو OneDrive مع مستخدمين من خارج مؤسستك. يحتوي هذا النهج على إعداد **خطورة متوسطة** .|إدارة المعلومات|لا|اشتراك الوظيفة الإضافية E5/G5 أو Defender لـ Office 365 P2 أو Microsoft 365 E5|
|**وحدة تخزين غير عادية لحذف الملف**|ينشئ تنبيها عند حذف عدد كبير بشكل غير عادي من الملفات في SharePoint أو OneDrive ضمن إطار زمني قصير. يحتوي هذا النهج على إعداد **خطورة متوسطة** .|إدارة المعلومات|لا|اشتراك الوظيفة الإضافية E5/G5 أو Defender لـ Office 365 P2 أو Microsoft 365 E5|
|**زيادة غير عادية في البريد الإلكتروني الذي تم الإبلاغ عنه على أنه تصيد احتيالي**|ينشئ تنبيها عند وجود زيادة ملحوظة في عدد الأشخاص في مؤسستك الذين يستخدمون الوظيفة الإضافية "رسالة التقرير" Outlook للإبلاغ عن الرسائل كمراسلات تصيد احتيالي. يحتوي هذا النهج على إعداد **خطورة متوسطة** . لمزيد من المعلومات حول هذه الوظيفة الإضافية، راجع [استخدام الوظيفة الإضافية "رسالة التقرير](https://support.office.com/article/b5caa9f1-cdf3-4443-af8c-ff724ea719d2)".|إدارة المخاطر|لا|اشتراك الوظيفة الإضافية E5/G5 أو Defender لـ Office 365 P2|
|**تم تسليم تصيد احتيالي لانتحال هوية المستخدم إلى علبة الوارد/**<sup>المجلد1,2</sup><sup></sup>|ينشئ تنبيها عندما تكتشف Microsoft أن المسؤول أو المستخدم قد سمح بتسليم رسالة تصيد احتيالي لانتحال هوية المستخدم إلى علبة الوارد (أو مجلد آخر يمكن للمستخدم الوصول إليه) من علبة البريد. تتضمن أمثلة التجاوزات قاعدة تدفق البريد أو علبة الوارد التي تسمح بالرسائل من مرسل أو مجال معين، أو نهج مكافحة البريد العشوائي الذي يسمح بالرسائل من مرسلين أو مجالات معينة. يحتوي هذا النهج على إعداد **خطورة متوسطة** .|إدارة المخاطر|لا|اشتراك الوظيفة الإضافية E5/G5 أو Defender لـ Office 365 P2|
...
انتقل إلى <a href="https://go.microsoft.com/fwlink/p/?linkid=2077139" target="_blank">مدخل Microsoft 365 Defender</a> ثم حدد **Incidents & alertsAlerts** > . بدلا من ذلك، يمكنك الانتقال مباشرة إلى <https://security.microsoft.com/alerts>.
...
- **مصدر.** استخدم عامل التصفية هذا لإظهار التنبيهات التي يتم تشغيلها بواسطة نهج التنبيه في مركز الامتثال أو التنبيهات التي يتم تشغيلها بواسطة نهج أمان التطبيقات على السحابة لـ Office 365 أو كليهما. لمزيد من المعلومات حول تنبيهات أمان التطبيقات على السحابة لـ Office 365، راجع [عرض تنبيهات Defender for Cloud Apps](#viewing-cloud-app-security-alerts).
...
عندما تحدث أحداث متعددة تطابق شروط نهج التنبيه مع فترة زمنية قصيرة، تتم إضافتها إلى تنبيه موجود بواسطة عملية تسمى *تجميع التنبيه*. عندما يقوم حدث بتشغيل تنبيه، يتم إنشاء التنبيه وعرضه على صفحة **التنبيهات** ويتم إرسال إعلام. إذا حدث الحدث نفسه ضمن الفاصل الزمني للتجميع، Microsoft 365 يضيف تفاصيل حول الحدث الجديد إلى التنبيه الموجود بدلا من تشغيل تنبيه جديد. الهدف من تجميع التنبيهات هو المساعدة في تقليل "الإرهاق" للتنبيه والسماح لك بالتركيز واتخاذ إجراء على عدد أقل من التنبيهات لنفس الحدث.
...
- يمكن لأعضاء مجموعة دور إدارة السجلات عرض التنبيهات التي يتم إنشاؤها بواسطة نهج التنبيه التي تم تعيينها لفئة **إدارة المعلومات** فقط.
...
|دور|إدارة المعلومات|منع فقدان البيانات|تدفق البريد|الأذونات|إدارة المخاطر|الاخرين|
|:---------|:---------:|:---------:|:---------:|:---------:|:---------:|:---------:|
|سجلات التدقيق|||||||
|إدارة الحالة|||||||
...
يتم الآن عرض التنبيهات التي يتم تشغيلها بواسطة نهج أمان التطبيقات على السحابة لـ Office 365 على صفحة **التنبيهات** في مركز التوافق. ويشمل ذلك التنبيهات التي يتم تشغيلها بواسطة نهج النشاط والتنبيهات التي يتم تشغيلها بواسطة نهج الكشف عن الحالات الشاذة في أمان التطبيقات على السحابة لـ Office 365. وهذا يعني أنه يمكنك عرض جميع التنبيهات في مركز الامتثال. يتوفر أمان التطبيقات على السحابة لـ Office 365 فقط للمؤسسات التي لها اشتراك Office 365 Enterprise E5 أو Office 365 Us Government G5. لمزيد من المعلومات، راجع [نظرة عامة على Defender for Cloud Apps](/cloud-app-security/what-is-cloud-app-security).

يمكن للمؤسسات التي لديها Microsoft Defender for Cloud Apps كجزء من اشتراك Enterprise Mobility + Security E5 أو كخدمة مستقلة عرض تنبيهات Defender for Cloud Apps المرتبطة بتطبيقات وخدمات Microsoft 365 في مدخل التوافق أو مدخل Microsoft 365 Defender.
