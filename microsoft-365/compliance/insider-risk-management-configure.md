...
- **تشغيل التدقيق**: عند التشغيل، يتم تسجيل نشاط المستخدم والمسؤول في مؤسستك في سجل تدقيق Microsoft 365. تستخدم سياسات المخاطر والتحليلات الداخلية هذا السجل للكشف عن أنشطة المخاطر.
...
هناك ست مجموعات أدوار تستخدم لتكوين ميزات إدارة المخاطر الداخلية. لتوفير **إدارة المخاطر ل Insider** كخيار قائمة في مدخل التوافق في Microsoft Purview ولمتابعة خطوات التكوين هذه، يجب تعيينك إلى أحد الأدوار أو مجموعات الأدوار التالية:
...
- مجموعة أدوار *Insider Risk Management مسؤول*
...
تستخدم إدارة المخاطر الداخلية سجلات تدقيق Microsoft 365 للحصول على رؤى المستخدم والأنشطة المحددة في السياسات ونتائج التحليلات. تعد سجلات تدقيق Microsoft 365 ملخصا لجميع الأنشطة داخل مؤسستك وقد تستخدم نهج إدارة المخاطر الداخلية هذه الأنشطة لإنشاء رؤى النهج.
...
لتمكين Insider risk Analytics، يجب أن تكون عضوا في مجموعة دور مسؤول *Insider أو Insider* *Risk Management مسؤول* أو Microsoft 365 *Global admin*.
...
### <a name="configure-microsoft-365-hr-connector"></a>تكوين موصل Microsoft 365 HR
...
موصل Microsoft 365 HR مطلوب عند استخدام قوالب النهج التالية:
...
راجع [إعداد موصل لاستيراد مقالة بيانات الموارد البشرية](import-hr-data.md) للحصول على إرشادات مفصلة خطوة بخطوة لتكوين موصل Microsoft 365 HR لمؤسستك. بعد تكوين موصل الموارد البشرية، ارجع إلى خطوات التكوين هذه.
...
مطلوب موصل Microsoft 365 Healthcare أو Epic عند استخدام قوالب النهج التالية:
...
1. في [مدخل التوافق في Microsoft Purview](https://compliance.microsoft.com)، انتقل إلى **إدارة المخاطر في Insider** وحدد **إعدادات مخاطر Insider** من الزاوية العلوية اليسرى من أي صفحة.
...
11. إذا حددت **أنني أريد تحديد مواقع SharePoint وتسميات الحساسية وأنواع المعلومات الحساسة و/أو ملحقات الملفات كمحتوى ذي أولوية** في الخطوة السابقة، فسترى صفحات التفاصيل لمواقع *SharePoint* *وأنواع المعلومات الحساسة* *وتسميات الحساسية* *وملحقات الملفات*. استخدم صفحات التفاصيل هذه لتعريف SharePoint وأنواع المعلومات الحساسة وتسميات الحساسية وملحقات الملفات لتحديد أولويات النهج.
