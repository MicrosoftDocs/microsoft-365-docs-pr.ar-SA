...
Teams أكثر من مجرد الدردشات ورسائل القناة. إذا كان لديك فرق تم إنشاؤها من مجموعة Microsoft 365 (مجموعة Office 365 سابقا)، يجب تكوين نهج استبقاء يتضمن مجموعة Microsoft 365 باستخدام موقع مجموعات Microsoft 365. ينطبق نهج الاستبقاء هذا على المحتوى في علبة بريد المجموعة، وفي موقعها، وملفاتها.
...
> [!NOTE]
> لا تقوم نهج الاستبقاء Yammer حاليا بإبلاغ المستخدمين عند حذف الرسائل نتيجة لنهج استبقاء.
>
...
Yammer أكثر من مجرد رسائل المجتمع والرسائل الخاصة. للاحتفاظ برسائل البريد الإلكتروني Yammer الشبكة وحذفها، قم بتكوين نهج استبقاء إضافي يتضمن Microsoft 365 المجموعات المستخدمة Yammer، باستخدام **مجموعات Microsoft 365 الموقع.** 

للاحتفاظ بالملفات المخزنة في Yammer وحذفها، ستحتاج إلى نهج استبقاء يتضمن موقع مجموعات Microsoft 365 أو  **OneDrive الحسابات:**
...
إذا كانت بعض عناصر Exchange أو SharePoint أو OneDrive أو مجموعات Microsoft 365 تحتاج إلى إعدادات استبقاء مختلفة من إعدادات نهج الاستبقاء التي قمت بتكوينها، فنشئ تسميات استبقاء لهذه [الاستثناءات](create-retention-labels-information-governance.md).
