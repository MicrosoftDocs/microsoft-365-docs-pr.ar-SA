...
4. استنادا إلى النطاق المحدد:
    ...
    - إذا اخترت **ثابت**: في الصفحة اختيار **مواقع** لتطبيق النهج، حدد موقعا واحدا أو أكثر Teams:
        - **Teams القناة**: الرسائل الواردة من دردشات القناة القياسية واجتماعات القنوات القياسية، ولكن ليس [](/microsoftteams/private-channels) من القنوات الخاصة التي لها موقع نهج خاص بها.
