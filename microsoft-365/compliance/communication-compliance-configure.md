...
ms.locfileid: "65317013"
---
# <a name="get-started-with-communication-compliance"></a>بدء العمل باستخدام توافق الاتصالات

[!include[Purview banner](../includes/purview-rebrand-banner.md)]

استخدم نهج توافق الاتصالات لتحديد اتصالات المستخدم للفحص من قبل المراجعين الداخليين أو الخارجيين. لمزيد من المعلومات حول كيفية مساعدة نهج توافق الاتصالات في مراقبة الاتصالات في مؤسستك، راجع [نهج توافق الاتصالات](communication-compliance.md). إذا كنت ترغب في مراجعة كيفية تكوين Contoso لنهج توافق الاتصالات بسرعة لمراقبة المحتوى غير المناسب في الاتصالات Microsoft Teams Exchange Online Yammer، فراجع [دراسة الحالة](communication-compliance-case-study.md) هذه.
...
يتم الكشف عن النشاط الذي يتضمن [أنواع معلومات حساسة](/microsoft-365/compliance/communication-compliance-policies#sensitive-information-types) في الرسائل التي تغطيها النهج الحالية والرسائل التي لا تغطيها النهج الحالية. يتم تجميع Insights لجميع أنواع المعلومات الحساسة، بما في ذلك تلك التي لم تحددها مؤسستك مسبقا في نهج توافق الاتصالات الحالي. استخدم هذه الرؤى لإنشاء نهج توافق اتصالات جديد أو لتحديث النهج الموجودة.
...
يتمتع أعضاء الأدوار التالية بنفس أذونات الحل المضمنة في مجموعة دور *مسؤول توافق الاتصالات* :
...
1. سجل الدخول [https://compliance.microsoft.com/permissions](https://compliance.microsoft.com/permissions) باستخدام بيانات الاعتماد لحساب مسؤول في مؤسستك Microsoft 365.
...
1. سجل الدخول إلى [مدخل التوافق في Microsoft Purview](https://compliance.microsoft.com) باستخدام بيانات الاعتماد لحساب مسؤول في مؤسستك Microsoft 365، ثم انتقل إلى **الأذونات**</a>.
...
|:-----|:-----|:-----|
|المستخدمون الخاضعون للإشراف <br> المستخدمون المستبعدون | مجموعات التوزيع <br> مجموعات Microsoft 365 | مجموعات التوزيع الديناميكية <br> مجموعات التوزيع المتداخلة <br> مجموعات الأمان الممكنة للبريد <br> مجموعات Microsoft 365 ذات عضوية ديناميكية |
| المراجعين | بلا | مجموعات التوزيع <br> مجموعات التوزيع الديناميكية <br> مجموعات التوزيع المتداخلة <br> مجموعات الأمان الممكنة للبريد |

عند تعيين *مجموعة توزيع* في النهج، يراقب النهج جميع رسائل البريد الإلكتروني Teams الدردشات من كل مستخدم في *مجموعة التوزيع*. عند تعيين *مجموعة Microsoft 365* في النهج، يراقب النهج جميع رسائل البريد الإلكتروني والدردشات Teams المرسلة إلى *مجموعة Microsoft 365*،* وليس رسائل البريد الإلكتروني والدردشات الفردية التي يتلقاها كل عضو في المجموعة. يوصى باستخدام مجموعات التوزيع في نهج توافق الاتصالات بحيث تتم مراقبة رسائل البريد الإلكتروني الفردية والدردشات Teams من كل مستخدم تلقائيا.

إذا كنت مؤسسة ذات نشر محلي Exchange أو موفر بريد إلكتروني خارجي وتريد مراقبة Microsoft Teams الدردشات للمستخدمين، فيجب إنشاء مجموعة توزيع للمستخدمين الذين لديهم علب بريد محلية أو خارجية للمراقبة. لاحقا في هذه الخطوات، ستقوم بتعيين مجموعة التوزيع هذه **كمستخدمين خاضعين للإشراف والمجموعات** المحددة في معالج النهج. لمزيد من المعلومات حول متطلبات وقيود تمكين التخزين المستند إلى السحابة ودعم Teams للمستخدمين المحليين، راجع [البحث عن بيانات دردشة Teams للمستخدمين المحليين](search-cloud-based-mailboxes-for-on-premises-users.md).
...
2. حدد [سمة مخصصة Exchange](/Exchange/recipients/mailbox-custom-attributes) غير مستخدمة لتعقب المستخدمين الذين تمت إضافتهم إلى نهج توافق الاتصالات في مؤسستك.
...
في الوضع الأصلي، يكون جميع مستخدمي Yammer في Azure Active Directory (Azure AD)، وجميع المجموعات هي مجموعات Office 365، ويتم تخزين جميع الملفات في SharePoint Online. يجب أن يكون مستأجر Yammer في الوضع الأصلي لنهج توافق الاتصالات لفحص المحادثات المحفوفة بالمخاطر وتحديدها في الرسائل الخاصة ومحادثات المجتمع في Yammer.

لمزيد من المعلومات حول تكوين Yammer في الوضع الأصلي، راجع:

- [نظرة عامة على الوضع الأصلي Yammer في Microsoft 365](/yammer/configure-your-yammer-network/overview-native-mode)
- [تكوين شبكة Yammer الخاصة بك من أجل الوضع الأصلي Microsoft 365](/yammer/configure-your-yammer-network/native-mode)
...
4. حدد **إنشاء نهج** لإنشاء نهج جديد وتكوينه من قالب أو لإنشاء نهج مخصص وتكوينه.
    ...
    > [!NOTE]
    > إذا كنت تريد تمكين [التعرف البصري على الحروف (OCR)](communication-compliance-policies.md#optical-character-recognition-ocr) لمسح الصور المضمنة أو المرفقة في الرسائل بحثا عن نص مطبوع أو مكتوب بخط اليد يتوافق مع شروط النهج، فحدد **تخصيص** **policyConditions** >  والنسبة المئوية وتمكين **استخراج النص المطبوع أو المكتوب بخط اليد من الصور للتقييم**.
    ...
    - اختر قنوات الاتصال التي تريد فحصها، بما في ذلك Exchange أو Microsoft Teams أو Yammer أو Skype for Business. ستختار أيضا فحص مصادر الجهات الخارجية إذا قمت بتكوين موصل في Microsoft 365.

    - اختر اتجاه الاتصال الذي تريد مراقبته، بما في ذلك الاتصالات الواردة أو الصادرة أو الداخلية.

    - تحديد [شروط](communication-compliance-policies.md#ConditionalSettings) نهج توافق الاتصالات. يمكنك الاختيار من بين عنوان الرسالة والكلمة الأساسية وأنواع الملفات وشروط مطابقة الحجم.
...
بعد إنشاء نهج توافق الاتصالات، من المستحسن اختباره للتأكد من أن الشروط التي حددتها يتم فرضها بشكل صحيح بواسطة النهج. قد تحتاج أيضا إلى [اختبار نهج تفادي فقدان البيانات في Microsoft Purview (DLP)](create-test-tune-dlp-policy.md) إذا كانت نهج التوافق مع الاتصالات تتضمن أنواع معلومات حساسة. تأكد من منح النهج الخاصة بك الوقت للتنشيط بحيث يتم التقاط الاتصالات التي تريد اختبارها.
...
2. أرسل رسالة بريد إلكتروني أو Microsoft Teams دردشة أو رسالة Yammer تفي بالمعايير التي حددتها في نهج توافق الاتصالات. يمكن أن يكون هذا الاختبار كلمة أساسية وحجم مرفق ومجال وما إلى ذلك. تأكد من تحديد ما إذا كانت الإعدادات الشرطية التي تم تكوينها في النهج مقيدة جدا أو مخففة جدا.

    > [!NOTE]
    > قد تستغرق معالجة رسائل البريد الإلكتروني في النهج بالكامل حوالي 24 ساعة. يمكن أن تستغرق الاتصالات في الأنظمة الأساسية Microsoft Teams Yammer والجهات الخارجية حوالي 48 ساعة للمعالجة الكاملة في النهج.

3. سجل الدخول إلى Microsoft 365 كمراجع معين في نهج التوافق مع الاتصالات. انتقل إلى **Communication** **complianceAlerts** >  لعرض التنبيهات الخاصة بنهجك.
...
لمعرفة المزيد حول التحقق من تنبيهات توافق الاتصالات، راجع [التحقيق في تنبيهات توافق الاتصالات ومعالجتها](communication-compliance-investigate-remediate.md).
