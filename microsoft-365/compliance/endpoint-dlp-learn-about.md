...
|Activity |الوصف  |Windows 10 1809 والإي وقت لاحق/ Windows 11| macOS Catalina 10.15 والإيائل | قابل للتدقيق/قابل للتدقيق|
|---------|---------|---------|---------|---------|
|التحميل إلى خدمة السحابة، أو الوصول بواسطة المستعرضات غير مسموح بها    | الكشف عن الوقت الذي يحاول فيه المستخدم تحميل عنصر إلى مجال خدمة مقيد أو الوصول إلى عنصر من خلال مستعرض.  إذا كانوا يستخدمون مستعرضا مدرجا في DLP كمستعرض غير مسموح به، فسيتم حظر نشاط التحميل وتتم إعادة توجيه المستخدم لاستخدام Microsoft Edge. سيقوم Microsoft Edge بعد ذلك بالسماح بالتحميل أو الوصول أو حظره استنادا إلى تكوين نهج DLP         |مدعم | مدعم|قابل للتدقيق وقابل للتقييد|
|نسخ إلى تطبيق آخر    |الكشف عن الوقت الذي يحاول فيه المستخدم نسخ المعلومات من عنصر محمي ثم لصقها في تطبيق أو عملية أو عنصر آخر. لا يتم الكشف عن نسخ المعلومات ولصقها داخل نفس التطبيق أو العملية أو العنصر بواسطة هذا النشاط.|مدعم|مدعم         | قابل للتدقيق وقابل للتقييد|
|نسخ إلى وسائط USB القابلة للإزالة |الكشف عن الوقت الذي يحاول فيه المستخدم نسخ عنصر أو معلومات إلى وسائط قابلة للإزالة أو جهاز USB.|مدعم|مدعم         | قابل للتدقيق وقابل للتقييد|
|نسخ إلى مشاركة شبكة    |الكشف عن الوقت الذي يحاول فيه مستخدم نسخ عنصر إلى مشاركة شبكة أو محرك أقراص شبكة معين |مدعم|مدعم         |قابل للتدقيق وقابل للتقييد|
|طباعة مستند    |الكشف عن الوقت الذي يحاول فيه المستخدم طباعة عنصر محمي إلى طابعة محلية أو طابعة شبكة.|مدعم|مدعم|قابل للتدقيق وقابل للتقييد         |
|نسخ إلى جلسة عمل بعيدة|الكشف عن الوقت الذي يحاول فيه مستخدم نسخ عنصر إلى جلسة عمل سطح مكتب بعيد |مدعم|غير معتمد|  قابل للتدقيق وقابل للتقييد|
|نسخ إلى جهاز Bluetooth|الكشف عن الوقت الذي يحاول فيه المستخدم نسخ عنصر إلى تطبيق Bluetooth غير مسموح به (كما هو محدد في قائمة عناوين Bluetooth aps غير مسموح بها في إعدادات DLP لنقطة النهاية).|مدعم|غير معتمد| قابل للتدقيق وقابل للتقييد|
|إنشاء عنصر|الكشف عن وقت قيام مستخدم بإنشاء عنصر|مدعم |مدعم |القابله|
|إعادة تسمية عنصر|الكشف عن وقت قيام مستخدم بإعادة تسمية عنصر|مدعم |مدعم |القابله|
