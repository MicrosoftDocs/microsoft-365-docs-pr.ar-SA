...
|---------|---------|---------|---------|---------|
|التحميل إلى خدمة السحابة، أو الوصول بواسطة المستعرضات غير مسموح بها    | الكشف عن الوقت الذي يحاول فيه المستخدم تحميل عنصر إلى مجال خدمة مقيد أو الوصول إلى عنصر من خلال مستعرض.  إذا كانوا يستخدمون مستعرضا مدرجا في DLP كمستعرض غير مسموح به، فسيتم حظر نشاط التحميل وتتم إعادة توجيه المستخدم لاستخدام Microsoft Edge. سيقوم Microsoft Edge بعد ذلك بالسماح بالتحميل أو الوصول أو حظره استنادا إلى تكوين نهج DLP         |دعم | دعم|قابل للتدقيق وقابل للتقييد|
...
|نسخ إلى جهاز Bluetooth|الكشف عن الوقت الذي يحاول فيه المستخدم نسخ عنصر إلى تطبيق Bluetooth غير مسموح به (كما هو محدد في قائمة عناوين Bluetooth aps غير مسموح بها في إعدادات DLP لنقطة النهاية).|دعم|غير معتمد| قابل للتدقيق وقابل للتقييد|
