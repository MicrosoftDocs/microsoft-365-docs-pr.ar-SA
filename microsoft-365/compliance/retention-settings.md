...
- **يتم تعيين عناوين البريد الإلكتروني** إلى **وكيل** اسم LDAP، الذي يتم عرضه **كعنوان وكيل** في مركز إدارة Azure AD.
...
1. في [مركز التوافق في Microsoft 365](https://compliance.microsoft.com/)، انتقل إلى أحد المواقع التالية:
    ...
    - إذا كنت تستخدم حل إدارة المعلومات:
       - **حلول** >  **إدارة** >  المعلومات علامة تبويب **النطاقات التكيفية** > + **Create scope**
...
3. تحقق من أن الإخراج يطابق المستخدمين أو المجموعات المتوقعة لنطاقك التكيفي. إذا لم يكن كذلك، فتحقق من الاستعلام والقيم مع المسؤول ذي الصلة ل Azure AD أو Exchange.
...
عند تكوين تسمية استبقاء أو نهج للاحتفاظ بالمحتوى، يمكنك اختيار الاحتفاظ بالعناصر لعدد معين من الأيام أو الأشهر أو السنوات. أو بدلا من ذلك، احتفظ بالعناصر إلى الأبد. لا يتم حساب فترة الاستبقاء من وقت تعيين النهج، ولكن وفقا لبداية فترة الاستبقاء المحددة.
...
عادة ما يكون هذا التحديث سريعا إلى حد ما ولكن قد يستغرق عدة أيام. عند اكتمال النسخ المتماثل للنهج عبر مواقع Microsoft 365، سترى حالة نهج الاستبقاء في مركز التوافق في Microsoft 365 تغيير من **تشغيل (معلق)** إلى **تشغيل (نجاح).**
