...
لبدء استخدام eDiscovery الأساسي، إليك سير عمل بسيط لإنشاء قوائم احتجاز eDiscovery للأشخاص ذوي الاهتمام، والبحث عن المحتوى ذي الصلة بالتحقيق الخاص بك، ثم تصدير تلك البيانات لمزيد من المراجعة. في كل من هذه الخطوات، سنسلط الضوء أيضا على بعض وظائف eDiscovery الموسعة (القياسية) التي يمكنك استكشافها.
