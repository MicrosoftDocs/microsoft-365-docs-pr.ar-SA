...
description: تعرف على مدخل توافق Microsoft Purview، بما في ذلك ما يحتوي عليه، وكيفية الحصول عليه، والخطوات التالية.
...
ms.locfileid: "64970770"
---
# <a name="microsoft-purview-compliance-portal"></a>مدخل توافق Microsoft Purview

[!include[Purview banner](../includes/purview-rebrand-banner.md)]

إذا كنت مهتما بوضع الامتثال لمؤسستك، فستحب مدخل <a href="https://go.microsoft.com/fwlink/p/?linkid=2077149" target="_blank">الامتثال ل Microsoft Purview</a>. يوفر مدخل الامتثال ل Microsoft Purview وصولا سهلا إلى البيانات والأدوات التي تحتاج إلى إدارتها لتلبية احتياجات الامتثال لمؤسستك.
...
[![الصفحة الرئيسية لمدخل الامتثال ل Microsoft Purview.](../media/m365-compliance-center-home.png)](https://compliance.microsoft.com)
...
![مقدمة مدخل الامتثال ل Microsoft Purview.](../media/m365-compliance-center-welcome-steps.png)
...
- راجع بطاقة **Microsoft Purview Compliance Manager** ، التي تقودك إلى حل [Compliance Manager](compliance-manager.md) . يساعد Compliance Manager على تبسيط الطريقة التي تدير بها التوافق. وهي تحسب درجة تستند إلى المخاطر تقيس تقدمك نحو إكمال الإجراءات الموصى بها التي تساعد على تقليل المخاطر المتعلقة بحماية البيانات والمعايير التنظيمية. كما يوفر قدرات سير العمل وتعيين التحكم المضمن لمساعدتك على تنفيذ إجراءات التحسين بكفاءة.
    ...
    ![Compliance Manager card Microsoft Purview compliance portal.](../media/m365-compliance-center-compliance-manager-card.png)
...
- راجع بطاقة **كتالوج Solution** الجديدة، التي ترتبط بمجموعات [الحلول المتكاملة](microsoft-365-solution-catalog.md) التي يمكنك استخدامها لمساعدتك في إدارة سيناريوهات التوافق الشاملة. قد تتضمن قدرات الحل وأدواته مزيجا من النهج والتنبيهات والتقارير والمزيد.
    ...
    ![مدخل توافق بطاقة كتالوج الحلول ل Microsoft Purview.](../media/m365-compliance-center-solution-catalog-card.png)
...
- راجع بطاقة **التنبيهات النشطة** ، التي تتضمن ملخصا [للتنبيهات الأكثر نشاطا](alert-policies.md) وتتضمن ارتباطا حيث يمكنك عرض معلومات أكثر تفصيلا، مثل الخطورة والحالة والفئة والمزيد.
    ...
    ![بوابة توافق Microsoft Purview لبطاقة التنبيهات النشطة.](../media/m365-compliance-center-active-alerts-card.png)
