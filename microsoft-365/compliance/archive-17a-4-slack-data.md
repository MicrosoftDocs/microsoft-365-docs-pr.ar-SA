...
1. انتقل إلى <https://compliance.microsoft.com> **موصلات** >  البيانات ثم انقر فوق **Slack DataParser**.
...
سيقوم موصل Slack DataParser بتعيين المستخدمين تلقائيا إلى عناوين بريدهم الإلكتروني في Microsoft 365 قبل استيراد البيانات إلى Microsoft 365.
