...
| وصف الحد | الحد |
|:-----|:-----|
|الحد الأقصى لعدد نهج الاحتجاز لمؤسسة. يتضمن هذا الحد الإجمالي المدمج لنهج الاحتجاز في Microsoft Purview eDiscovery (قياسي) وحالات Microsoft Purview eDiscovery (Premium). <br/> |10,000<sup>3</sup>  <br/> |
...
|الحد الأقصى لعدد الأحرف لاستعلام البحث ل SharePoint ومواقع OneDrive for Business (بما في ذلك عوامل التشغيل والشروط).|10,000<br>4000 مع أحرف البدل<sup>5</sup>|
...
|الحد الأقصى لعدد العناصر من SharePoint ومواقع OneDrive for Business المعروضة على صفحة المعاينة لعمليات البحث. يتم عرض أحدث العناصر.|200|
|الحد الأقصى لعدد مواقع SharePoint ومواقع OneDrive for Business التي يمكن معاينتها للحصول على نتائج البحث. إذا كان هناك أكثر من 200 موقع تحتوي على عناصر تتطابق مع استعلام البحث، فإن أفضل 200 موقع مع معظم النتائج فقط متوفرة للمعاينة.|200|
...
<sup>2</sup> تتم مشاركة هذا الحد مع تصدير المحتوى في أدوات eDiscovery الأخرى. وهذا يعني أن عمليات التصدير المتزامنة في البحث عن المحتوى وeDiscovery (قياسي) (وإضافة محتوى إلى مجموعات المراجعة في eDiscovery (Premium)) يتم تطبيقها جميعا مقابل هذا الحد.
...
<sup>5</sup> عند البحث في SharePoint ومواقع OneDrive for Business، يتم حساب الأحرف الموجودة في عناوين URL للمواقع التي يتم البحث فيها مقابل هذا الحد. يتكون العدد الإجمالي للأحرف من:

  - كافة الأحرف في الحقلين "المستخدمون" و"عوامل التصفية".
  - كافة عوامل تصفية أذونات البحث التي تنطبق على المستخدم.
  - الأحرف من أي خصائص موقع في البحث، بما في ذلك ExchangeLocation و PublicFolderLocation وSharePointLocation وExchangeLocationExclusion و PublicFolderLocationExclusion وSharePointLocationExclusion وOneDriveLocationExclusion. على سبيل المثال، سيتم احتساب كل مواقع SharePoint وحسابات OneDrive في البحث على أنها ستة أحرف، حيث ستظهر الكلمة "الكل" لكل من حقل SharePointLocation وحقل OneDriveLocation.
