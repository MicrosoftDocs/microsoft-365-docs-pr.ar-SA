...
| وصف الحد | الحد |
|:-----|:-----|
|الحد الأقصى لعدد نهج الاحتجاز لمؤسسة. يتضمن هذا الحد الإجمالي المدمج لنهج الاحتجاز في حالات Microsoft Purview eDiscovery (Standard) وMicrosoft Purview eDiscovery (Premium). <br/> |100003<sup></sup>  <br/> |
...
>
> <sup>7</sup> ينطبق هذا الحد على تنزيل المستندات المحددة من مجموعة مراجعة. لا ينطبق على تصدير المستندات من مجموعة مراجعة. لمزيد من المعلومات حول تنزيل المستندات وتصديرها، راجع [بيانات حالة التصدير في eDiscovery (Premium).](exporting-data-ediscover20.md)
