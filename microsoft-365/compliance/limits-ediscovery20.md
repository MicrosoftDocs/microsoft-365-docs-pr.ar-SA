...
|وصف الحد|الحد|
|---|---|
|العدد الإجمالي للمستندات التي يمكن إضافتها إلى حالة (لكافة مجموعات المراجعة في حالة ما).|ما يصل إلى 40 مليون (تنسيق حالة جديدة)|
|إجمالي حجم الملف لكل مجموعة تحميل. يتضمن ذلك تحميل غير Office 365 في مجموعة مراجعة.|حتى 1 تيرابايت (تنسيق حالة جديدة)|
