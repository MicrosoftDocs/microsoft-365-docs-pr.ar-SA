...
description: دراسة حالة لشركة Contoso وكيفية تكوينها لنهج توافق الاتصالات بسرعة لمراقبة النصوص غير المناسبة في اتصالات Microsoft Teams وExchange Online وYamer.
...
- اشتراك Office 365 Enterprise E3 + الوظيفة الإضافية التوافق المتقدم ل Office 365 (لم تعد متوفرة للاشتراكات الجديدة، راجع الملاحظة)
...
> [!IMPORTANT]
> لم يعد الامتثال المتقدم ل Office 365 يباع كتشترك مستقل. عند انتهاء صلاحية الاشتراكات الحالية، يجب على العملاء الانتقال إلى أحد الاشتراكات أعلاه، والتي تحتوي على نفس ميزات التوافق أو ميزات التوافق الإضافية.

يتخذ مسؤولو تكنولوجيا المعلومات في Contoso الخطوات التالية للتحقق من دعم الترخيص لشركة Contoso:

1. يقوم مسؤولو تكنولوجيا المعلومات بتسجيل الدخول إلى مركز <https://admin.microsoft.com> إدارة Microsoft 365 والانتقال إلى مركز مسؤولي Microsoft 365 ><a href="https://go.microsoft.com/fwlink/p/?linkid=842264" target="_blank">**تراخيص**</a> **الفوترة** > .
...
للوصول إلى توافق الاتصالات عند البدء من مركز إدارة Microsoft 365، يقوم مسؤولو تكنولوجيا المعلومات في Contoso ومتخصصو التوافق بتسجيل الدخول إلى مركز إدارة Microsoft 365 [(https://admin.microsoft.com)](https://admin.microsoft.com) وانتقل إلى [مدخل توافق Microsoft Purview](https://compliance.microsoft.com)

![ارتباط توافق الاتصالات.](../media/communication-compliance-case-compliance-link.png)

يفتح هذا الإجراء **مركز الأمان والتوافق في Office 365**، ويجب عليهم تحديد الارتباط إلى **مدخل توافق Microsoft Purview** المتوفر في الشعار في أعلى الصفحة.

![مركز الأمان والتوافق في Office 365.](../media/communication-compliance-case-scc.png)
...
يتطلب توافق الاتصالات أن يكون مستأجر Yammer لمؤسسة ما في الوضع الأصلي لمراقبة النص غير المناسب في الرسائل الخاصة ومحادثات المجتمع العام.
...
يرغب متخصصو التوافق في Contoso في إضافة جميع المستخدمين إلى نهج الاتصال الذي سيراقب النص غير المناسب. يمكنهم أن يقرروا إضافة كل حساب مستخدم إلى النهج بشكل منفصل، لكنهم قرروا أنه من الأسهل بكثير ويوفر الوقت لاستخدام مجموعة توزيع **جميع المستخدمين** للمستخدمين لهذا النهج.

إنهم بحاجة إلى إنشاء مجموعة جديدة لتضمين جميع مستخدمي Contoso، حتى يتخذوا الخطوات التالية:

1. يقوم مسؤولو تكنولوجيا المعلومات في Contoso بتسجيل الدخول إلى مركز مسؤولي Microsoft 365 [(https://admin.microsoft.com)](https://admin.microsoft.com) وانتقل إلى مركز مسؤولي Microsoft 365 > **Groups** > <a href="https://go.microsoft.com/fwlink/p/?linkid=2052855" target="_blank">**Groups**</a>.
