...
|الحد الأقصى لعدد عمليات البحث التي يمكن أن يبدأها مستخدم واحد في نفس الوقت. من المرجح أن يتم الوصول إلى هذا الحد عندما يحاول المستخدم بدء عمليات بحث متعددة باستخدام الأمر **Get-ComplianceSearch \|Start-ComplianceSearch** في Security & Compliance Center PowerShell.|10|
