---
title: إعداد موصل أرشفة بيانات دردشة ICE Connect في Microsoft 365
f1.keywords:
- NOCSH
...
description: تعرف على كيفية إعداد موصل 17a-4 ICE Connect Chat DataParser واستخدامه لاستيراد بيانات ICE Connect Chat وأرشفتها في Microsoft 365.
ms.openlocfilehash: 4700226893585f7f5f949ec581cecc7c05464e68
ms.sourcegitcommit: c29fc9d7477c3985d02d7a956a9f4b311c4d9c76
ms.translationtype: MT
ms.contentlocale: ar-SA
ms.lasthandoff: 07/06/2022
ms.locfileid: "66640237"
---
# <a name="set-up-a-connector-to-archive-ice-connect-chat-data"></a>إعداد موصل أرشفة بيانات دردشة ICE Connect

استخدم [ICE DataParser](https://www.17a-4.com/ice-dataparser/) من 17a-4 LLC لاستيراد البيانات وأرشفتها من ICE Connect Chat إلى علب بريد المستخدمين في مؤسسة Microsoft 365. يتضمن DataParser موصل دردشة ICE الذي تم تكوينه لالتقاط العناصر من مصدر بيانات تابع لجهة خارجية واستيراد هذه العناصر إلى Microsoft 365. يحول موصل ICE DataParser بيانات دردشة ICE Connect إلى تنسيق رسالة بريد إلكتروني ثم يستورد هذه العناصر إلى علب بريد المستخدمين في Microsoft 365.

بعد تخزين بيانات دردشة ICE Connect في علب بريد المستخدمين، يمكنك تطبيق ميزات Microsoft Purview مثل احتجاز التقاضي وeDiscovery ونهج الاستبقاء وتسميات الاستبقاء وتوافق الاتصالات. يمكن أن يساعد استخدام موصل ICE DataParser لاستيراد البيانات وأرشفتها في Microsoft 365 مؤسستك على البقاء متوافقة مع السياسات الحكومية والتنظيمية.

## <a name="overview-of-archiving-ice-chat-data"></a>نظرة عامة على أرشفة بيانات ICE Chat

تشرح النظرة العامة التالية عملية استخدام موصل بيانات أرشفة بيانات ICE Connect Chat في Microsoft 365.

![أرشفة سير العمل لبيانات دردشة ICE Connect من 17a-4.](../media/ICEChatDataParserConnectorWorkflow.png)

1. تعمل مؤسستك مع 17a-4 لإعداد وتكوين ICE DataParser.

2. بشكل منتظم، يتم تجميع عناصر ICE Connect Chat بواسطة DataParser. يقوم DataParser أيضا بتحويل محتوى رسالة إلى تنسيق رسالة بريد إلكتروني.
...
4. يتم إنشاء مجلد فرعي في مجلد علبة الوارد يسمى **ICE DataParser** في علب بريد المستخدمين، ويتم استيراد عناصر دردشة ICE Connect إلى هذا المجلد. يحدد الموصل علبة البريد التي تريد استيراد العناصر إليها باستخدام قيمة خاصية *"البريد الإلكتروني* ". يحتوي كل عنصر دردشة ICE Connect على هذه الخاصية، والتي يتم ملؤها بعنوان البريد الإلكتروني لكل مشارك.
...
الخطوة الأولى هي الوصول إلى صفحة موصلات البيانات في مدخل التوافق وإنشاء موصل 17a-4 لبيانات دردشة ICE Connect.

1. انتقل إلى <https://compliance.microsoft.com> **موصلات** >  البيانات ثم انقر فوق **ICE DataParser**.
...
سيقوم موصل ICE DataParser تلقائيا بتعيين المستخدمين إلى عناوين بريدهم الإلكتروني في Microsoft 365 قبل استيراد البيانات إلى Microsoft 365.
