...
استخدم صفحة **الترتيب** من **إدارة السجلات** في مدخل توافق Microsoft Purview لإدارة مراجعات الترتيب وعرض بيانات تعريف [السجلات](records-management.md#records) التي تم حذفها تلقائيا في نهاية فترة الاستبقاء الخاصة بها.
...
للوصول بنجاح إلى علامة التبويب **"الترتيب** " في مدخل توافق Microsoft Purview، يجب أن يكون للمستخدمين دور **"إدارة الترتيب** ". اعتبارا من ديسمبر 2020، يتم الآن تضمين هذا الدور في مجموعة الأدوار الافتراضية **لإدارة السجلات** .
...
- لعرض محتويات العناصر أثناء عملية الترتيب، أضف مستخدمين إلى مجموعة دور **عارض محتوى Content Explorer** . إذا لم يكن لدى المستخدمين الأذونات من مجموعة الأدوار هذه، فلا يزال بإمكانهم تحديد إجراء مراجعة الترتيب لإكمال مراجعة الترتيب، ولكن يجب عليهم القيام بذلك دون أن يتمكنوا من عرض محتويات العنصر من جزء المعاينة المصغرة في مدخل توافق Microsoft Purview.

- بشكل افتراضي، يرى كل شخص يصل إلى صفحة **"الترتيب** " العناصر التي تم تعيينها لمراجعتها فقط. لكي يتمكن مسؤول إدارة السجلات من رؤية كافة العناصر المعينة لكافة المستخدمين، وكافة تسميات الاستبقاء التي تم تكوينها لمراجعة الترتيب: انتقل إلى **إعدادات إدارة السجلات** >  لتحديد مجموعة أمان ممكنة للبريد تحتوي على حسابات المسؤول ثم تمكينها.
    
    لا تدعم مجموعات Microsoft 365 ومجموعات الأمان غير الممكنة للبريد هذه الميزة ولا يتم عرضها في القائمة للتحديد. إذا كنت بحاجة إلى إنشاء مجموعة أمان جديدة ممكنة للبريد، فاستخدم الارتباط <a href="https://go.microsoft.com/fwlink/p/?linkid=2024339" target="_blank">إلى مركز مسؤولي Microsoft 365</a> لإنشاء المجموعة الجديدة. 
    
    > [!IMPORTANT]
    > بعد تمكين المجموعة، لا يمكنك تغييرها في مدخل توافق Microsoft Purview. راجع القسم التالي لمعرفة كيفية تمكين مجموعة مختلفة باستخدام PowerShell.
...
بعد تمكين مجموعة أمان للتصرف من **إعدادات إدارة السجلات** في مدخل توافق Microsoft Purview، لا يمكنك تعطيل هذا الإذن للمجموعة أو استبدال المجموعة المحددة في مدخل توافق Microsoft Purview. ومع ذلك، يمكنك تمكين مجموعة أمان أخرى ممكنة للبريد باستخدام [Enable-ComplianceTagStorage](/powershell/module/exchange/enable-compliancetagstorage) cmdlet.
...
تأكد من تمكين التدقيق قبل يوم واحد على الأقل من إجراء الترتيب الأول. لمزيد من المعلومات، راجع [البحث في سجل التدقيق في مدخل توافق Microsoft Purview](search-the-audit-log-in-security-and-compliance.md). 
...
يتلقى المستخدمون إعلاما أوليا بالبريد الإلكتروني لكل تسمية في نهاية فترة استبقاء العنصر، مع تذكير لكل تسمية مرة في الأسبوع بجميع مراجعات الترتيب التي تم تعيينها لهم. يمكنهم النقر فوق الارتباط في رسائل البريد الإلكتروني للإعلام والتذكير للانتقال مباشرة إلى صفحة **إدارة** >  **السجلات** في مدخل توافق Microsoft Purview لمراجعة المحتوى واتخاذ إجراء. بدلا من ذلك، يمكن للمراجعين الانتقال إلى صفحة **الترتيب** هذه في مدخل توافق Microsoft Purview. ثم:
...
![صفحة الترتيب في مدخل الامتثال ل Microsoft Purview.](../media/disposition-tab.png)
...
تشغيل مراجعة الترتيب في نهاية فترة الاستبقاء هو خيار تكوين يتوفر فقط مع تسمية الاستبقاء. مراجعة الترتيب غير متوفرة لنهج الاستبقاء. لمزيد من المعلومات حول حلي الاستبقاء هذين، راجع [التعرف على نهج الاستبقاء وتسميات الاستبقاء](retention.md).

من الصفحة **"تعريف إعدادات الاستبقاء** " لتسمية استبقاء:

![إعدادات الاستبقاء للتسمية.](../media/disposition-review-option.png)
 
بعد تحديد خيار **"Trigger a disposition review** "، في الصفحة التالية من التكوين، يمكنك تحديد عدد المراحل المتتالية من الترتيب التي تريدها ومراجعي الترتيب لكل مرحلة:
...
بالنسبة للمراجعين، حدد مستخدما أو مجموعة أمان ممكنة للبريد. مجموعات Microsoft 365 ([مجموعات Office 365 سابقا](https://techcommunity.microsoft.com/t5/microsoft-365-blog/office-365-groups-will-become-microsoft-365-groups/ba-p/1303601)) غير معتمدة لهذا الخيار.
...
> [!NOTE]
> إذا قمت بتكوين تسميات الاستبقاء قبل توفر مراجعة الترتيب متعددة المراحل، يمكنك ترقية التسميات لدعم هذه الميزة: في معالج التسميات، حدد **"إضافة مرحلة**"، أو قم بتحرير المراجعين الحاليين أو إضافة مراجعين جدد.

أثناء مرحلة التكوين، لكل مرحلة محددة، يمكنك إعادة تسميتها أو إعادة ترتيبها أو إزالتها عن طريق تحديد خيار إجراءات المرحلة (**...**): 
...
من أي من صفحات إدارة السجلات في مدخل توافق Microsoft Purview، حدد **إعدادات إدارة السجلات**:  
...
عندما يتم إعلام المراجع بالبريد الإلكتروني بأن المحتوى جاهز للمراجعة، يمكنه النقر فوق ارتباط في البريد الإلكتروني ينقله مباشرة إلى صفحة **الترتيب** من **إدارة السجلات** في مدخل توافق Microsoft Purview. هناك، يمكن للمراجعين معرفة عدد العناصر لكل تسمية استبقاء قيد الانتظار مع **النوع** الذي يعرض **الترتيب المعلقة**. ثم يحددون تسمية استبقاء، **ويفتحون في نافذة جديدة** لمشاهدة كل المحتوى الذي يحتوي على هذه التسمية:
...
- **الموافقة على التخلص**:
    ...
    - عند تحديد هذا الإجراء للمرحلة النهائية من مراجعة الترتيب، أو عند وجود مرحلة واحدة فقط من الترتيب: يتم وضع علامة على العنصر على أنه مؤهل للحذف الدائم، والذي تتخذه مهمة المؤقت بعد ذلك في غضون 7 أيام. يعتمد التوقيت الدقيق لحذف العنصر نهائيا بعد ذلك على حمل العمل. لمزيد من المعلومات، راجع [كيفية عمل الاستبقاء SharePoint OneDrive](retention-policies-sharepoint.md#how-retention-works-for-sharepoint-and-onedrive) [وكيفية عمل الاستبقاء Exchange](retention-policies-exchange.md#how-retention-works-for-exchange).
