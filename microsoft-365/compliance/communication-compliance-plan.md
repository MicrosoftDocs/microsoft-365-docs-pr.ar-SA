...
- جميع المؤسسات لديها معايير اتصال واحتياجات سياسة مختلفة. الكشف عن كلمات أساسية معينة باستخدام [شروط نهج](communication-compliance-policies.md#conditional-settings) التوافق مع الاتصالات أو الكشف عن أنواع معينة من المعلومات مع [أنواع المعلومات الحساسة المخصصة](create-a-custom-sensitive-information-type.md).
