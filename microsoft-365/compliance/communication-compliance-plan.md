...
للحصول على معلومات حول التقاعد للإشراف في Office 365، راجع [مخطط Microsoft 365](https://www.microsoft.com/microsoft-365/roadmap) للحصول على التفاصيل.

## <a name="work-with-stakeholders-in-your-organization"></a>العمل مع المساهمين في مؤسستك

حدد أصحاب المصلحة المناسبين في مؤسستك للتعاون في اتخاذ إجراءات بشأن تنبيهات التوافق مع الاتصالات. بعض أصحاب المصلحة الموصى بهم للنظر في تضمينهم في التخطيط الأولي [وسير عمل الامتثال للاتصالات](communication-compliance.md#workflow) من طرف إلى طرف هم أشخاص من المجالات التالية في مؤسستك:
...
يعد إنشاء نهج توافق الاتصالات سريعا وسهلا مع [القوالب المحددة مسبقا](communication-compliance-policies.md#policy-templates) للمحتوى غير المناسب والمعلومات الحساسة والتوافق التنظيمي. تسمح نهج الامتثال للاتصالات المخصصة بالمرونة للكشف عن المشكلات الخاصة بمؤسستك ومتطلباتها والتحقيق فيها.
...
- يمكنك فحص الاتصالات من [مصادر الجهات الخارجية](communication-compliance-channels.md#third-party-sources) بحثا عن البيانات المستوردة إلى علب البريد في مؤسسة Microsoft 365. لتضمين مراجعة الاتصالات في هذه الأنظمة الأساسية، ستحتاج إلى تكوين موصل لهذه الخدمات قبل مراقبة الرسائل التي تفي بشروط النهج بواسطة نهج الاتصال.
- يمكن أن تدعم النهج لغات المراقبة بخلاف اللغة الإنجليزية في نهج الامتثال للاتصالات المخصصة. أنشئ [قاموس كلمات أساسية مخصصا](communication-compliance-policies.md#custom-keyword-dictionaries) للكلمات المسيئة باللغة التي تختارها أو أنشئ نموذج التعلم الآلي الخاص بك باستخدام [مصنفات قابلة للتدريب](classifier-get-started-with.md) في Microsoft 365.
- جميع المؤسسات لديها معايير اتصال واحتياجات سياسة مختلفة. مراقبة الكلمات الأساسية المحددة باستخدام [شروط نهج](communication-compliance-policies.md#conditional-settings) التوافق مع الاتصالات أو مراقبة أنواع معينة من المعلومات مع [أنواع المعلومات الحساسة المخصصة](create-a-custom-sensitive-information-type.md).
...
لتكوين توافق الاتصالات لمؤسستك Microsoft 365، راجع [تكوين توافق الاتصالات](communication-compliance-configure.md) أو الاطلاع على [دراسة الحالة لشركة Contoso](communication-compliance-case-study.md) وكيفية تكوينها بسرعة لنهج توافق الاتصالات لمراقبة المحتوى غير المناسب في Microsoft Teams Exchange Online Yammer  الاتصالات.
