...
ms.locfileid: "66627338"
---
# <a name="track-relevance-analysis-in-ediscovery-premium"></a>تعقب تحليل الصلة في eDiscovery (Premium)
  
في Microsoft Purview eDiscovery (Premium)، تعرض علامة التبويب "تعقب الصلة" الصلاحية المحسوبة لتدريب الصلة الذي تم إجراؤه في علامة التبويب "علامة" وتشير إلى الخطوة التالية التي يجب اتخاذها في عملية التدريب التكراري في الصلة. 
...
إذا كانت هناك حالات عدم تناسق في وضع علامات الملفات، فقد يؤثر ذلك على التحليل. يمكن استخدام عملية تناسق وضع العلامات eDiscovery (Premium) عندما لا تكون النتائج مثالية أو عندما يكون التناسق مريبا. يتم إرجاع قائمة بالملفات ذات العلامات غير المتناسقة المحتملة، ويمكن مراجعتها وإعادة ضبطها، حسب الضرورة.
...
يعرض جزء **إحصائيات التدريب** الإحصائيات والرسومات البيانية استنادا إلى نتائج التدريب على صلة eDiscovery (Premium). 
