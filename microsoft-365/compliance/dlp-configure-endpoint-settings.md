...
افتح Microsoft [Purview compliance portalData](https://compliance.microsoft.com) >  **loss preventionEndpoint** >  **DLP settingsFile** **path exclusions** > .
...
يتم تحديد نطاق التفاعلات بين **أنشطة "الملف" للتطبيقات في مجموعات التطبيقات المقيدة (معاينة)** **وأنشطة "ملف" لكافة التطبيقات** **وقائمة أنشطة التطبيقات المقيدة** إلى القاعدة نفسها.

##### <a name="restricted-app-groups-overrides"></a>تجاوز مجموعات التطبيقات المقيدة

تتجاوز التكوينات المعرفة في **أنشطة "الملف" للتطبيقات في مجموعات التطبيقات المقيدة (معاينة)** التكوينات في قائمة **أنشطة التطبيقات المقيدة** **وأنشطة "الملف" لكافة التطبيقات** في نفس القاعدة.
...
إذا لم يكن أحد التطبيقات في **أنشطة "الملف" للتطبيقات في مجموعات التطبيقات المقيدة (معاينة)** أو لم يكن في قائمة **أنشطة التطبيقات المقيدة** أو كان في قائمة **أنشطة التطبيقات المقيدة** مع إجراء `Audit only`، أو "حظر مع تجاوز"، يتم تطبيق أي قيود معرفة في **أنشطة "الملف" لكافة التطبيقات** في القاعدة نفسها.  
...
- [Azure Active Directory (AAD (دليل Azure النشط)) منضم](/azure/active-directory/devices/concept-azure-ad-join)
