...
| **انتهاكات نهج الأمان العامة** | تم الكشف عن التهرب الدفاعي من عناصر التحكم في الأمان أو البرامج غير المرغوب فيها من قبل Microsoft Defender لنقطة النهاية | اشتراك Microsoft Defender النشط لنقطة النهاية <br><br> تكامل Microsoft Defender لنقطة النهاية مع مدخل توافق Microsoft Purview الذي تم تكوينه |
...
| **انتهاكات نهج الأمان من قبل المستخدمين المغادرين** | مؤشرات تاريخ الإنهاء أو الإنهاء من موصل الموارد البشرية أو حذف حساب Azure Active Directory | (اختياري) موصل Microsoft 365 HR الذي تم تكوينه لمؤشرات تاريخ الإنهاء وتاريخ الإنهاء <br><br> اشتراك Microsoft Defender النشط لنقطة النهاية <br><br> تكامل Microsoft Defender لنقطة النهاية مع مدخل توافق Microsoft Purview الذي تم تكوينه |
| **انتهاكات نهج الأمان من قبل المستخدمين ذات الأولوية** | تم الكشف عن التهرب الدفاعي من عناصر التحكم في الأمان أو البرامج غير المرغوب فيها من قبل Microsoft Defender لنقطة النهاية | اشتراك Microsoft Defender النشط لنقطة النهاية <br><br> تكامل Microsoft Defender لنقطة النهاية مع مدخل توافق Microsoft Purview الذي تم تكوينه <br><br> مجموعات المستخدمين ذات الأولوية التي تم تكوينها في إعدادات المخاطر الداخلية |
| **انتهاكات نهج الأمان من قبل المستخدم الساخط** | مؤشرات تحسين الأداء أو الأداء الضعيف أو تغيير مستوى الوظيفة من موصل الموارد البشرية | تم تكوين موصل Microsoft 365 HR لمؤشرات عدم الإسهاب <br><br> اشتراك Microsoft Defender النشط لنقطة النهاية <br><br> تكامل Microsoft Defender لنقطة النهاية مع مدخل توافق Microsoft Purview الذي تم تكوينه |
