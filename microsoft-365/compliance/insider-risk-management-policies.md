...
description: تعرف على نهج إدارة المخاطر الداخلية في Microsoft 365
...
عند استخدام هذا القالب، يجب أيضا تكوين موصل Microsoft 365 HR لاستيراد بيانات ملف تعريف المؤسسة للمستخدمين في مؤسستك بشكل دوري. راجع استيراد البيانات باستخدام مقالة موصل الموارد البشرية للحصول على إرشادات مفصلة خطوة بخطوة لتكوين موصل الموارد البشرية Microsoft 365 لمؤسستك.
...
|**انتهاكات نهج الأمان العامة**|تم الكشف عن التهرب الدفاعي من عناصر التحكم الأمنية أو البرامج غير المرغوب فيها بواسطة Microsoft Defender لنقطة النهاية|اشتراك Microsoft Defender لنقطة النهاية النشط <br><br> Microsoft Defender لنقطة النهاية التكامل مع تكوين مركز التوافق في Microsoft 365|
...
|**انتهاكات نهج الأمان من قبل المستخدمين المغادرين**|مؤشرات تاريخ الإنهاء أو الإنهاء من موصل الموارد البشرية أو حذف حساب Azure Active Directory|(اختياري) Microsoft 365 موصل الموارد البشرية الذي تم تكوينه لمؤشرات الإنهاء وتاريخ الإنهاء <br><br> اشتراك Microsoft Defender لنقطة النهاية النشط <br><br> Microsoft Defender لنقطة النهاية التكامل مع تكوين مركز التوافق في Microsoft 365|
|**انتهاكات نهج الأمان من قبل المستخدمين ذات الأولوية**|تم الكشف عن التهرب الدفاعي من عناصر التحكم الأمنية أو البرامج غير المرغوب فيها بواسطة Microsoft Defender لنقطة النهاية|اشتراك Microsoft Defender لنقطة النهاية النشط <br><br> Microsoft Defender لنقطة النهاية التكامل مع تكوين مركز التوافق في Microsoft 365 <br><br> مجموعات المستخدمين ذات الأولوية التي تم تكوينها في إعدادات المخاطر الداخلية|
|**انتهاكات نهج الأمان من قبل المستخدم الساخط**|مؤشرات تحسين الأداء أو الأداء الضعيف أو تغيير مستوى الوظيفة من موصل الموارد البشرية|Microsoft 365 موصل الموارد البشرية الذي تم تكوينه لمؤشرات عدم الإسهاب <br><br> اشتراك Microsoft Defender لنقطة النهاية النشط <br><br> Microsoft Defender لنقطة النهاية التكامل مع تكوين مركز التوافق في Microsoft 365|

## <a name="prioritize-content-in-policies"></a>تحديد أولويات المحتوى في النهج

تدعم نهج إدارة المخاطر الداخلية تحديد أولوية أعلى للمحتوى اعتمادا على مكان تخزينه أو كيفية تصنيفه. يؤدي تحديد المحتوى كأولوية إلى زيادة درجة المخاطر لأي نشاط مرتبط، ما يزيد بدوره من فرصة إنشاء تنبيه عالي الخطورة. ومع ذلك، لن تنشئ بعض الأنشطة تنبيها على الإطلاق ما لم يتضمن المحتوى ذي الصلة أنواع معلومات حساسة مضمنة أو مخصصة أو تم تحديدها كأولوية في النهج.
...
لإنشاء نهج جديد لإدارة المخاطر الداخلية، ستستخدم معالج النهج في حل **إدارة المخاطر ل Insider** في مركز التوافق في Microsoft 365.
...
لتحديث نهج إدارة المخاطر الداخلية الحالي، ستستخدم معالج النهج في حل **إدارة المخاطر ل Insider** في مركز التوافق في Microsoft 365.
