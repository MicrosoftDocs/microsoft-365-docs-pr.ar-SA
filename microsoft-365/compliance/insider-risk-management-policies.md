...
description: تعرف على نهج إدارة المخاطر الداخلية في Microsoft Purview
...
تعد حماية بيانات سجل الرعاية الصحية ومنع إساءة استخدام البيانات الشخصية للمرضى مصدر قلق كبير للمؤسسات في مجال الرعاية الصحية. قد يتضمن سوء الاستخدام هذا تسرب بيانات سرية إلى أشخاص غير مصرح لهم، أو تعديل سجلات المرضى بشكل احتيالي، أو سرقة سجلات الرعاية الصحية للمرضى. كما أن منع إساءة استخدام بيانات المرضى هذه، إما عن طريق نقص الوعي أو الإهمال أو الاحتيال من قبل المستخدمين هو أيضا مكون رئيسي في تلبية المتطلبات التنظيمية لقانون نقل التأمين الصحي والمساءلة (HIPAA) وقانون تكنولوجيا المعلومات الصحية من أجل الصحة الاقتصادية والسريرية (HITECH). يحدد كلا العملين متطلبات حماية المعلومات الصحية المحمية للمرضى (PHI).
...
| :------------------ | :--------------------------------- | :---------------- |
| **سرقة البيانات من قبل المستخدمين المغادرين** | مؤشر تاريخ الإنهاء أو الإنهاء من موصل الموارد البشرية أو حذف حساب Azure Active Directory | (اختياري) Microsoft 365 موصل الموارد البشرية الذي تم تكوينه لمؤشرات الإنهاء وتاريخ الإنهاء |
...
| **تسرب البيانات من قبل المستخدمين الساخطين** | مؤشرات تحسين الأداء أو الأداء الضعيف أو تغيير مستوى الوظيفة من موصل الموارد البشرية | Microsoft 365 موصل الموارد البشرية الذي تم تكوينه لمؤشرات عدم الإسهاب |
...
| **إساءة استخدام بيانات المرضى العامة** | التهرب الدفاعي من عناصر التحكم الأمنية من أنظمة EMR <br><br> مؤشرات مطابقة عنوان المستخدم والمرضى من أنظمة الموارد البشرية | مؤشرات الوصول إلى الرعاية الصحية المحددة في إعدادات السياسة أو المخاطر الداخلية <br><br> Microsoft 365 موصل الموارد البشرية الذي تم تكوينه لمطابقة العنوان <br><br> تم تكوين Microsoft Healthcare أو Epic connector |
| **انتهاكات نهج الأمان من قبل المستخدمين المغادرين** | مؤشرات تاريخ الإنهاء أو الإنهاء من موصل الموارد البشرية أو حذف حساب Azure Active Directory | (اختياري) Microsoft 365 موصل الموارد البشرية الذي تم تكوينه لمؤشرات الإنهاء وتاريخ الإنهاء <br><br> اشتراك Microsoft Defender لنقطة النهاية النشط <br><br> Microsoft Defender لنقطة النهاية التكامل مع تكوين مدخل التوافق في Microsoft Purview |
...
| **انتهاكات نهج الأمان من قبل المستخدم الساخط** | مؤشرات تحسين الأداء أو الأداء الضعيف أو تغيير مستوى الوظيفة من موصل الموارد البشرية | Microsoft 365 موصل الموارد البشرية الذي تم تكوينه لمؤشرات عدم الإسهاب <br><br> اشتراك Microsoft Defender لنقطة النهاية النشط <br><br> Microsoft Defender لنقطة النهاية التكامل مع تكوين مدخل التوافق في Microsoft Purview |
...
على سبيل المثال، لدى مؤسستك موقع SharePoint مخصص لمشروع سري للغاية. يمكن أن يؤدي تسرب البيانات للمعلومات في هذا الموقع SharePoint إلى اختراق المشروع وسيكون له تأثير كبير على نجاحه. من خلال تحديد أولويات موقع SharePoint هذا في نهج تسرب البيانات، يتم زيادة درجات المخاطر للأنشطة المؤهلة تلقائيا. يزيد ترتيب الأولويات هذا من احتمال أن تنشئ هذه الأنشطة تنبيه مخاطر من الداخل وترفع مستوى الخطورة للتنبيه.

عند إنشاء نهج إدارة المخاطر الداخلية في معالج النهج، يمكنك الاختيار من بين الأولويات التالية:

- **مواقع SharePoint**: يتم تعيين درجة مخاطر أعلى لأي نشاط مقترن بكافة أنواع الملفات في مواقع SharePoint المحددة. يمكن للمستخدمين الذين يقومون بتكوين النهج وتحديد مواقع Share Point ذات الأولوية تحديد SharePoint المواقع التي لديهم الإذن للوصول إليها. إذا لم تكن مواقع SharePoint متوفرة للتحديد في النهج من قبل المستخدم الحالي، يمكن لمستخدم آخر له الأذونات المطلوبة تحديد مواقع النهج لاحقا أو يجب منح المستخدم الحالي حق الوصول إلى المواقع المطلوبة.
...
- التوصيات: هناك بعض المشكلات في النهج التي قد تمنع النهج من العمل كما هو متوقع.
...
|لم يتم إلحاق أي أجهزة|- سرقة البيانات من قبل المستخدمين المغادرين <br> - تسرب بيانات عام <br> - تسرب البيانات من قبل المستخدمين الساخطين <br> - تسرب البيانات من قبل المستخدمين ذو الأولوية|يتم تحديد مؤشرات الجهاز ولكن لا توجد أي أجهزة تم إلحاقها Microsoft 365 <br><br> تحقق مما إذا كانت الأجهزة ملحقة وتفي بالمتطلبات.|
...
|لا تتم مشاركة التنبيهات Microsoft Defender لنقطة النهاية مع مركز التوافق|- انتهاكات نهج الأمان العامة <br> - انتهاكات نهج الأمان من قبل المستخدمين المغادرين <br> - انتهاكات نهج الأمان من قبل المستخدمين الساخطين <br> - انتهاكات نهج الأمان من قبل المستخدمين ذات الأولوية|لا تتم مشاركة التنبيهات Microsoft Defender لنقطة النهاية مع مركز الامتثال. <br><br> تكوين مشاركة تنبيهات Microsoft Defender لنقطة النهاية.|
...
تستخدم قوالب نهج إدارة المخاطر الداخلية حدودا لإدارة حجم ومعدل المعالجة لأنشطة مخاطر المستخدم داخل النطاق وكيفية دمج هذه العملية مع دعم خدمات Microsoft 365. يحتوي كل قالب نهج على الحد الأقصى لعدد المستخدمين الذين يمكن تعيين درجات المخاطر بهمة للنهج الذي يمكنه دعمه ومعالجة أنشطة المخاطر والإبلاغ عنها بفعالية. المستخدمون داخل النطاق هم المستخدمون الذين لديهم أحداث مشغلة للنهج.
...
11. إذا حددت **أريد تحديد مواقع SharePoint وتسميات الحساسية وأنواع المعلومات الحساسة و/أو ملحقات الملفات كمحتوى ذي أولوية** في الخطوة السابقة، فسترى صفحات التفاصيل لمواقع *SharePoint* *وأنواع المعلومات الحساسة* *وتسميات الحساسية* *وملحقات الملفات*. استخدم صفحات التفاصيل هذه لتحديد SharePoint وأنواع المعلومات الحساسة وتسميات الحساسية لتحديد أولويات النهج.
