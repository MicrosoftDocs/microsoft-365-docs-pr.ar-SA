...
| **انتهاكات نهج الأمان العامة** | تم الكشف عن التهرب الدفاعي من عناصر التحكم الأمنية أو البرامج غير المرغوب فيها بواسطة Microsoft Defender لنقطة النهاية | اشتراك Microsoft Defender لنقطة النهاية النشط <br><br> Microsoft Defender لنقطة النهاية التكامل مع مدخل توافق Microsoft Purview الذي تم تكوينه |
...
| **انتهاكات نهج الأمان من قبل المستخدمين المغادرين** | مؤشرات تاريخ الإنهاء أو الإنهاء من موصل الموارد البشرية أو حذف حساب Azure Active Directory | (اختياري) Microsoft 365 موصل الموارد البشرية الذي تم تكوينه لمؤشرات الإنهاء وتاريخ الإنهاء <br><br> اشتراك Microsoft Defender لنقطة النهاية النشط <br><br> Microsoft Defender لنقطة النهاية التكامل مع مدخل توافق Microsoft Purview الذي تم تكوينه |
| **انتهاكات نهج الأمان من قبل المستخدمين ذات الأولوية** | تم الكشف عن التهرب الدفاعي من عناصر التحكم الأمنية أو البرامج غير المرغوب فيها بواسطة Microsoft Defender لنقطة النهاية | اشتراك Microsoft Defender لنقطة النهاية النشط <br><br> Microsoft Defender لنقطة النهاية التكامل مع مدخل توافق Microsoft Purview الذي تم تكوينه <br><br> مجموعات المستخدمين ذات الأولوية التي تم تكوينها في إعدادات المخاطر الداخلية |
| **انتهاكات نهج الأمان من قبل المستخدم الساخط** | مؤشرات تحسين الأداء أو الأداء الضعيف أو تغيير مستوى الوظيفة من موصل الموارد البشرية | Microsoft 365 موصل الموارد البشرية الذي تم تكوينه لمؤشرات عدم الإسهاب <br><br> اشتراك Microsoft Defender لنقطة النهاية النشط <br><br> Microsoft Defender لنقطة النهاية التكامل مع مدخل توافق Microsoft Purview الذي تم تكوينه |
