...
في الحالات الأكثر خطورة، قد تحتاج إلى مشاركة معلومات حالة إدارة المخاطر الداخلية مع المراجعين أو الخدمات الأخرى في مؤسستك. يتم دمج إدارة المخاطر الداخلية بإحكام مع حلول Microsoft Purview الأخرى لمساعدتك في حل المخاطر من البداية إلى النهاية.

- **eDiscovery (Premium)**: تصعيد حالة التحقيق يسمح لك بنقل بيانات وإدارة الحالة إلى Microsoft Purview eDiscovery (Premium). يوفر eDiscovery (Premium) سير عمل من طرف إلى طرف للاحتفاظ بالمحتوى الذي يستجيب للتحقيقات الداخلية والخارجية لمؤسستك وجمعه ومراجعته وتحليله وتصديره. يسمح للفرق القانونية بإدارة سير عمل إعلام الاحتجاز القانوني بأكمله. لمعرفة المزيد حول حالات eDiscovery (Premium)، راجع [نظرة عامة على Microsoft Purview eDiscovery (Premium)](overview-ediscovery-20.md).
