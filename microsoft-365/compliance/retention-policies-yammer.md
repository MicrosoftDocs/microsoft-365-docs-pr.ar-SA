...
عند انتهاء فترة الاستبقاء ونقل رسالة إلى مجلد SubstrateHolds، يتم توصيل عملية حذف إلى خدمة Yammer، ثم تقوم بترحيل نفس العملية إلى تطبيق العميل Yammer. يمكن أن يفسر التأخير في هذا الاتصال أو التخزين المؤقت سبب استمرار المستخدمين في رؤية هذه الرسائل في تطبيق Yammer لفترة زمنية قصيرة.
