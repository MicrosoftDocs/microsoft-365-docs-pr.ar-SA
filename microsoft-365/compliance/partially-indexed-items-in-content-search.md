...
description: تعرف على العناصر غير المفهرسة في Exchange وSharePoint التي يمكنك تضمينها في بحث eDiscovery الذي تقوم بتشغيله في مدخل التوافق في Microsoft Purview.
ms.openlocfilehash: e4bca9995dd173ef972522f273765db03dff3524
ms.sourcegitcommit: c29fc9d7477c3985d02d7a956a9f4b311c4d9c76
ms.translationtype: MT
ms.contentlocale: ar-SA
ms.lasthandoff: 07/06/2022
ms.locfileid: "66622470"
---
# <a name="partially-indexed-items-in-ediscovery"></a>العناصر المفهرسة جزئيا في eDiscovery

يتضمن البحث Microsoft Purview eDiscovery الذي تقوم بتشغيله من مدخل التوافق في Microsoft Purview العناصر المفهرسة جزئيا تلقائيا في نتائج البحث المقدرة عند تشغيل عملية بحث. العناصر المفهرسة جزئيا هي عناصر علبة بريد Exchange والمستندات الموجودة على SharePoint ومواقع OneDrive for Business التي لم تتم فهرستها بشكل كامل للبحث لسبب ما. في Exchange، يحتوي العنصر المفهرس جزئيا عادة على ملف (من نوع ملف لا يمكن فهرسته) مرفق برسالة بريد إلكتروني. فيما يلي بعض الأسباب الأخرى التي تجعل العناصر لا يمكن فهرستها للبحث ويتم إرجاعها كعناصر مفهرسة جزئيا عند تشغيل بحث eDiscovery:
...
- عند تشغيل بحث eDiscovery، يتم عرض العدد الإجمالي وحجم عناصر Exchange المفهرسة جزئيا (التي يتم إرجاعها بواسطة استعلام البحث) في إحصائيات البحث في صفحة القائمة المنبثقة، ويتم تسميتها **كعناصر غير مفهرسة**. لا تتضمن الإحصائيات حول العناصر المفهرسة جزئيا المعروضة في صفحة القائمة المنبثقة عناصر مفهرسة جزئيا في مواقع SharePoint أو حسابات OneDrive.
...
- لا تتوفر العناصر المفهرسة جزئيا لمعاينتها. يجب تصدير نتائج البحث لعرض العناصر المفهرسة جزئيا التي تم إرجاعها بواسطة البحث.
   ...
   بالإضافة إلى ذلك، عندما تقوم بتصدير نتائج البحث وتضمين عناصر مفهرسة جزئيا في عملية التصدير، يتم تصدير العناصر المفهرسة جزئيا من عناصر SharePoint إلى مجلد يسمى **"غير قابل للفهرسة**". عند تصدير عناصر Exchange المفهرسة جزئيا، يتم تصديرها بشكل مختلف استنادا إلى ما إذا كانت العناصر المفهرسة جزئيا تطابق استعلام البحث وتكوين إعدادات التصدير أم لا. 
...
للحصول على قائمة بحدود الفهرسة لمستندات SharePoint، راجع [حدود البحث ل SharePoint Online](/sharepoint/search-limits).
...
|الحد الأقصى لحجم ملفات Excel  <br/> |4 ميغابايت  <br/> |الحد الأقصى لحجم ملف Excel الموجود على موقع أو المرفق برسالة بريد إلكتروني سيتم تحليلها للفهرسة. لن يتم تحليل أي ملف Excel أكبر من هذا الحد، وسيتم وضع علامة unindexed على الملف أو البريد الإلكتروني الذي يحتوي على مرفق الملف.  <br/> |
...
- على الرغم من أن نوع الملف معتمد للفهرسة ومفهرس، فقد تكون هناك أخطاء في الفهرسة أو البحث تؤدي إلى إرجاع ملف كعنصر مفهرس جزئيا. على سبيل المثال، قد يكون البحث في ملف Excel كبير ناجحا جزئيا (لأنه تم فهرسة أول 4 ميغابايت)، ولكن بعد ذلك يفشل بسبب تجاوز حد حجم الملف. في هذه الحالة، من الممكن إرجاع الملف نفسه مع نتائج البحث وكعنصر مفهرس جزئيا.

- يمكن معاينة الملفات المشفرة باستخدام [تقنيات تشفير Microsoft](encryption.md) والمرفقة برسالة بريد إلكتروني تتطابق مع معايير البحث وسيتم فك تشفيرها عند تصديرها. في هذا الوقت، تتم فهرسة الملفات المشفرة باستخدام تقنيات تشفير Microsoft (والمخزنة في SharePoint أو OneDrive for Business) بشكل جزئي. 
