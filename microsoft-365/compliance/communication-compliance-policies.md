---
title: إنشاء وإدارة سياسات الامتثال للاتصالات
description: تعرف على المزيد حول إنشاء نهج توافق الاتصالات وإدارتها.
...
ms.locfileid: "66686364"
---
# <a name="create-and-manage-communication-compliance-policies"></a>إنشاء وإدارة سياسات الامتثال للاتصالات
...
يوضح الجدول التالي وقت الكشف عن أنواع المحتويات المعتمدة:
...
لديك خيار تضمين أنواع المعلومات الحساسة كجزء من نهج التوافق مع الاتصالات. أنواع المعلومات الحساسة هي إما أنواع بيانات محددة مسبقا أو مخصصة يمكن أن تساعد في تحديد أرقام بطاقات الائتمان وأرقام الحسابات المصرفية وأرقام جواز السفر والمزيد غير ذلك وحمايتها. كجزء من [التعرف على تفادي فقدان البيانات في Microsoft Purview](/microsoft-365/compliance/dlp-learn-about-dlp)، يمكن لتكوين المعلومات الحساسة استخدام الأنماط وتقارب الأحرف ومستويات الثقة وحتى أنواع البيانات المخصصة للمساعدة في تحديد المحتوى الذي قد يكون حساسا ووضع علامة عليه. أنواع المعلومات الحساسة الافتراضية هي:
...
> [!IMPORTANT]
> لدى SITs طريقتان مختلفتان لتحديد معلمات الحد الأقصى لعدد المثيلات الفريدة. لمعرفة المزيد، راجع [قيم عدد المثيلات المعتمدة ل SIT](/microsoft-365/compliance/create-a-custom-sensitive-information-type#instance-count-supported-values-for-sit).

لمعرفة المزيد حول تفاصيل المعلومات الحساسة والأنماط المضمنة في الأنواع الافتراضية، راجع [تعريفات كيان نوع المعلومات الحساسة](/microsoft-365/compliance/sensitive-information-type-entity-definitions).

### <a name="custom-keyword-dictionaries"></a>قواميس الكلمات الأساسية المخصصة

قم بتكوين قواميس كلمات أساسية مخصصة (أو معجمات) لتوفير إدارة بسيطة للكلمات الأساسية الخاصة بمؤسستك أو مجالك. تدعم قواميس الكلمات الأساسية ما يصل إلى 100 كيلوبايت من المصطلحات (ما بعد الضغط) في القاموس وتدعم أي لغة. حد المستأجر هو أيضا 100 كيلوبايت بعد الضغط. إذا لزم الأمر، يمكنك تطبيق قواميس كلمات أساسية مخصصة متعددة على نهج واحد أو الحصول على قاموس كلمة أساسية واحد لكل نهج. يتم تعيين هذه القواميس في نهج توافق الاتصالات ويمكن الحصول عليها من ملف (مثل .csv أو قائمة .txt)، أو من قائمة يمكنك [استيرادها في مدخل التوافق](/microsoft-365/compliance/create-a-keyword-dictionary). استخدم القواميس المخصصة عندما تحتاج إلى دعم المصطلحات أو اللغات الخاصة بمؤسستك وسياساتك.
