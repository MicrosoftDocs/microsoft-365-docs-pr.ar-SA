...
description: تعرف على كيفية تصفية البيانات باستخدام ميزة الاستيراد الذكية في خدمة استيراد Microsoft 365 عند استيراد ملفات PST إلى Microsoft 365.
ms.openlocfilehash: 1a9483d77ff575b643d4ab9717d286b608bea35d
ms.sourcegitcommit: c29fc9d7477c3985d02d7a956a9f4b311c4d9c76
ms.translationtype: MT
ms.contentlocale: ar-SA
ms.lasthandoff: 07/06/2022
ms.locfileid: "66640061"
---
# <a name="filter-data-when-importing-pst-files"></a>تصفية البيانات عند استيراد ملفات PST

استخدم ميزة الاستيراد الذكي الجديدة في خدمة استيراد Microsoft 365 لتصفية العناصر الموجودة في ملفات PST التي يتم استيرادها فعليا إلى علب البريد الهدف. إليك كيفية عملها:
  
- بعد إنشاء مهمة استيراد PST وإرسالها، يتم تحميل ملفات PST إلى منطقة تخزين Azure في سحابة Microsoft.
  
- يحلل Microsoft 365 البيانات في ملفات PST، بطريقة آمنة وآمنة، من خلال تحديد عمر عناصر علبة البريد وأنواع الرسائل المختلفة المضمنة في ملفات PST.
...
- بعد تكوين إعدادات عامل التصفية، يقوم Microsoft 365 باستيراد البيانات التي تفي بمعايير التصفية فقط إلى علب البريد الهدف المحددة في مهمة الاستيراد.
...
1. انتقل إلى <a href="https://go.microsoft.com/fwlink/p/?linkid=2077149" target="_blank">مدخل التوافق في Microsoft Purview</a> وسجل الدخول باستخدام بيانات الاعتماد لحساب مسؤول في مؤسستك.
...
2. في الجزء الأيمن من مدخل التوافق، انقر فوق **استيراد** إدارة \> **دورة حياة البيانات**.
    ...
    ![تشير حالة اكتمال التحليل إلى أن Microsoft 365 قام بتحليل البيانات في ملفات PST.](../media/de5294f4-f0ba-4b92-a48a-a4b32b6da490.png)
...
5. استنادا إلى ما إذا كنت تريد اقتطاع البيانات التي تم استيرادها إلى Microsoft 365 أم لا، ضمن **هل تريد تصفية بياناتك؟**، قم بأحد الإجراءات التالية:
    ...
    يتم عرض صفحة **"استيراد البيانات إلى Office 365**" مع رؤى بيانات مفصلة من التحليل الذي أجرته Microsoft 365. 
  
    ![يعرض Microsoft 365 رؤى بيانات مفصلة من تحليل ملفات PST.](../media/4881205f-0288-4c32-a440-37e2160295f2.png)
    ...
    يمكنك تكوين عوامل التصفية هذه:
      ...
      - **العمر** - حدد عمرا بحيث يتم استيراد العناصر الأحدث من العمر المحدد فقط. راجع المقطع ["مزيد من المعلومات](#more-information) " للحصول على وصف حول كيفية تحديد Microsoft 365 لالمستودعات العمرية لعامل تصفية **العمر** . 
    ...
    ج. انقر فوق **"تطبيق** " في الصفحة **المنبثقة "خيارات تصفية إضافية** " لحفظ إعدادات عامل التصفية. 
...
- كيف يحدد Microsoft 365 الزيادات لعامل تصفية العمر؟ عندما يحلل Microsoft 365 ملف PST، فإنه ينظر إلى الطابع الزمني المرسل أو المستلم لكل عنصر (إذا كان العنصر يحتوي على طابع زمني مرسل ومتلق، يتم تحديد التاريخ الأقدم). ثم يبحث Microsoft 365 في قيمة السنة لهذا الطابع الزمني ويقارنها بالتاريخ الحالي لتحديد عمر العنصر. ثم يتم استخدام هذه الفئات العمرية كقيم في القائمة المنسدلة لعامل تصفية **العمر** . على سبيل المثال، إذا كان ملف PST يحتوي على رسائل من 2016 و2015 و2014، فستكون القيم في عامل تصفية **العمر** **سنة واحدة** **وسنة وسنة** **و3 سنوات**.
...
- يسرد الجدول التالي أنواع الرسائل المضمنة في الفئة **"أخرى** " في عامل تصفية **"النوع** " في الصفحة " **خيارات إضافية** " المنبثقة (راجع الخطوة 5 ب في الإجراء السابق). حاليا، لا يمكنك استبعاد العناصر في الفئة "أخرى" عند استيراد PSTs إلى Office 365. 
    ...
    |IPM. Note.IMC.Notification  <br/> |التقارير المرسلة بواسطة Internet Mail Connect، وهي البوابة Exchange Server إلى الإنترنت  <br/> |
