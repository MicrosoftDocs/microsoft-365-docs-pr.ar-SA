...
- **العناصر غير المفهرسة**. إذا تضمنت مجموعة المسودات البحث في كل علب بريد Exchange أو كافة مواقع SharePoint، فستتم إضافة العناصر غير المفهرسة فقط من مواقع المحتوى التي تحتوي على عناصر تطابق معايير المجموعة إلى مجموعة المراجعة. بمعنى آخر، إذا لم يتم العثور على أي نتائج في علبة بريد أو موقع، فلن تتم إضافة أي عناصر غير مفهرسة في علبة البريد أو الموقع إلى مجموعة المراجعة. ومع ذلك، سيتم تضمين العناصر غير المفهرسة من كافة مواقع المحتوى (حتى تلك التي لا تحتوي على عناصر تطابق استعلام المجموعة) في نتائج المجموعة المقدرة.
