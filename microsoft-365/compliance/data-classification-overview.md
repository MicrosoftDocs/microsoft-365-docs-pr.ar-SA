...
ms.locfileid: "66917574"
---
# <a name="learn-about-data-classification"></a>التعرّف على تصنيف البيانات

بصفتك مسؤول Microsoft 365 أو مسؤول التوافق، يمكنك تقييم المحتوى في مؤسستك ثم وضع علامة عليه للتحكم في مكان تواجده وحمايته بغض النظر عن مكان تواجده والتأكد من الاحتفاظ به وحذفه وفقا لاحتياجات مؤسستك. يمكنك القيام بذلك من خلال تطبيق [تسميات الحساسية وتسميات](sensitivity-labels.md) [الاستبقاء](retention.md#retention-labels) وتصنيف نوع المعلومات الحساسة. هناك طرق مختلفة للقيام بالاكتشاف والتقييم ووضع العلامات، ولكن النتيجة النهائية هي أنه قد يكون لديك أعداد كبيرة جدا من المستندات ورسائل البريد الإلكتروني التي تم وضع علامة عليها وتصنيفها باستخدام تسمية واحدة أو كليهما. بعد تطبيق تسميات الاستبقاء وأوصاف الحساسية الخاصة بك، ستحتاج إلى معرفة كيفية استخدام التسميات عبر المستأجر الخاص بك وما يتم القيام به مع هذه العناصر. توفر صفحة تصنيف البيانات رؤية في نص المحتوى هذا، على وجه التحديد:
