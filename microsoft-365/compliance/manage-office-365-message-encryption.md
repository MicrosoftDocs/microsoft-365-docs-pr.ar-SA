...
إذا لم يستخدم مستلم رسالة مشفرة بواسطة OME Outlook، بغض النظر عن الحساب المستخدم من قبل المستلم، فسيتلقى المستلم ارتباط عرض ويب محدود الوقت يسمح له بقراءة الرسالة. يتضمن هذا الارتباط رمز تمرير لمرة واحدة. بصفتك مسؤولا، يمكنك تحديد ما إذا كان يمكن للمستلمين استخدام رموز المرور لمرة واحدة لتسجيل الدخول إلى مدخل OME.
...
لمزيد من المعلومات، ولعرض تجربة العميل، راجع [عرض الرسائل المشفرة على جهاز iPhone أو iPad](https://support.microsoft.com/en-us/office/view-protected-messages-on-your-iphone-or-ipad-4d631321-0d26-4bcc-a483-d294dd0b1caf).
...
لمزيد من المعلومات حول كيفية تطبيق Microsoft 365 للتشفير لرسائل البريد الإلكتروني ومرفقات البريد الإلكتروني باستخدام خيار Encrypt-Only، راجع [خيار التشفير فقط لرسائل البريد الإلكتروني.](/azure/information-protection/deploy-use/configure-usage-rights#encrypt-only-option-for-emails)
...
للحصول على معلومات مفصلة حول كيفية تخصيص تشفير الرسائل في Microsoft Purview لمؤسستك، راجع [إضافة العلامة التجارية لمؤسستك إلى الرسائل المشفرة](add-your-organization-brand-to-encrypted-messages.md). لتمكين القدرة على تعقب الرسائل المشفرة وإبطالها، يجب إضافة العلامة التجارية المخصصة إلى مدخل OME.

## <a name="disable-microsoft-purview-message-encryption"></a>تعطيل تشفير الرسائل في Microsoft Purview

نأمل ألا تصل إلى ذلك، ولكن إذا كنت بحاجة إلى ذلك، فإن تعطيل تشفير الرسائل في Microsoft Purview أمر واضح جدا. أولا، ستحتاج إلى إزالة أي قواعد لتدفق البريد قمت بإنشائها تستخدم تشفير الرسائل في Microsoft Purview. للحصول على معلومات حول إزالة قواعد تدفق البريد، راجع [إدارة قواعد تدفق البريد](/exchange/security-and-compliance/mail-flow-rules/manage-mail-flow-rules). ثم أكمل هذه الخطوات في Exchange Online PowerShell.

### <a name="to-disable-microsoft-purview-message-encryption"></a>لتعطيل تشفير الرسائل في Microsoft Purview
...
3. قم بتعطيل تشفير الرسائل في Microsoft Purview عن طريق تشغيل cmdlet Set-IRMConfiguration مع تعيين المعلمة AzureRMSLicensingEnabled إلى false:
