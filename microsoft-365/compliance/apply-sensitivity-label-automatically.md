...
- **التسمية من جانب الخدمة عندما يكون المحتوى محفوظا بالفعل (في SharePoint أو OneDrive) أو يتم إرساله عبر البريد الإلكتروني (تتم معالجته بواسطة Exchange Online)**: استخدم نهج تسمية تلقائية.
    ...
    للحصول على إرشادات التكوين، راجع [كيفية تكوين نهج التسمية التلقائية SharePoint OneDrive Exchange](#how-to-configure-auto-labeling-policies-for-sharepoint-onedrive-and-exchange) على هذه الصفحة.
...
|:-----|:-----|:-----|
|مطبق يدويا، أي أولوية|Word، Excel، PowerPoint: لا <br /><br> Outlook: لا  |SharePoint OneDrive: لا <br /><br> Exchange: لا بشكل افتراضي، ولكن قابل للتكوين |
|تطبيق تلقائيا أو تسمية افتراضية من النهج، أولوية أقل |Word، Excel، PowerPoint: نعم <br /><br> Outlook: نعم | SharePoint OneDrive: نعم <br /><br> Exchange: نعم |
|تطبيق تلقائيا أو تسمية افتراضية من النهج، أولوية أعلى |Word، Excel، PowerPoint: لا <br /><br> Outlook: لا |SharePoint OneDrive: لا <br /><br> Exchange: لا بشكل افتراضي، ولكن قابل للتكوين |
...
تتوفر إعدادات الوصف التلقائي لتطبيقات Office عند [إنشاء وصف الحساسية أو تحريره](create-sensitivity-labels.md). تأكد من تحديد **"ملفات" & رسائل البريد الإلكتروني** لنطاق التسمية:
...
- لا تدعم جميع تطبيقات Office التسمية التلقائية (والموصى بها). لمزيد من المعلومات، راجع [دعم قدرات وصف الحساسية في التطبيقات](sensitivity-labels-office-apps.md#support-for-sensitivity-label-capabilities-in-apps).
...
- لكي تدعم Outlook التسميات الموصى بها، يجب أولا تكوين [إعداد نهج متقدم](/azure/information-protection/rms-client/clientv2-admin-guide-customizations#enable-recommended-classification-in-outlook).
...
بشكل افتراضي، يتم تضمين جميع مواقع SharePoint OneDrive Exchange في نهج التسمية التلقائية، وعند حفظ النهج، يتم تشغيله في [وضع المحاكاة](#learn-about-simulation-mode). لا يوجد أي تحقق من أنك قمت [بتمكين تسميات الحساسية لملفات Office في SharePoint OneDrive](sensitivity-labels-sharepoint-onedrive-files.md)، وهو أحد المتطلبات الأساسية لتطبيق التسمية التلقائية على المحتوى في SharePoint OneDrive.

## <a name="how-to-configure-auto-labeling-policies-for-sharepoint-onedrive-and-exchange"></a>كيفية تكوين نهج التسمية التلقائية SharePoint OneDrive Exchange
...
- وضع المحاكاة:
  - يجب تشغيل التدقيق Microsoft 365. إذا كنت بحاجة إلى تشغيل التدقيق أو إذا لم تكن متأكدا مما إذا كان التدقيق قيد التشغيل بالفعل، فراجع [تشغيل البحث في سجل التدقيق أو إيقاف تشغيله](turn-audit-log-search-on-or-off.md).
...
- للتسمية التلقائية للملفات في SharePoint OneDrive:
  - لقد [قمت بتمكين تسميات الحساسية لملفات Office في SharePoint OneDrive](sensitivity-labels-sharepoint-onedrive-files.md).
...
- تسمية حساسية واحدة أو أكثر [تم إنشاؤها ونشرها](create-sensitivity-labels.md) (لمستخدم واحد على الأقل) يمكنك تحديدها لنهج التسمية التلقائية. لهذه التسميات:
  ...
  - إذا كانت التسميات تطبق [التشفير](encryption-sensitivity-labels.md):
    - عندما يتضمن نهج التسمية التلقائية مواقع SharePoint أو OneDrive، يجب تكوين التسمية للإعداد **"تعيين الأذونات الآن**"، ويجب تعيين **وصول المستخدم إلى المحتوى إلى** "**أبدا**".
...
6. بالنسبة إلى الصفحة **، اختر المواقع التي تريد تطبيق التسمية فيها**: حدد مواقع Exchange SharePoint OneDrive وحددها. إذا كنت لا تريد الاحتفاظ بالملف الافتراضي **للكل** مضمن للمواقع التي اخترتها، فحدد الارتباط لاختيار مثيلات معينة لتضمينها، أو حدد الارتباط لاختيار مثيلات معينة لاستبعادها. ثم حدد **"التالي**".
    ...
    - للحصول على حسابات OneDrive، راجع [الحصول على قائمة بجميع عناوين URL OneDrive للمستخدمين في مؤسستك لمساعدتك على](/onedrive/list-onedrive-urls) تحديد حسابات OneDrive فردية لتضمينها أو استبعادها.

7. بالنسبة إلى صفحة **"إعداد القواعد الشائعة أو المتقدمة** ": احتفظ **بالقواعد** الشائعة الافتراضية لتعريف القواعد التي تحدد المحتوى المطلوب تسميته عبر جميع المواقع المحددة. إذا كنت بحاجة إلى قواعد مختلفة لكل موقع، بما في ذلك المزيد من الخيارات Exchange، فحدد **القواعد المتقدمة**. ثم حدد **"التالي**".
...
10. لتحديد **ما إذا كنت تريد اختبار النهج الآن أو صفحة لاحقة** : حدد **نهج التشغيل في وضع المحاكاة** إذا كنت جاهزا لتشغيل نهج التسمية التلقائية الآن، في وضع المحاكاة. وإلا، فحدد **"ترك النهج" متوقفا عن التشغيل**. حدد **"التالي"**:
...
## <a name="tips-to-increase-labeling-reach"></a>تلميحات لزيادة وصول التسمية
...
بالإضافة إلى ذلك، ضع [علامة على الملفات الجديدة كحساسة بشكل افتراضي](/sharepoint/sensitive-by-default) في SharePoint لمنع الضيوف من الوصول إلى الملفات المضافة حديثا حتى يقوم نهج DLP واحد على الأقل بمسح محتوى الملف.
