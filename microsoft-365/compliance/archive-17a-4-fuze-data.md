---
title: إعداد موصل أرشفة بيانات "تعليق" في Microsoft 365
f1.keywords:
- NOCSH
...
بعد تخزين البيانات المشوشة في علب بريد المستخدمين، يمكنك تطبيق ميزات Microsoft Purview مثل احتجاز التقاضي وeDiscovery ونهج الاستبقاء وتسميات الاستبقاء وتوافق الاتصالات. يمكن أن يساعد استخدام موصل Fuze لاستيراد البيانات وأرشفتها في Microsoft 365 مؤسستك على البقاء متوافقة مع السياسات الحكومية والتنظيمية.

## <a name="overview-of-archiving-fuze-data"></a>نظرة عامة على أرشفة بيانات الفرز

تشرح النظرة العامة التالية عملية استخدام موصل بيانات أرشفة البيانات في Microsoft 365.
...
1. انتقل إلى <https://compliance.microsoft.com> **Data connectorsFuze** >  **DataParser ثم انقر فوقها**.
...
سيقوم موصل Fuze DataParser تلقائيا بتعيين المستخدمين إلى عناوين بريدهم الإلكتروني Microsoft 365 قبل استيراد البيانات إلى Microsoft 365.
