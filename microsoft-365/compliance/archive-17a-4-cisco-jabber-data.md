---
title: إعداد موصل لأرشفة بيانات Cisco Jabber في Microsoft 365
f1.keywords:
- NOCSH
ms.author: markjjo
author: markjjo
...
ms.locfileid: "63578277"
---
# <a name="set-up-a-connector-to-archive-cisco-jabber-data"></a>إعداد موصل لأرشفة بيانات Cisco Jabber

استخدم [Cisco Jabber DataParser](https://www.17a-4.com/jabber-dataparser/) من 17a-4 LLC لاستيراد البيانات وأرشفتها من Cisco Jabber إلى علب بريد المستخدمين في Microsoft 365 الخاصة بك. يتضمن DataParser موصل Cisco Jabber تم تكوينه لالتقاط العناصر من مصدر بيانات جهة خارجية واستيراد هذه العناصر Microsoft 365. يحول موصل Cisco Jabber DataParser بيانات Cisco Jabber إلى تنسيق رسالة بريد إلكتروني ثم يستورد هذه العناصر إلى علب بريد المستخدمين في Microsoft 365.
...
تشرح النظرة العامة التالية عملية استخدام موصل بيانات لأرشفة بيانات Cisco Jabber في Microsoft 365.

![أرشفة سير العمل لبيانات Cisco Jabber من 17a-4.](../media/CiscoJabberDataParserConnectorWorkflow.png)

1. تعمل مؤسستك مع 17a-4 لإعداد Cisco Jabber DataParser وتكوينه.

2. بشكل منتظم، يتم تجميع عناصر Cisco Jabber بواسطة DataParser. يحول DataParser أيضا محتوى الرسالة إلى تنسيق رسالة بريد إلكتروني.

3. يتصل موصل Cisco Jabber DataParser الذي تقوم بإنشاءه في مركز التوافق في Microsoft 365 ب DataParser وينقل الرسائل إلى موقع تخزين Azure آمن في سحابة Microsoft.

4. يتم إنشاء مجلد فرعي في مجلد علبة الوارد يسمى **Cisco Jabber DataParser** في علب بريد المستخدمين، كما يتم استيراد عناصر Cisco Jabber إلى ذلك المجلد. يحدد الموصل علبة البريد التي تريد استيراد العناصر لها باستخدام قيمة خاصية *البريد* الإلكتروني. يحتوي كل عنصر Cisco Jabber على هذه الخاصية، التي يتم ملؤها عنوان البريد الإلكتروني لكل مشارك.
...
الخطوة الأولى هي الوصول إلى صفحة موصلات البيانات في مركز التوافق في Microsoft 365 وإنشاء موصل 17a-4 لبيانات Cisco Jabber.

1. انتقل إلى <https://compliance.microsoft.com> موصلات **البيانات** >  ثم انقر **فوقهاCisco Jabber DataParser**.
...
5. سجل الدخول إلى حسابك في 17a-4 وأكمل الخطوات في معالج اتصال Cisco Jabber DataParser.

## <a name="step-2-configure-the-cisco-jabber-dataparser-connector"></a>الخطوة 2: تكوين موصل Cisco Jabber DataParser

استخدام دعم 17a-4 لتكوين موصل Cisco Jabber DataParser.

## <a name="step-3-map-users"></a>الخطوة 3: تعيين المستخدمين

سيرسم موصل Cisco Jabber DataParser تلقائيا على المستخدمين Microsoft 365 بريدهم الإلكتروني قبل استيراد البيانات Microsoft 365.

## <a name="step-4-monitor-the-cisco-jabber-dataparser-connector"></a>الخطوة 4: مراقبة موصل Cisco Jabber DataParser

بعد إنشاء موصل Cisco Jabber DataParser، يمكنك عرض حالة الموصل في مركز التوافق في Microsoft 365.

1. انتقل إلى <https://compliance.microsoft.com> **موصلات البيانات وانقر** فوقها في التنقل الأيسر.

2. انقر فوق **علامة** التبويب موصلات، ثم حدد موصل Cisco Jabber DataParser الذي أنشأته لعرض صفحة القائمة الإعلانية، التي تحتوي على الخصائص والمعلومات حول الموصل.
