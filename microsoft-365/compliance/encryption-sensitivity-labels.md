...
- تكوين Exchange ل Azure حماية البيانات
    ...
    لا يجب تكوين Exchange ل Azure حماية البيانات قبل أن يتمكن المستخدمون من تطبيق التسميات في Outlook لتشفير رسائل البريد الإلكتروني الخاصة بهم. ومع ذلك، حتى يتم تكوين Exchange ل Azure حماية البيانات، لا تحصل على الوظائف الكاملة لاستخدام حماية Rights Management Azure مع Exchange.
    
    على سبيل المثال، لا يمكن للمستخدمين عرض رسائل البريد الإلكتروني المشفرة على الهواتف الجوالة أو مع Outlook على ويب، ولا يمكن فهرسة رسائل البريد الإلكتروني المشفرة للبحث، ولا يمكنك تكوين Exchange Online DLP لحماية Rights Management. 
...
- **السماح بالوصول دون اتصال** مطلقا أو دائما أو لعدد معين من الأيام بعد تطبيق التسمية. إذا قمت بتقييد الوصول دون اتصال إلى أي وقت أو عدد من الأيام، عند الوصول إلى هذا الحد، يجب إعادة المصادقة على المستخدمين وتسجيل وصولهم. لمزيد من المعلومات، راجع القسم التالي في Rights Management استخدام الترخيص.
