---
title: سير عمل Teams في Advanced eDiscovery
f1.keywords:
- NOCSH
ms.author: markjjo
author: markjjo
...
توفر هذه المقالة مجموعة شاملة من الإجراءات والإرشادات وأفضل الممارسات لاستخدام Advanced eDiscovery للاحتفاظ بالمحتوى وجمعه ومراجعته وتصديره من Microsoft Teams. الهدف من هذه المقالة هو مساعدتك على تحسين سير عمل eDiscovery لمحتوى Teams.

هناك خمس فئات من محتوى Teams يمكنك تجميعه ومعالجتها باستخدام Advanced eDiscovery:
...
أحد المتطلبات الأساسية لإدارة محتوى Teams في Advanced eDiscovery هو فهم نوع المحتوى Teams الذي يمكنك تجميعه ومعالجتها ومراجعته في Advanced eDiscovery ومكان تخزين هذا المحتوى في Microsoft 365. يسرد الجدول التالي نوع محتوى Teams ومكان تخزين كل منهما.
...
الخطوة الأولى لإدارة محتوى Teams في Advanced eDiscovery هي إنشاء حالة باستخدام تنسيق الحالة الجديد المحسن لإدارة محتوى Teams. فيما يلي فوائد استخدام تنسيق الحالة الجديد لمحتوى Teams:
...
لمزيد من المعلومات حول حدود حالة الأحرف المتزايدة، راجع [استخدام تنسيق الحالة الجديد في Advanced eDiscovery](advanced-ediscovery-new-case-format.md).

لإنشاء حالة:

1. انتقل إلى <https://compliance.microsoft.com> وسجل الدخول.

2. في جزء التنقل الأيمن من مركز التوافق في Microsoft 365، انقر فوق **eDiscovery > خيارات متقدمة**.

3. في صفحة **Advanced eDiscovery**، انقر فوق علامة التبويب **"حالات**"، ثم انقر فوق **"إنشاء حالة**".
...
1. انتقل إلى حالة Advanced eDiscovery التي قمت بإنشائها في المقطع السابق، ثم انقر فوق **مصادر البيانات**.
...
لمزيد من المعلومات حول إضافة مصادر البيانات والحفاظ عليها في حالة Advanced eDiscovery، راجع:

- [إضافة أمناء حفظ إلى حالة Advanced eDiscovery](add-custodians-to-case.md)

- [إضافة مصادر بيانات غير احتجازية إلى حالة Advanced eDiscovery](non-custodial-data-sources.md)
...
1. انتقل إلى حالة Advanced eDiscovery التي أضفت أمناء الحفظ إليها في القسم السابق، ثم انقر فوق **المجموعات**.
...
بعد إضافة مجموعات من محتوى Teams إلى مجموعة مراجعة، فإن الخطوة التالية هي مراجعة المحتوى لصلته بالتحقيق الخاص بك وإحصائه إذا لزم الأمر. أحد المتطلبات الأساسية الهامة لمراجعة محتوى Teams هو فهم كيفية معالجة Advanced eDiscovery Teams محادثات الدردشة والمرفقات عند إضافتها إلى مجموعة مراجعة. تؤدي معالجة محتوى Teams هذه إلى العناصر الثلاثة التالية:
...
- **[نسخ المحادثة المترابطة](#transcript-conversation-threading)**. كيف تحدد Advanced eDiscovery المحتوى الإضافي من محادثة لتجميعه لتوفير سياق حول العناصر التي تطابق معايير المجموعة.

- **[إلغاء التكرار](#deduplication-of-teams-content)**. كيفية معالجة Advanced eDiscovery لمحتوى Teams المكرر.

- **[بيانات التعريف](#metadata-for-teams-content)**. خصائص بيانات التعريف التي Advanced eDiscovery إضافتها إلى المحتوى Teams بعد جمعه وإضافته إلى مجموعة مراجعة.
...
تساعدك وظيفة مؤشر ترابط المحادثة بتنسيق الحالة الجديدة في Advanced eDiscovery على تحديد المحتوى السياقي المرتبط بالعناصر التي قد تكون ذات صلة بالتحقيق. تنتج هذه الميزة طرق عرض محادثة مميزة تتضمن رسائل دردشة تسبق العناصر وتتابعها تتطابق مع استعلام البحث أثناء المجموعة. تسمح لك هذه الإمكانية بمراجعة محادثات الدردشة الكاملة (تسمى *المحادثات المترابطة*) بكفاءة وسريعة في Microsoft Teams. كما هو موضح سابقا، تتم إعادة بناء محادثات الدردشة في ملفات نسخة HTML عندما يضيف Advanced eDiscovery محتوى Teams إلى مجموعة مراجعة.

إليك المنطق المستخدم من قبل Advanced eDiscovery لتضمين رسائل إضافية وملفات نسخ الردود التي توفر سياقا حول العناصر تتطابق مع استعلام المجموعة (يسمى *العناصر المستجيبة*) الذي استخدمته عند تجميع محتوى Teams. تستند سلوكيات الترابط المختلفة إلى أنواع الدردشات واستعلام البحث المستخدم لجمع العناصر المستجيبة. هناك سيناريو تجميع شائعان:
...
- يجب أن يكون كل ملف نسخة تمت إضافته إلى مجموعة مراجعة تعيينا واحدا إلى واحد للمحتوى المخزن في مواقع البيانات. وهذا يعني أن Advanced eDiscovery لا يجمع أي محتوى Teams تمت إضافته بالفعل إلى مجموعة المراجعة. إذا تم تجميع رسالة دردشة بالفعل في مجموعة مراجعة، Advanced eDiscovery لا يضيف الرسالة نفسها من موقع البيانات نفسه إلى مجموعة المراجعة في المجموعات اللاحقة.
...
للحصول على أوصاف لخصائص بيانات تعريف Advanced eDiscovery الأخرى، راجع [حقول بيانات تعريف المستند في Advanced eDiscovery](document-metadata-fields-in-Advanced-eDiscovery.md).
...
فيما يلي دليل مرجعي سريع لاستخدام Advanced eDiscovery Microsoft Teams. يلخص هذا الدليل نقاط المفاتيح لاستخدام Advanced eDiscovery للاحتفاظ بالمحتوى وتجميعه ومراجعته وتصديره من Microsoft Teams.
