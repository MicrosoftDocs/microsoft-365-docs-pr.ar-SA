...
نوصي باستخدام استبقاء Microsoft 365 لتطبيق الاحتجاز على علبة البريد. تتم تغطية أساليب أخرى في [Learn حول علب البريد غير النشطة](inactive-mailboxes-in-office-365.md).
...
|ل...|قم بذلك...|نتيجه|
|---|---|---|
|الاحتفاظ بمحتوى علبة البريد إلى أجل غير مسمى بعد مغادرة موظف للمؤسسة|1. تطبيق إعدادات الاستبقاء Microsoft 365 مع إجراءات الاستبقاء لعل البريد (نهج استبقاء) أو عناصر بريد إلكتروني محددة (تسمية استبقاء واحدة أو أكثر). <br /><br> 2. انتظر حتى يتم تطبيق إعدادات الاستبقاء. <br /><br> 3. إزالة حساب Microsoft 365 الخاص بالمستخدم.|يتم الاحتفاظ بكافة المحتويات الموجودة في علبة البريد غير النشطة التي تم تطبيق إعدادات الاستبقاء عليها، بما في ذلك العناصر الموجودة في مجلد العناصر القابلة للاسترداد، إلى أجل غير مسمى.|
|الاحتفاظ بكافة محتويات علبة البريد لفترة معينة بعد مغادرة الموظف للمؤسسة ثم حذف علبة البريد|1. تطبيق نهج استبقاء Microsoft 365 على علبة البريد باستخدام إعدادات الاستبقاء التي تحتفظ بالعناصر ثم تحذفها عند انتهاء فترة الاستبقاء. <br /><br> 2. انتظر حتى يتم تطبيق إعدادات الاستبقاء. <br /><br> 3. إزالة حساب Microsoft 365 الخاص بالمستخدم.|عند انتهاء فترة الاستبقاء لعنصر علبة بريد، يتم نقل العنصر إلى مجلد "العناصر القابلة للاسترداد" ثم يتم حذفه نهائيا (تتم إزالته) من علبة البريد غير النشطة عند انتهاء فترة الاحتفاظ بالعنصر المحذوفة (لعلب بريد Exchange). تستند فترة الاستبقاء لنهج الاستبقاء Microsoft 365 دائما إلى التاريخ الأصلي لاستلام عنصر علبة بريد أو إنشائه.|


> [!NOTE]
> إذا تم تطبيق إعدادات الاستبقاء Microsoft 365 التي تم تكوينها للاحتفاظ بالمحتوى أو الاحتفاظ به ثم حذفه، على علبة البريد أو عناصر علبة البريد، أو تم وضع احتجاز التقاضي بالفعل على علبة بريد، أو إذا كان كل ما عليك فعله لإنشاء علبة بريد غير نشطة هو حذف حساب المستخدم المقابل.
...
2. في جزء التنقل الأيمن، حدد **"إظهار الكل**"، ثم حدد **نهج** **إدارة** >  دورة حياة البيانات.
...
4. تعرض صفحة **علب البريد غير النشطة** قائمة بعلب البريد غير النشطة. حدد واحدا للاطلاع على تفاصيل حول علبة البريد غير النشطة هذه. تتضمن التفاصيل معرف Exchange لعل البريد وما إذا كان قيد [الاحتجاز في التقاضي](create-a-litigation-hold.md).
    
    لن ترى أنواعا أخرى من قوائم الاحتجاز في جزء التفاصيل، على سبيل المثال نهج استبقاء Microsoft 365 أو احتجاز eDiscovery. للعثور على هذه المعلومات، راجع [كيفية تحديد نوع قائمة الاحتجاز الموضوعة على علبة بريد Exchange Online](identify-a-hold-on-an-exchange-online-mailbox.md).
