...
4. تعرض صفحة **علب البريد غير النشطة** قائمة بعلب البريد غير النشطة. حدد واحدا للاطلاع على تفاصيل حول علبة البريد غير النشطة هذه. تتضمن التفاصيل المدة التي تم فيها تعليقه، ومعرف Exchange، ووقت تعليقه.

في صفحة " **علب البريد غير النشطة** "، حدد ![أيقونة "تصدير نتائج البحث".](../media/47205c65-babd-4b3a-bd7b-98dfd92883ba.png) **تصدير** لعرض ملف CSV يحتوي على معلومات إضافية حول علب البريد غير النشطة في مؤسستك أو تنزيله.
