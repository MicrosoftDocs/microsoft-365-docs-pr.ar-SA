...
description: يمكن للمسؤولين إعداد موصل أصلي لاستيراد صفحات Facebook Business وأرشفتها إلى Microsoft 365. بعد استيراد هذه البيانات إلى Microsoft 365، يمكنك استخدام ميزات التوافق مثل الاحتجاز القانوني والبحث في المحتوى ونهج الاستبقاء لإدارة إدارة بيانات Facebook الخاصة بمؤسستك.
ms.openlocfilehash: 0b2d37859941cc0e1ae5c49fad6fd72312cc03cf
ms.sourcegitcommit: c29fc9d7477c3985d02d7a956a9f4b311c4d9c76
ms.translationtype: MT
ms.contentlocale: ar-SA
ms.lasthandoff: 07/06/2022
ms.locfileid: "66632542"
---
...
1. انتقل إلى <https://portal.azure.com> تسجيل الدخول باستخدام بيانات اعتماد حساب مسؤول عام.
    ...
    ![إنشاء تطبيق في AAD.](../media/FBCimage1.png)
...
9. انسخ قيمة السر واحفظه في ملف نصي أو موقع تخزين آخر. هذا هو سر تطبيق AAD الذي تستخدمه في خطوات لاحقة.
...
2. بعد النقر فوق **"Deploy to Azure"**، ستتم إعادة توجيهك إلى مدخل Azure مع صفحة قالب مخصصة. املأ تفاصيل **"الأساسيات** **والإعدادات** " ثم انقر فوق **"شراء**".
   ...
   - **معرف المستأجر:** معرف المستأجر لمؤسسة Microsoft 365 التي نسختها بعد إنشاء تطبيق موصل Facebook في Azure Active Directory في الخطوة 1.
...
7. في جزء التنقل الأيمن ضمن **"تسجيل الدخول إلى Facebook"**، انقر فوق **"إعدادات**"، وأضف URI لإعادة توجيه OAuth في المربع **"عناوين URL لإعادة توجيه OAuth الصالحة** ". استخدم التنسيق **\<connectorserviceuri>/Views/FacebookOAuth**، حيث تكون قيمة connectorserviceuri هي عنوان URL لخدمة تطبيق Azure لمؤسستك؛ على سبيل المثال، `https://fbconnector.azurewebsites.net`.
...
3. في مربع معرف المستأجر، اكتب معرف المستأجر أو الصقه (الذي حصلت عليه في الخطوة 2). في مربع كلمة المرور، اكتب APISecretKey (الذي حصلت عليه في الخطوة 2) أو الصقه، ثم انقر فوق **"تعيين إعدادات التكوين** " لعرض صفحة تفاصيل التكوين.
...
4. أدخل إعدادات التكوين التالية
   ...
   - **معرف تطبيق AAD:** معرف التطبيق لتطبيق Azure Active Directory الذي أنشأته في الخطوة 1.

   - **سر تطبيق AAD:** قيمة سر APISecretKey الذي أنشأته في الخطوة 1.
...
1. انتقل إلى مدخل التوافق في Microsoft Purview، ثم حدد <a href="https://go.microsoft.com/fwlink/p/?linkid=2173865" target="_blank">**موصلات البيانات**</a.
...
5. في صفحة **إضافة بيانات اعتماد لصفحة تطبيق الموصل** ، أدخل المعلومات التالية ثم انقر فوق **"التحقق من صحة الاتصال**".
   ...
   - في مربع **معرف تطبيق Azure** ، اكتب قيمة معرف التطبيق (العميل) أو الصقها أيضا باسم معرف تطبيق AAD الذي أنشأته في الخطوة 1.

6. بعد التحقق من صحة الاتصال بنجاح، انقر فوق **"التالي**".

7. في **تخويل Microsoft 365 لاستيراد صفحة البيانات** ، اكتب APISecretKey أو الصقه مرة أخرى، ثم انقر فوق **تسجيل الدخول إلى تطبيق الويب**.
...
12. في صفحة **اختيار موقع التخزين** ، اكتب عنوان البريد الإلكتروني لعل بريد Microsoft 365 الذي سيتم استيراد عناصر Facebook إليه، ثم انقر فوق **"التالي**".
