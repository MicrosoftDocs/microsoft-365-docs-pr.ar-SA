...
على الرغم من أنه يمكنك إنشاء تسميات الاستبقاء وإدارتها من **إدارة دورة حياة البيانات** في مدخل التوافق في Microsoft Purview، فإن خطة الملفات من **إدارة السجلات** لديها قدرات إدارة إضافية:
...
إذا قمت بالفعل بإنشاء تسميات استبقاء من **إدارة دورة حياة البيانات** في مدخل التوافق في Microsoft Purview، يتم عرض هذه التسميات تلقائيا في خطة الملفات. 
...
- **يحدد Relabel إلى** - يتم طرحه حاليا - ما إذا تم تكوين التسمية لتطبيق تسمية أخرى في نهاية فترة الاستبقاء. القيم الصحيحة:
...
|التعليق|سلسلة|لا|استخدم هذه الخاصية لإضافة وصف حول تسمية الاستبقاء للمسؤولين. يظهر هذا الوصف فقط للمسؤولين الذين يديرون تسمية الاستبقاء في مدخل التوافق في Microsoft Purview.|
...
- إلغاء تأمين هذا السجل بشكل افتراضي (يتم طرحه حاليا في المعاينة): لا يتوفر هذا الإعداد في القالب المطلوب استيراده، ولا يمكنك تحديد هذا الإعداد في مدخل التوافق بعد نجاح عملية الاستيراد.

- تسمية الاستبدال (يتم طرحها حاليا في المعاينة): لا يتوفر هذا الإعداد في القالب المطلوب استيراده، ولكن يمكنك تحديد هذا الإعداد في مدخل التوافق بعد نجاح عملية الاستيراد.
