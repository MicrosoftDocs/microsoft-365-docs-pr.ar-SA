...
في [مدخل التوافق في Microsoft Purview](https://compliance.microsoft.com/)، انتقل إلى **خطة ملف** **إدارة** >  سجلات **الحلول** > :
...
4. حدد **"تحميل ملف** " لتحميل القالب الذي تم تعبئته.
...
|ملاحظات|سلسلة|لا|استخدم هذه الخاصية لإضافة وصف حول تسمية الاستبقاء للمستخدمين. يظهر هذا الوصف عند مرور المستخدمين فوق التسمية في تطبيقات مثل Outlook وSharePoint وOneDrive. إذا تركت هذه الخاصية فارغة، فسيتم عرض وصف افتراضي يشرح إعدادات استبقاء التسمية. |
...
|RetentionDuration|سلسلة|لا، ما لم يتم تحديد **RetentionAction** أو **RetentionType**|تحدد هذه الخاصية عدد الأيام للاحتفاظ بالمحتوى. القيم الصحيحة هي: </br>**غير محدود**: سيتم الاحتفاظ بالعناصر إلى أجل غير مسمى. </br>**_n_*: عدد صحيح موجب بالأيام؛ على سبيل المثال، **365**. الحد الأقصى للعدد المعتمد هو 36525، وهو 100 سنة. إذا كنت بحاجة إلى أكثر من هذا الحد الأقصى، فاستخدم "غير محدود" بدلا من ذلك.</br> </br> تبعيات المجموعة: عند تحديد هذه الخاصية، يجب أيضا تحديد RetentionAction و RetentionType.
...
|CitationJurisdiction|سلسلة|لا|تحدد هذه الخاصية الولاية أو الوكالة المعروضة في واصف خطة ملف **التزويد/الاقتباس** . على سبيل المثال، "عمولة الأوراق المالية والبورصة الأمريكية (SEC)".|
