...
في مدخل توافق Microsoft Purview، انتقل إلى خطة **SolutionsRecords** >  **managementFile** > :
...
|التعليق|سلسلة|لا|استخدم هذه الخاصية لإضافة وصف حول تسمية الاستبقاء للمسؤولين. يظهر هذا الوصف فقط للمسؤولين الذين يديرون تسمية الاستبقاء في مدخل توافق Microsoft Purview.|
