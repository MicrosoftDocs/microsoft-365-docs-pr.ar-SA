---
title: سلاسل تشفير Microsoft 365 - DOD و GCC High
f1.keywords:
- NOCSH
ms.author: kvice
...
- Strat_O365_IP
description: عرض قائمة كاملة من شهادات DOD وS GCC High root وشهادات المراجع المصدقة (CAs) في Microsoft 365.
ms.openlocfilehash: 201bc3d7a952bc7906d7efe7ac7b856348cb88e4
ms.sourcegitcommit: c29fc9d7477c3985d02d7a956a9f4b311c4d9c76
ms.translationtype: MT
ms.contentlocale: ar-SA
ms.lasthandoff: 07/06/2022
ms.locfileid: "66627316"
---
# <a name="microsoft-365-encryption-chains---dod-and-gcc-high"></a>سلاسل تشفير Microsoft 365 - DOD و GCC High

يستفيد Microsoft 365 من عدد من موفري الشهادات المختلفين. يصف ما يلي القائمة الكاملة لشهادات جذر Microsoft 365 المعروفة التي قد يواجهها **عملاء DOD و GCC High** عند الوصول إلى Microsoft 365. للحصول على معلومات حول الشهادات التي قد تحتاج إلى تثبيتها في البنية الأساسية الخاصة بك، راجع [خطة شهادات SSL التابعة لجهة خارجية ل Microsoft 365](../enterprise/plan-for-third-party-ssl-certificates.md).

تنطبق معلومات الشهادة التالية على **جميع عملاء DOD و GCC High**.

تاريخ التحديث الأخير: **10/16/2020**

> [!NOTE]
> للحصول على معلومات الشهادة التي تنطبق على **العملاء في جميع أنحاء العالم**، راجع [سلاسل تشفير Microsoft 365](encryption-office-365-certificate-chains.md).

| **نوع الشهادة** | **تنزيل P7b** | **نقاط نهاية CRL** | **نقاط نهاية OCSP** |
| --- | --- | --- | --- | --- |
| شهادات الجذر والمتوسط الموثوق بها بشكل عام | [مجموعة شهادات Microsoft 365 ITAR (P7B)](https://download.microsoft.com/download/b/3/a/b3ae08a2-516c-46a9-8723-6256e4fd6383/m365_chain_certs_itar20201012.p7b) | crl.entrust.net<br>crl3.digicert.com<br>crl4.digicert.com | ocsp.digicert.com<br>ocsp.entrust.net |

قم بتوسيع المقطعين الجذر والمتوسط أدناه للاطلاع على تفاصيل إضافية حول موفري الشهادات.

## <a name="microsoft-365-certificate-details"></a>**تفاصيل شهادة Microsoft 365**
...
| **الصلاحية ليست قبل** | 04 أغسطس 12:00:00 2015 UTC |
| **الصلاحية ليست بعد** | 04 أغسطس 12:00:00 2030 UTC |
...
| **خوارزمية التوقيع** | sha256RSA |
| **الصلاحية ليست قبل** | الخميس 24 سبتمبر 2020 5:00 م |
| **الصلاحية ليست حتى** | الثلاثاء 24 سبتمبر 2030 4:59 م |
...
| **طول المفتاح العام** | RSA 2048 bits (e 65537) |
| **خوارزمية التوقيع** | sha256RSA |
| **الصلاحية ليست قبل** | 22 أكتوبر 00:00:00 2013 UTC |
| **الصلاحية ليست بعد** | 22 أكتوبر 00:00:00 2028 بالتوقيت العالمي المتفق عليه |
...
| **طول المفتاح العام** | RSA 2048 bits |
| **خوارزمية التوقيع** | sha256RSA |
| **الصلاحية ليست قبل** | الجمعة، 8 مارس 2013 4:00 ص |
| **الصلاحية ليست حتى** | الأربعاء، 8 مارس 2023 4:00 ص |
...
### <a name="entrust-root-certification-authority"></a>**تفويض المرجع الجذر**

| **الموضوع** | CN=مصادقة المرجع الجذر<br>OU="(c) 2006 Tahoma, Inc."<br>يتم تضمين OU=www.entrust.net/CPS حسب المرجع<br>الوحدة التنظيمية=راجع www.entrust.net/legal-terms<br>O=&quot;سند، Inc.&quot;<br>C=US |
| --- | --- |
| **الرقم التسلسلي** | 45:6B:50:54 |
| **طول المفتاح العام** | RSA 2048 bits (e 65537) |
| **خوارزمية التوقيع** | sha1RSA |
| **الصلاحية ليست قبل** | 27 نوفمبر 12:23:42 2006 UTC |
| **الصلاحية ليست بعد** | 27 نوفمبر 12:53:42 2026 UTC |
...
| **بصمة الإبهام (SHA-1)** | B31EB1B740E36C8402DADC37D44DF5D4674952F9 |
| **بصمة الإبهام (SHA-256)** | 73C176434F1BC6D5ADF45B0E76E727287C8DE57616C1E6E6141A2B2CBC7D8E4C |

### <a name="entrust-root-certification-authority---g2"></a>**تفويض المرجع الجذر - G2**

| **الموضوع** | CN=مصادقة المرجع الجذر - G2<br>OU=&quot;(c) 2009 Authoriz, Inc. - للاستخدام المصرح به فقط&quot;<br>الوحدة التنظيمية=راجع www.entrust.net/legal-terms<br>O=&quot;سند، Inc.&quot;<br>C=US |
| --- | --- |
...
### <a name="entrust-certification-authority---l1c"></a>**تفويض المرجع المصدق - L1C**
...
| **الصلاحية ليست بعد** | 11 نوفمبر 02:51:17 2021 UTC |
...
### <a name="entrust-certification-authority---l1e"></a>**تفويض المرجع المصدق - L1E**

| **الموضوع** | CN=إسناد المرجع المصدق - L1E<br>OU=&quot;(c) 2009 Tahoma, Inc.&quot;<br>يتم تضمين OU=www.au.net/rpa حسب المرجع<br>O=&quot;سند، Inc.&quot;<br>C=US |
| --- | --- |
| **المصدر** | CN=Authority.net Certification Authority (2048)<br>OU=(c) 1999 Entrust.net Limited<br>OU=www.entrust.net/CPS\_2048 incorp. حسب ref. (limits liab.)<br>O=Entrust.net |
...
| **معرف مفتاح المرجع** | keyid:68:90:e4:67:a4:a6:53:80:c7:86:66:a4:f1:f7:4b:43:fb:84:bd:6d |
| **بصمة الإبهام (SHA-1)** | 8A000CC056F7D17349F045BEB0319A3B91C9F979 |
| **بصمة الإبهام (SHA-256)** | 3C7A634E5778A0F731972B702DAE24B2CF2060219F607E69878B164C61A06C41 |
...
### <a name="entrust-certification-authority---l1m"></a>**تفويض المرجع المصدق - L1M**

| **الموضوع** | CN=Authoriz Certification Authority - L1M, OU=&quot;(c) 2014 Linux, Inc. - للاستخدام المصرح به فقط&quot;<br>الوحدة التنظيمية=راجع www.entrust.net/legal-terms<br>O=&quot;سند، Inc.&quot;<br>C=US |
| --- | --- |
| **المصدر** | CN=مصادقة المرجع الجذر - G2<br>OU=&quot;(c) 2009 Authoriz, Inc. - للاستخدام المصرح به فقط&quot;<br>الوحدة التنظيمية=راجع www.entrust.net/legal-terms<br>O=&quot;سند، Inc.&quot;<br>C=US |
| **الرقم التسلسلي** | 61:A1:E7:D2:00:00:00:00:51:D3:66:A6 |
| **طول المفتاح العام** | RSA 2048 bits (e 65537) |
| **خوارزمية التوقيع** | sha256RSA |
| **الصلاحية ليست قبل** | 15 ديسمبر 07:25:03 2014 UTC |
| **الصلاحية ليست بعد** | 15 أكتوبر 08:55:03 2030 UTC |
| **معرف مفتاح الموضوع** | C3:F7:D0:B5:2A:30:AD:AF:0D:91:21:70:39:54:DD:BC:89:70:C7:3A |
| **معرف مفتاح المرجع** | keyid:6a:72:26:7a:d0:1e:ef:7d:e7:3b:69:51:d4:6c:8d:9f:90:12:66:ab |
| **بصمة الإبهام (SHA-1)** | CC136695639065FAB47074D28C55314C66077E90 |
| **بصمة الإبهام (SHA-256)** | 75C5B3F01FD1F51A2C447AB7C785D72E69FA9C472C08571E7EADF3B8EABAE70C |
| **عناوين URL CRL** | http://crl.entrust.net/g2ca.crl |
| **عناوين URL ل OCSP** | http://ocsp.entrust.net |
...
### <a name="microsoft-azure-tls-issuing-ca-06"></a>**إصدار CA 06 من Microsoft Azure TLS**
