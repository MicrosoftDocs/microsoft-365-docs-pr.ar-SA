...
description: تعيين الأذونات المطلوبة لتنفيذ المهام ذات الصلة ب eDiscovery باستخدام مركز التوافق في Microsoft 365.
ms.custom:
- seo-marvel-apr2020
...
- **مسؤول eDiscovery** - مسؤول eDiscovery هو عضو في مجموعة أدوار eDiscovery Manager، ويمكنه تنفيذ نفس المهام المتعلقة بالبحث في المحتوى وإدارة الحالة التي يمكن أن يقوم بها مدير eDiscovery. بالإضافة إلى ذلك، يمكن لمسؤول eDiscovery:
  ...
  - الوصول إلى جميع الحالات المدرجة في صفحات **eDiscovery** الأساسية **Advanced eDiscovery** في مركز التوافق في Microsoft 365.

  - الوصول إلى بيانات حالة الأحرف في Advanced eDiscovery لأي حالة في المؤسسة.
...
> [!NOTE]
> لتحليل بيانات المستخدم باستخدام Advanced eDiscovery، يجب تعيين ترخيص Office 365 E5 أو ترخيص Microsoft 365 E5 للمستخدم (الوصي على البيانات). بدلا من ذلك، يمكن تعيين ترخيص Office 365 E1 التوافق في Microsoft 365 E5 أو Office 365 أو ترخيص Microsoft 365 E3 للمستخدمين الذين لديهم ترخيص التوافق في Microsoft 365 E5 أو Microsoft 365 eDiscovery ووظيفة التدقيق الإضافية. لا يحتاج المسؤولون أو مسؤولو الامتثال أو الموظفون القانونيون الذين تم تعيينهم إلى الحالات كأعضاء ويستخدمون Advanced eDiscovery لجمع البيانات وعرضها وتحليلها إلى ترخيص E5. لمزيد من المعلومات حول ترخيص Advanced eDiscovery، راجع [الاشتراكات والترخيص في Advanced eDiscovery](overview-ediscovery-20.md#subscriptions-and-licensing).
...
1. انتقل إلى <a href="https://go.microsoft.com/fwlink/p/?linkid=2077149" target="_blank">مركز التوافق في Microsoft 365</a> وسجل الدخول باستخدام حساب يمكنه تعيين الأذونات.
...
في صفحة **"الأذونات**" في مركز التوافق في Microsoft 365، يمكنك أيضا تعيين الأذونات المتعلقة ب eDiscovery للمستخدمين عن طريق إضافتها إلى مجموعات أدوار "مسؤول التوافق" و"إدارة المؤسسة" و"المراجع". للحصول على وصف لأدوار RBAC المتعلقة ب eDiscovery المعينة لكل مجموعة من مجموعات الأدوار هذه، راجع [أدوار RBAC المتعلقة ب eDiscovery](#rbac-roles-related-to-ediscovery).

## <a name="rbac-roles-related-to-ediscovery"></a>أدوار RBAC المتعلقة ب eDiscovery

يسرد الجدول التالي أدوار RBAC المتعلقة ب eDiscovery في مركز التوافق في Microsoft 365، ويشير إلى مجموعات الأدوار المضمنة التي يتم تعيين كل دور إليها بشكل افتراضي.
...
يتيح هذا الدور للمستخدمين إنشاء وتحرير وحذف والتحكم في الوصول إلى eDiscovery الأساسي وحالات Advanced eDiscovery في مركز التوافق في Microsoft 365. كما هو موضح سابقا، يجب تعيين دور إدارة الحالة للمستخدم قبل أن تتمكن من استخدام **Add-eDiscoveryCaseAdmin** cmdlet لجعله مسؤول eDiscovery.

لمزيد من المعلومات، اطلع على:

- [بدء استخدام eDiscovery الأساسي](get-started-core-ediscovery.md)

- [بدء استخدام Advanced eDiscovery](get-started-with-advanced-ediscovery.md)

### <a name="communication"></a>اتصال

يتيح هذا الدور للمستخدمين إدارة جميع الاتصالات مع أمناء الحفظ المحددين في حالة Advanced eDiscovery. يتضمن ذلك إنشاء إعلامات الاحتجاز، والاحتفاظ بالتذكيرات، والتصعيدات إلى الإدارة. يمكن للمستخدم أيضا تعقب إقرار الوصي بإشعارات الاحتجاز وإدارة الوصول إلى مدخل الوصي الذي يستخدمه كل أمين لتعقب الاتصالات للحالات التي تم تحديدها على أنها وصي.

لمزيد من المعلومات، راجع ["العمل باستخدام الاتصالات" في Advanced eDiscovery](managing-custodian-communications.md).

### <a name="compliance-search"></a>البحث عن التوافق

يتيح هذا الدور للمستخدمين تشغيل أداة البحث في المحتوى في مركز التوافق في Microsoft 365 للبحث في علب البريد والمجلدات العامة ومواقع SharePoint عبر الإنترنت ومواقع OneDrive for Business ومحادثات Skype for Business Microsoft 365  المجموعات والمجموعات Microsoft Teams والمجموعات Yammer. يسمح هذا الدور للمستخدم بالحصول على تقدير لنتائج البحث وإنشاء تقارير التصدير، ولكن هناك حاجة إلى أدوار أخرى لبدء إجراءات البحث في المحتوى مثل معاينة نتائج البحث أو تصديرها أو حذفها.

في البحث في المحتوى و Core eDiscovery، يمكن للمستخدمين الذين تم تعيين دور البحث التوافقي لهم ولكن ليس لديهم دور المعاينة معاينة نتائج البحث الذي تم فيه بدء إجراء المعاينة من قبل مستخدم تم تعيين دور المعاينة له. يمكن للمستخدم الذي ليس له دور المعاينة معاينة النتائج لمدة تصل إلى أسبوعين بعد إنشاء إجراء المعاينة الأولية.

وبالمثل، يمكن للمستخدمين في البحث في المحتوى و Core eDiscovery الذين تم تعيين دور "البحث في التوافق" ولكن ليس لديهم دور التصدير تنزيل نتائج البحث الذي بدأ فيه إجراء التصدير من قبل مستخدم تم تعيين دور التصدير له. يمكن للمستخدم الذي ليس له دور التصدير تنزيل نتائج البحث لمدة تصل إلى أسبوعين بعد إنشاء إجراء التصدير الأولي. بعد ذلك، لا يمكنهم تنزيل النتائج إلا إذا قام شخص ما بدور التصدير بإعادة تشغيل التصدير.
...
يتيح هذا الدور للمستخدمين تحديد أمناء الحفظ وإدارتها لحالات Advanced eDiscovery واستخدام المعلومات من Azure Active Directory ومصادر أخرى للعثور على مصادر البيانات المرتبطة بالأمناء. يمكن للمستخدم إقران مصادر بيانات أخرى مثل علب البريد ومواقع SharePoint Teams مع أمناء الحفظ في حالة ما. يمكن للمستخدم أيضا وضع احتجاز قانوني على مصادر البيانات المرتبطة بأمناء الحفظ للحفاظ على المحتوى في سياق الحالة.

لمزيد من المعلومات، راجع [العمل مع أمناء الحفظ في Advanced eDiscovery](managing-custodians.md).

### <a name="export"></a>التصدير

يتيح الدور للمستخدمين تصدير نتائج البحث في المحتوى إلى كمبيوتر محلي. كما يتيح لهم إعداد نتائج البحث للتحليل في Advanced eDiscovery.
...
- [إنشاء قائمة احتجاز في Core eDiscovery](create-ediscovery-holds.md) 

- [إنشاء قائمة احتجاز في Advanced eDiscovery](add-custodians-to-case.md)
...
يتيح هذا الدور للمستخدمين الوصول إلى مجموعات المراجعة في [Advanced eDiscovery](overview-ediscovery-20.md). يمكن للمستخدمين الذين تم تعيين هذا الدور رؤية قائمة الحالات وفتحها على صفحة **eDiscovery > Advanced** في مركز التوافق في Microsoft 365 التي هم أعضاء فيها. بعد وصول المستخدم إلى حالة Advanced eDiscovery، يمكنه تحديد **مجموعات المراجعة** للوصول إلى بيانات الحالة. لا يسمح هذا الدور للمستخدم بمعاينة نتائج البحث في مجموعة مقترنة بالحالة أو القيام بمهام أخرى للبحث أو إدارة الحالة. يمكن للمستخدمين الذين لديهم هذا الدور الوصول إلى البيانات في مجموعة مراجعة فقط.

### <a name="rms-decrypt"></a>فك تشفير RMS

يتيح هذا الدور للمستخدمين عرض رسائل البريد الإلكتروني المحمية بحقوق عند معاينة نتائج البحث وتصدير رسائل البريد الإلكتروني المحمية بحقوق غير المشفرة. يتيح هذا الدور أيضا للمستخدمين عرض (وتصدير) ملف مشفر [باستخدام تقنية تشفير Microsoft](encryption.md) عند إرفاق الملف المشفر برسالة بريد إلكتروني مضمنة في نتائج بحث eDiscovery. بالإضافة إلى ذلك، يتيح هذا الدور للمستخدمين مراجعة مرفقات البريد الإلكتروني المشفرة التي تتم إضافتها إلى مجموعة مراجعة في Advanced eDiscovery والاستعلام عنها. لمزيد من المعلومات حول فك التشفير في eDiscovery، راجع [فك التشفير في أدوات eDiscovery Microsoft 365](ediscovery-decryption.md).
...
يمكنك إضافة مجموعات الأدوار كأعضاء في core eDiscovery وحالات Advanced eDiscovery بحيث يمكن لأعضاء مجموعات الأدوار الوصول إلى المهام وتنفيذها في الحالات المعينة. تحدد الأدوار المعينة إلى مجموعة الأدوار ما يمكن لأعضاء مجموعة الأدوار القيام به. ثم تتيح إضافة مجموعة أدوار كعضو في الحالة للأعضاء الوصول إلى هذه المهام وتنفيذها في حالة معينة. لمزيد من المعلومات حول إضافة مجموعات الأدوار كأعضاء في الحالات، راجع:

- [بدء استخدام eDiscovery الأساسي](get-started-core-ediscovery.md#step-4-optional-add-members-to-a-core-ediscovery-case)

- [إضافة أعضاء أو إزالتهم من حالة Advanced eDiscovery](add-or-remove-members-from-a-case-in-advanced-ediscovery.md)
...
### <a name="get-a-list-of-core-ediscovery-cases-a-role-group-is-assigned-to"></a>الحصول على قائمة بحالات eDiscovery الأساسية التي تم تعيين مجموعة أدوار لها

```powershell
Get-ComplianceCase -RoleGroup "Name of role group"
```

### <a name="get-a-list-of-advanced-ediscovery-cases-a-role-group-is-assigned-to"></a>الحصول على قائمة بحالات Advanced eDiscovery تم تعيين مجموعة أدوار لها
