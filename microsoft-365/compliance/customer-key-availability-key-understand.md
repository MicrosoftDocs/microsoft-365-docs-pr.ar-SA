...
يتم تنفيذ ضوابط الوصول لمنع الوصول غير المصرح به إلى الأنظمة الداخلية، بما في ذلك المخازن السرية الرئيسية للتوفر. لا يملك مهندسو Microsoft إمكانية الوصول المباشر إلى مخازن مفاتيح التوفر السرية. لمزيد من التفاصيل حول عناصر التحكم [بالوصول، راجع "عناصر التحكم بالوصول الإداري" في Microsoft 365](/compliance/assurance/assurance-administrative-access-controls-overview).
...
### <a name="recovery-procedure-for-sharepoint-online-onedrive-for-business-and-teams-files"></a>إجراء الاسترداد لملفات SharePoint Online و OneDrive for Business و Teams
...
## <a name="how-sharepoint-online-onedrive-for-business-and-teams-files-use-the-availability-key"></a>كيفية استخدام ملفات SharePoint Online و OneDrive for Business و Teams لمفتاح التوفر
...
### <a name="triggers-for-sharepoint-online-onedrive-for-business-and-teams-files"></a>مشغلات ملفات SharePoint Online و OneDrive for Business و Teams
...
### <a name="sharepoint-online-onedrive-for-business-and-teams-files-availability-key-logging"></a>تسجيل مفتاح توفر ملفات SharePoint Online و OneDrive for Business و Teams
...
![شفرات التشفير لمفتاح عميل Exchange Online](../media/customerkeyencryptionhierarchiesexchangeskype.png)
