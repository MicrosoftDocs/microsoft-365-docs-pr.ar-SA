...
3. على علامة التبويب **"استيراد** "، انقر فوق !["إضافة أيقونة".](../media/ITPro-EAC-AddIcon.gif) **مهمة استيراد جديدة**.
   ...
   > [!NOTE]
   > يجب أن يتم تعيين الأذونات المناسبة لك للوصول إلى صفحة **الاستيراد** في مدخل التوافق لإنشاء مهمة استيراد. راجع المقطع **"قبل البدء** " للحصول على مزيد من المعلومات. 
