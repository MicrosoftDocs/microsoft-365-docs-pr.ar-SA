...
ms.locfileid: "67071383"
---
# <a name="set-up-a-connector-to-import-physical-badging-data-preview"></a>إعداد موصل لاستيراد بيانات البادئة الفعلية (معاينة)

يمكنك إعداد موصل بيانات في مدخل التوافق في Microsoft Purview لاستيراد بيانات التالفة الفعلية، مثل أحداث الوصول المادي البسيطة للموظف أو أي تنبيهات وصول فعلية تم إنشاؤها بواسطة نظام التالفة الخاص بمؤسستك. أمثلة على نقاط الوصول المادية هي إدخال إلى مبنى أو إدخال إلى غرفة الخادم أو مركز البيانات. يمكن استخدام بيانات التالفة المادية بواسطة حل Microsoft Purview [Insider Risk Management](insider-risk-management.md) للمساعدة في حماية مؤسستك من الأنشطة الضارة أو سرقة البيانات داخل مؤسستك.
