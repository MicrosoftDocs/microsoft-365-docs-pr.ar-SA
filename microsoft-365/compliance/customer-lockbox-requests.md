...
description: تعرف على طلبات مربع تأمين العميل التي تسمح لك بالتحكم في كيفية وصول مهندس دعم Microsoft إلى بياناتك عند مواجهة مشكلة.
...
ms.locfileid: "64481397"
---
# <a name="customer-lockbox-in-office-365"></a>مربع تأمين العميل في Office 365

توفر هذه المقالة إرشادات النشر والتكوين ل Customer Lockbox. يدعم Customer Lockbox الطلبات للوصول إلى البيانات في Exchange Online و SharePoint و OneDrive for Business و Teams. للتوصية بدعم خدمات أخرى، أرسل طلبا في ["مدخل الملاحظات](https://feedbackportal.microsoft.com)".
...
7. بعد موافقة الموافق من المؤسسة على الطلب، يتلقى مهندس Microsoft رسالة الموافقة ويسجل دخوله إلى المستأجر ويصلح مشكلة العميل. لدى مهندسي Microsoft المدة المطلوبة لإصلاح المشكلة التي يتم بعدها إبطال الوصول تلقائيا.
...
2. اختر **الإعدادات** >  **أو الإعدادات** >  **الأمان & الخصوصية**.
...
البحث عن `Set-AccessToCustomerDataRequest` الأنشطة
...
تعرض لقطة الشاشة التالية مثالا لسجل تدقيق يتوافق مع طلب مربع تأمين العميل المعتمد. إذا تم رفض طلب مربع تأمين العميل، ستكون `ApprovalDecision` قيمة المعلمة .`Deny`
...
مربع تأمين العميل معتمد حاليا في Exchange Online SharePoint عبر الإنترنت OneDrive for Business و Teams.

### <a name="is-customer-lockbox-available-to-all-customers"></a>هل يتوفر مربع تأمين العميل لجميع العملاء؟

يتم تضمين Customer Lockbox مع اشتراكات Microsoft 365 أو Office 365 E5 ويمكن إضافتها إلى خطط أخرى باستخدام اشتراك حماية البيانات والتوافق أو اشتراك في الوظائف الإضافية للتوافق المتقدم. لمزيد من المعلومات، [راجع الخطط والأسعار](https://products.office.com/business/office-365-enterprise-e5-business-software) .
...
- النص الذي يتم إدخاله في Teams وقنوات Teams، على سبيل المثال، الدردشات 1:1، الدردشات الجماعية، القنوات المشتركة، القنوات الخاصة، ودردشة الاجتماع

- البيانات الأخرى الملصقة في Teams الدردشة، مثل قصاصات التعليمات البرمجية والصور ورسائل الصوت والفيديو والربط

- بيانات التطبيق والبوت في Teams الدردشات Teams القنوات
...
- الملفات التي تم نشرها Teams الدردشات Teams القنوات
...
### <a name="how-do-i-opt-in-to-customer-lockbox"></a>كيف أعمل الاشتراك في Customer Lockbox؟

يمكن للمسؤول العام تمكين مربع تأمين العميل وتكوينه في مركز مسؤولي Microsoft 365.
...
### <a name="how-do-i-know-that-microsoft-follows-the-approval-process"></a>كيف أعمل تعرف أن Microsoft تتبع عملية الموافقة؟
...
يمكن للمسؤول العام فقط في مؤسستك تحديد من يمكنه الموافقة على طلبات مربع تأمين العميل. وهذا يعني أن أعضاء مجموعة مسؤول عمومي في Azure Active Directory هم فقط الذين يمكنهم تحديد الأشخاص الذين يمكنهم الموافقة على الطلب. يتم إدارة عضوية مسؤول عمومي في Azure Active Directory فقط من قبل مؤسستك.
