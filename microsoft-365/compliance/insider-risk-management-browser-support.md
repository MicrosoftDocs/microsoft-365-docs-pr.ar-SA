...
description: تعرف على اكتشاف إشارة مستعرض إدارة المخاطر الداخلية في Microsoft 365
...
غالبا ما يستخدم المستخدمون مستعرضات الويب للوصول إلى كل من الملفات الحساسة وغير الحساسة داخل المؤسسة. تسمح إدارة المخاطر الداخلية لمؤسستك بالكشف عن إشارات النقل غير المصرح به للمستعرض والتصرف عليها لجميع الملفات غير القابلة للتنفيذ التي يتم عرضها في [مستعرضي Microsoft Edge](https://www.microsoft.com/edge) [وGoogle Chrome](https://www.google.com/chrome). باستخدام هذه الإشارات، يمكن للمحللين والباحثين العمل بسرعة عند تنفيذ أي من الأنشطة التالية من قبل مستخدمي النهج داخل النطاق عند استخدام هذه المتصفحات:
...
- يوصى بأحدث إصدار Windows 10 x64، الحد الأدنى Windows 10 x64 build 1809 لدعم الكشف عن الإشارات. الكشف عن إشارة المستعرض غير مدعوم حاليا على الأجهزة غير Windows.
...
- يجب [إلحاق](/microsoft-365/compliance/insider-risk-management-settings#enable-device-indicators-and-onboard-devices) الأجهزة بمدخل التوافق Microsoft 365.

للحصول على متطلبات تكوين مستعرض معينة، راجع القسمين Microsoft Edge وGoogle Chrome لاحقا في هذه المقالة.

## <a name="configure-browser-signal-detection-for-microsoft-edge"></a>تكوين الكشف عن إشارة المستعرض Microsoft Edge

### <a name="microsoft-edge-browser-requirements"></a>متطلبات المستعرض Microsoft Edge
...
1. تسجيل الدخول إلى [مركز إدارة إدارة نقاط النهاية من Microsoft](https://endpoint.microsoft.com) باستخدام أذونات المسؤول.
...
**الخطوة 1: استيراد أحدث ملف قالب إداري Microsoft Edge (.admx).**

يجب أن تكون الأجهزة قابلة للإدارة باستخدام نهج المجموعة ويجب استيراد كافة [القوالب الإدارية Microsoft Edge](https://www.microsoft.com/edge/business/download) إلى المتجر المركزي نهج المجموعة. لمزيد من المعلومات، راجع [كيفية إنشاء المخزن المركزي للقوالب الإدارية نهج المجموعة وإدارتها في Windows](/troubleshoot/windows-client/group-policy/create-and-manage-central-store).
...
2. قم بتوسيع المسار التالي **قوالب** \>  نهج تكوين \> \> **الكمبيوتر/المستخدم** الإدارية **للقوالب الإدارية الكلاسيكية** \> **Microsoft Edge** \> **Extensions**. قد يختلف هذا المسار استنادا إلى تكوين مؤسستك.
...
2. تسجيل الدخول إلى [مركز إدارة إدارة نقاط النهاية من Microsoft](https://endpoint.microsoft.com).
...
1. تسجيل الدخول إلى [مركز إدارة إدارة نقاط النهاية من Microsoft](https://endpoint.microsoft.com).
2. انتقل إلى **ملفات تعريف التكوين**.
3. حدد **إنشاء ملف تعريف**.
4. اختر **Windows 10** *كمنصة*.
...
يجب أن تكون أجهزتك قابلة للإدارة باستخدام نهج المجموعة ويجب استيراد جميع [قوالب Chrome الإدارية](https://chromeenterprise.google/browser/download/) إلى نهج المجموعة Central Store. لمزيد من المعلومات، راجع [كيفية إنشاء المخزن المركزي للقوالب الإدارية نهج المجموعة وإدارتها في Windows](/troubleshoot/windows-client/group-policy/create-and-manage-central-store).
...
3. لاختبار الكشف عن الإشارات للملفات المطبوعة على الأجهزة المحلية أو أجهزة الشبكة، والملفات المنقولة أو المنسوخة إلى مشاركة الشبكة، والملفات المنسوخة إلى أجهزة USB، أكمل الخطوات التالية من جهاز Windows معتمد:
