...
قم بتشغيل الأمر التالي في [Security & Compliance Center PowerShell](/powershell/exchange/connect-to-scc-powershell) لتحديد نهج الاستبقاء الذي يتم تطبيقه على علبة البريد. سيقوم هذا الأمر أيضا بإرجاع أي نهج استبقاء محادثة Teams مطبقة على علبة بريد. استخدم GUID (دون تضمين البادئة أو `skp` البادئة`mbx`) لنهج الاستبقاء الذي حددته في الخطوة 1.

```powershell
Get-RetentionCompliancePolicy <retention policy GUID without prefix> | FL Name
```

بعد تحديد نهج الاستبقاء، انتقل إلى صفحة **GovernanceRetention** >  **للمعلومات** في مدخل التوافق، وقم بتحرير نهج الاستبقاء الذي حددته في الخطوة السابقة، وقم بإزالة علبة البريد من قائمة المستلمين المضمنين في نهج الاستبقاء.
  
### <a name="organization-wide-retention-policies"></a>نهج الاستبقاء على مستوى المؤسسة
  
يتم تطبيق نهج الاستبقاء على مستوى المؤسسة وعلى مستوى Exchange وعلى مستوى Teams على كل علبة بريد في المؤسسة. يتم تطبيقها على مستوى المؤسسة (وليس مستوى علبة البريد) ويتم إرجاعها عند تشغيل **الأمر Get-OrganizationConfig** cmdlet في الخطوة 1. قم بتشغيل الأمر التالي في [Security & Compliance Center PowerShell](/powershell/exchange/exchange-online-powershell) لتحديد نهج الاستبقاء على مستوى المؤسسة. استخدم GUID (دون تضمين البادئة  `mbx` ) لنهج الاستبقاء على مستوى المؤسسة التي حددتها في الخطوة 1.

```powershell
Get-RetentionCompliancePolicy <retention policy GUID without prefix> | FL Name
```

بعد تحديد نهج الاستبقاء على مستوى المؤسسة، انتقل إلى صفحة **GovernanceRetention** >  **للمعلومات** في مدخل التوافق، واحرر كل نهج استبقاء على مستوى المؤسسة حددته في الخطوة السابقة، وأضف علبة البريد إلى قائمة المستلمين المستبعدين. سيؤدي القيام بذلك إلى إزالة علبة بريد المستخدم من نهج الاستبقاء.
...
الآن أنت جاهز لحذف العناصر في مجلد العناصر القابلة للاسترداد باستخدام [New-ComplianceSearch](/powershell/module/exchange/new-compliancesearch) و [New-ComplianceSearchAction](/powershell/module/exchange/new-compliancesearchaction) cmdlets في Security & Compliance Center PowerShell.
...
4. بعد إنشاء عملية بحث في المحتوى والتحقق من أنها ترجع العناصر التي تريد wan حذفها، استخدم `New-ComplianceSearchAction -Purge -PurgeType HardDelete` الأمر (في Security & Compliance Center PowerShell) لحذف العناصر التي تم إرجاعها بواسطة بحث المحتوى الذي أنشأته في الخطوة السابقة بشكل دائم. على سبيل المثال، يمكنك تشغيل أمر مشابه للأمر التالي:
...
4. أعد تطبيق قوائم الاحتجاز التي قمت بإزالتها في الخطوة 3. استنادا إلى نوع الاحتجاز، استخدم أحد الإجراءات التالية.
    ...
    **نهج الاستبقاء المطبقة على علب بريد معينة**
    ...
    استخدم مدخل التوافق لإضافة علبة البريد مرة أخرى إلى نهج الاستبقاء. انتقل إلى صفحة **GovernanceRetention** >  **للمعلومات** في مركز الامتثال، وقم بتحرير نهج الاستبقاء، وأضف علبة البريد مرة أخرى إلى قائمة المستلمين الذين يتم تطبيق نهج الاستبقاء عليهم.

    **نهج الاستبقاء على مستوى المؤسسة**

    إذا قمت بإزالة نهج استبقاء على مستوى المؤسسة أو Exchange عن طريق استبعاده من النهج، فاستخدم مدخل التوافق لإزالة علبة البريد من قائمة المستخدمين المستبعدين. انتقل إلى صفحة **GovernanceRetention** >  **للمعلومات** في مركز الامتثال، وقم بتحرير نهج الاستبقاء على مستوى المؤسسة، وقم بإزالة علبة البريد من قائمة المستلمين المستبعدين. سيؤدي القيام بذلك إلى إعادة تطبيق نهج الاستبقاء على علبة بريد المستخدم.

    **قوائم احتجاز حالة eDiscovery**

    استخدم مدخل التوافق لإضافة علبة البريد مرة أخرى إلى قائمة الاحتجاز المقترنة بحالة eDiscovery. انتقل إلى صفحة **eDiscoveryCore** > ، وافتح الحالة، وأضف علبة البريد مرة أخرى إلى قائمة الاحتجاز. 
