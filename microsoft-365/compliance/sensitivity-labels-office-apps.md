...
لمعرفة المزيد حول دعم التسمية باستخدام عميل AIP، وكيفية تعطيل هذا العميل في تطبيقات Office فقط، راجع [لماذا اختر تسمية مضمنة عبر الوظيفة الإضافية AIP لتطبيقات Office](sensitivity-labels-aip.md).
...
## <a name="information-rights-management-irm-options-and-sensitivity-labels"></a>خيارات Rights Management المعلومات (IRM) وتسميات الحساسية

تعمل تسميات الحساسية التي تقوم بتكوينها لتطبيق التشفير على إزالة التعقيد من المستخدمين لتحديد إعدادات التشفير الخاصة بهم. في العديد من تطبيقات Office، لا يزال من الممكن تكوين إعدادات التشفير الفردية هذه يدويا من قبل المستخدمين باستخدام خيارات Rights Management المعلومات (IRM). على سبيل المثال، لتطبيقات Windows:
...
- خيار آخر هو استخدام [SharePoint والتكامل OneDrive مع Azure AD B2B](/sharepoint/sharepoint-azureb2b-integration) بحيث يتم إنشاء حسابات الضيوف تلقائيا عند مشاركة المستخدمين الارتباطات.
...
يدعم Word Excel PowerPoint الأساليب التالية لتحويل مستند Office إلى مستند PDF:
...
- تنسيق PDF/A وتشفيره
     ...
     تنسيق PDF هذا المصمم للأرشفة على المدى الطويل غير معتمد عندما تطبق التسمية التحية وستمنع المستخدمين من تحويل مستندات Office إلى PDF.
