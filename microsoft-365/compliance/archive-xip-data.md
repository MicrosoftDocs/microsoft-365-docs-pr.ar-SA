...
description: يمكن للمسؤولين إعداد موصل لاستيراد بيانات مصدر XIP وأرشفتها من Veritas إلى Microsoft 365. يتيح لك هذا الموصل أرشفة البيانات من مصادر بيانات تابعة لجهة خارجية في Microsoft 365. بعد أرشفتك لهذه البيانات، يمكنك استخدام ميزات التوافق مثل الاحتجاز القانوني والبحث في المحتوى ونهج الاستبقاء لإدارة بيانات الجهات الخارجية.
ms.openlocfilehash: a5ae71c246170f7eda041dd521e779f9c6218278
ms.sourcegitcommit: c29fc9d7477c3985d02d7a956a9f4b311c4d9c76
ms.translationtype: MT
ms.contentlocale: ar-SA
ms.lasthandoff: 07/06/2022
ms.locfileid: "66626876"
---
# <a name="set-up-a-connector-to-archive-xip-source-data"></a>إعداد موصل أرشفة بيانات مصدر XIP

استخدم موصل Veritas في مدخل التوافق في Microsoft Purview لاستيراد البيانات وأرشفتها من النظام الأساسي المصدر ل XIP إلى علب بريد المستخدمين في مؤسسة Microsoft 365. يوفر Veritas موصل [XIP](https://globanet.com/xip/) يسمح باستخدام ملف XIP لاستيراد العناصر إلى Microsoft 365. يشبه ملف XIP ملف ZIP، ولكنه يسمح باستخدام توقيع رقمي. يتم التحقق من التوقيع الرقمي بواسطة Veritas Merge 1 قبل استخراج ملف مصدر XIP. يحول الموصل المحتوى من الملف المصدر ل XIP إلى تنسيق رسالة بريد إلكتروني ثم يستورد هذه العناصر إلى علب بريد المستخدمين في Microsoft 365.
...
1. في صفحة **تعيين مستخدمي XIP إلى مستخدمي Microsoft 365** ، قم بتمكين تعيين المستخدم تلقائيا. تتضمن عناصر مصدر XIP خاصية تسمى *"البريد الإلكتروني*"، والتي تحتوي على عناوين بريد إلكتروني للمستخدمين في مؤسستك. إذا كان بإمكان الموصل إقران هذا العنوان بمستخدم Microsoft 365، يتم استيراد العناصر إلى علبة بريد هذا المستخدم.
