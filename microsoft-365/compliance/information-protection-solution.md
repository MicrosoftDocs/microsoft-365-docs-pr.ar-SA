...
![نظرة عامة على حل حماية البيانات في Microsoft Purview](../media/mip-solution-overview-extended.png)
...
![معرفة بياناتك لنظرة عامة على حل حماية البيانات في Microsoft Purview](../media/knowyourdata-mipsolution.png)

غالبا ما تكون معرفة مكان وجود بياناتك الحساسة أكبر تحد للعديد من المؤسسات. يساعدك تصنيف البيانات حماية البيانات في Microsoft Purview على اكتشاف وتصنيف كميات متزايدة باستمرار من البيانات التي تنشئها مؤسستك بدقة. تساعدك التمثيلات الرسومية على الحصول على رؤى حول هذه البيانات حتى تتمكن من إعداد النهج ومراقبتها لحمايتها وإدارتها.


|خطوه|الوصف|معلومات إضافية|
|:---|:----------|:---------------|
|1| وصف فئات المعلومات الحساسة التي تريد حمايتها. <br /><br /> لديك بالفعل فكرة عن أنواع المعلومات الأكثر قيمة لمؤسستك والأنواع التي ليست كذلك. اعمل مع أصحاب المصلحة لوصف هذه الفئات التي تشكل نقطة البداية الخاصة بك. | [التعرّف على أنواع المعلومات الحساسة](sensitive-information-type-learn-about.md) <p> [تعرّف على المزيد حول مصنفات قابلة للتدريب](classifier-learn-about.md)|
...
![حماية بياناتك من أجل نظرة عامة على حل حماية البيانات في Microsoft Purview](../media/protect-mipsolution.png)
