...
يمكنك إعداد موصل بيانات في مدخل التوافق في Microsoft Purview لاستيراد بيانات الموارد البشرية (HR) إلى مؤسسة حكومة الولايات المتحدة. تتضمن البيانات المتعلقة بالموارد البشرية التاريخ الذي أرسل فيه الموظف تاريخ استحقاقه وتاريخ اليوم الأخير للموظف. يمكن بعد ذلك استخدام بيانات الموارد البشرية هذه بواسطة حلول حماية المعلومات من Microsoft، مثل [حل إدارة المخاطر من الداخل](insider-risk-management.md)، للمساعدة في حماية مؤسستك من الأنشطة الضارة أو سرقة البيانات داخل مؤسستك. يتكون إعداد موصل الموارد البشرية من إنشاء تطبيق في Azure Active Directory يستخدم للمصادقة بواسطة الموصل، وإنشاء ملفات تعيين CSV التي تحتوي على بيانات الموارد البشرية، وإنشاء موصل بيانات في مركز الامتثال، ثم تشغيل برنامج نصي (على أساس مجدول) يستوعب بيانات الموارد البشرية في ملف CSV إلى سحابة Microsoft. ثم يتم استخدام موصل البيانات من قبل أداة إدارة المخاطر الداخلية للوصول إلى بيانات الموارد البشرية التي تم استيرادها إلى مؤسسة Microsoft 365 US Government.
...
7. قم بتشغيل الأمر التالي لتحميل بيانات الموارد البشرية في ملف CSV إلى سحابة Microsoft؛ على سبيل المثال:
   ...
   |`appId` |معرف تطبيق Azure AD للتطبيق الذي أنشأته في Azure AD في الخطوة 1. يتم استخدام هذا من قبل Azure AD للمصادقة عندما يحاول البرنامج النصي الوصول إلى مؤسسة Microsoft 365. |
   |`appSecret`|سر التطبيق Azure AD للتطبيق الذي أنشأته في Azure AD في الخطوة 1. يستخدم هذا أيضا للمصادقة.|
