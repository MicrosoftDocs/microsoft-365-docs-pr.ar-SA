...
ms.locfileid: "65320651"
---
# <a name="set-up-a-connector-to-archive-webex-teams-data"></a>إعداد موصل إلى أرشفة بيانات Teams Webex

[!include[Purview banner](../includes/purview-rebrand-banner.md)]

استخدم موصل Veritas في مدخل التوافق في Microsoft Purview لاستيراد البيانات وأرشفتها من Teams Webex إلى علب بريد المستخدمين في مؤسسة Microsoft 365. يوفر Veritas موصل [Teams Webex](https://globanet.com/webex-teams/) الذي تم تكوينه لالتقاط عناصر اتصال Teams Webex واستيرادها إلى Microsoft 365. يحول الموصل المحتوى من Teams Webex، مثل الدردشات 1:1 ومحادثات المجموعة ومحادثات القناة والمرفقات من حساب Teams Webex الخاص بمؤسستك، إلى تنسيق رسالة بريد إلكتروني ثم استيراد هذه العناصر إلى علبة بريد المستخدم في Microsoft 365.
