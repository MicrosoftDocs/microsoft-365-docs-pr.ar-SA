...
|قيمه|اختصار|الوصف|
|---|---|---|
|0<sup>1</sup>|PKIX-TA|الشهادة المستخدمة هي المرجع المصدق العام لإرساء الثقة من سلسلة الثقة X.509.|
|1<sup>1</sup>|PKIX-EE|الشهادة المحددة هي الخادم الوجهة؛ يجب أن تتحقق فحوصات DNSSEC من صحتها.|
...
## <a name="exchange-online-mail-flow-with-smtp-dane"></a>Exchange Online تدفق البريد مع SMTP DANE
...
:::image type="content" source="../media/compliance-trial/mail-flow-smtp-dane.png" alt-text="تدفق بريد Exchange عبر الإنترنت مع SMTP DANE" lightbox="../media/compliance-trial/mail-flow-smtp-dane.png":::
...
1. مدخل Exchange مسؤول Center من خلال طريقة عرض "تفاصيل تتبع الرسائل".
...
3. أعد محاولة إرسال البريد الإلكتروني وراجع "تفاصيل تتبع الرسائل" للرسالة في مدخل Exchange مسؤول Center.
...
2. السماح بوقت تجديد شهادة الخادم الوجهة وتحديث سجل TLSA للإشارة إلى الشهادة الجديدة. بعد ذلك، أعد محاولة إرسال البريد الإلكتروني وراجع "تفاصيل تتبع الرسائل" للرسالة في مدخل Exchange مسؤول Center.
...
2. السماح لوقت مسؤول البريد الإلكتروني الوجهة لمراجعة تكوين DANE وصلاحية شهادة خادم البريد الإلكتروني. بعد ذلك، أعد محاولة إرسال البريد الإلكتروني وراجع "تفاصيل تتبع الرسائل" للرسالة في مدخل Exchange مسؤول Center.
...
1. تنبيه مسؤول البريد الإلكتروني الوجهة بأنك تلقيت رمز الخطأ هذا وقم بتوفير سلسلة رمز الخطأ له.
2. السماح لوقت مسؤول البريد الإلكتروني الوجهة لمراجعة تكوين DNSSEC لمجاله. بعد ذلك، أعد محاولة إرسال البريد الإلكتروني وراجع "تفاصيل تتبع الرسائل" للرسالة في مدخل Exchange مسؤول Center.
...
[Exchange Online Transport News من Microsoft Ignite 2020 - Microsoft Tech Community](https://techcommunity.microsoft.com/t5/exchange-team-blog/exchange-online-transport-news-from-microsoft-ignite-2020/ba-p/1687699)
