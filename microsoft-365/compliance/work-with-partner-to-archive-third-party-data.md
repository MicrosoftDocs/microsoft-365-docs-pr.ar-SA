...
بعد قبول الطلب، يتم عرض مدخل [Azure](https://portal.azure.com) . لعرض قائمة التطبيقات لمؤسستك، انقر فوق تطبيقات **Azure Active Directory** > **Enterprise**. يتم سرد موصل بيانات Microsoft 365 جهة خارجية على جزء **تطبيقات Enterprise**.
