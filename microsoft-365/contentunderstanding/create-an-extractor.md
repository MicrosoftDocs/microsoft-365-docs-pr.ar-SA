...
تحتاج إلى إنشاء مستخرج لكل كيان في المستند الذي تريد استخراجه. في مثالنا، نريد استخراج تاريخ   **بدءService** لكل  **تاريخ تجديدContract**  الذي تم تحديده بواسطة النموذج. نريد أن نتمكن من رؤية طريقة عرض في مكتبة المستندات  **لكلContract** Renewaldocuments ، مع عمود يعرض قيمة تاريخ **بدء الخدمة** لكل مستند. 
...
على سبيل المثال، سنقوم بإنشاء تفسير يوفر تلميحا حول تنسيق الكيان نفسه والتباينات التي قد تكون موجودة في نماذج المستندات. على سبيل المثال، يمكن أن تكون قيمة التاريخ في عدد من التنسيقات المختلفة، مثل:
- 10/14/2019
- 14 أكتوبر 2019
...
إذا تلقيت تطابقا على ملفات العينة المسماة، يمكنك الآن اختبار النموذج الخاص بك على ملفات الأمثلة المتبقية غير المسماة. هذا اختياري، ولكنه خطوة مفيدة لتقييم "اللياقة البدنية" أو جاهزية النموذج قبل استخدامه، عن طريق اختباره على الملفات التي لم يرها النموذج من قبل.
