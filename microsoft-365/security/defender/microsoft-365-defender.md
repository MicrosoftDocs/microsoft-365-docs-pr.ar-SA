...
- **[Microsoft 365 Defender](microsoft-365-defender.md)** هو جزء من حل الكشف *والاستجابة الموسع* (XDR) من Microsoft الذي يستفيد من قائمة مشاريع أمان Microsoft 365 لتحليل بيانات التهديد تلقائيا عبر المجالات، وإنشاء صورة لهجوم على لوحة معلومات واحدة.
...
يؤدي مركزية معلومات الأمان إلى إنشاء مكان واحد للتحقيق في حوادث الأمان عبر Microsoft 365. ومن الأمثلة الأساسية على ذلك **الحوادث** ضمن **الحوادث & التنبيهات** حول التشغيل السريع Microsoft 365 Defender.
...
يتم فتح مركز التعلم مع مسارات التعلم المنظمة حول مواضيع مثل "كيفية التحقيق في استخدام Microsoft 365 Defender؟" و"Microsoft Defender لـ Office 365 أفضل الممارسات". يتم تنسيق هذا القسم حاليا بواسطة مجموعة منتجات الأمان داخل Microsoft. يعكس كل مسار تعلم الوقت المتوقع الذي يستغرقه التعرف على المفاهيم. على سبيل المثال، من المتوقع أن تستغرق "الخطوات التي يجب اتخاذها عند اختراق حساب مستخدم Microsoft Defender لـ Office 365" 8 دقائق، وهي تعلم قيم على الفور.
