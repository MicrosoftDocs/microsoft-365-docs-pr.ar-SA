...
keywords: التطبيق، الوصول، api، إنشاء
...
تصف هذه الصفحة كيفية إنشاء تطبيق للحصول على وصول برمجي Microsoft 365 Defender بدون مستخدم معرف— على سبيل المثال، إذا كنت تقوم بإنشاء خدمة daemon أو خدمة خلفية.

إذا كنت بحاجة إلى الوصول Microsoft 365 Defender برمجيا نيابة عن مستخدم واحد أو أكثر، فشاهد إنشاء تطبيق للوصول إلى [واجهات](api-create-app-user-context.md) برمجة تطبيقات Microsoft 365 Defender بالنيابة عن مستخدم وإنشاء تطبيق مع وصول الشريك إلى Microsoft 365 Defender [واجهات برمجة التطبيقات](api-partner-access.md). إذا لم تكن متأكدا من نوع الوصول الذي تحتاج إليه، فشاهد [بدء العمل](api-access.md).
...
2. انتقل إلى **تسجيلات Azure Active DirectoryApp** >  >  **التسجيل الجديد**.
   ...
   :::image type="content" source="../../media/atp-azure-new-app2.png" alt-text="علامة التبويب &quot;تسجيل جديد&quot; في مدخل Microsoft 365 Defender" lightbox="../../media/atp-azure-new-app2.png":::

3. في النموذج، اختر اسما للتطبيق، ثم حدد **تسجيل**.
...
4. في صفحة التطبيق الخاصة بك، حدد أذونات **APIAdd** >  **permissionAPIs** >  **تستخدم >**، وا اكتب الحماية من المخاطر من **Microsoft**، وحدد **الحماية من المخاطر من Microsoft**. يمكن لتطبيقك الآن الوصول إلى Microsoft 365 Defender.
   ...
   :::image type="content" source="../../media/apis-in-my-org-tab.PNG" alt-text="علامة تبويب استخدام واجهات برمجة التطبيقات الخاصة Microsoft 365 Defender المؤسسة" lightbox="../../media/apis-in-my-org-tab.PNG":::
...
9. **بالنسبة Microsoft 365 Defender الشركاء** [فقط: اتبع](./api-partner-access.md) هذه الإرشادات للوصول إلى الشريك من خلال واجهات برمجة تطبيقات Microsoft 365 Defender، قم بتعيين تطبيقك إلى مستأجر متعدد، بحيث يمكن أن يكون متوفرا في جميع المستأجرين بمجرد حصولك على موافقة المسؤول. إن الوصول إلى **الشريك** مطلوب لتطبيقات الأطراف الخارجية، على سبيل المثال، إذا قمت بإنشاء تطبيق مخصص للتشغيل في مستأجرين متعددين للعملاء. لن يكون **مطلوبا** إذا قمت بإنشاء خدمة تريد تشغيلها في المستأجر فقط، مثل تطبيق لاستخدامك الخاص يتفاعل فقط مع بياناتك الخاصة. لتعيين تطبيقك إلى مستأجر متعدد:
    ...
    يحتاج مسؤول Active Directory العام لكل مستأجر إلى تحديد ارتباط الموافقة والموافقة على تطبيقك.

    يكون لاارتباط الموافقة البنية التالية:
...
1. قم TENANT_ID إلى "مستأجر Azure" للعميل الذي يريد استخدام تطبيقك للوصول إلى Microsoft 365 Defender.
...
1. تأكد من أن *ادعاء الأدوار* ضمن الرمز المميز الذي تم فك فك تشفيره يحتوي على الأذونات المطلوبة.
   ...
   :::image type="content" source="../../media/defender-endpoint/webapp-decoded-token.png" alt-text="جزء الرمز المميز المفكك في مدخل Microsoft 365 Defender" lightbox="../../media/defender-endpoint/webapp-decoded-token.png":::
...
2. في طلب http الذي أنت `"Bearer" <token>`على وشك إرساله، قم بتعيين رأس التخويل إلى ، *يكون Bearer* هو نظام التفويض، والرمز *المميز هو الرمز* المميز الذي تم التحقق من صحته.
