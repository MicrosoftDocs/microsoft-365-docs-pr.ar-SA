...
>[!Note]
>تصف هذه المقالة تنبيهات الأمان في Microsoft 365 Defender. ومع ذلك، يمكنك استخدام تنبيهات النشاط لإرسال إعلامات بالبريد الإلكتروني إلى نفسك أو إلى مسؤولين آخرين عندما يقوم المستخدمون بأنشطة معينة في Microsoft 365. لمزيد من المعلومات، راجع [إنشاء تنبيهات النشاط - Microsoft 365 | التوافق Microsoft Docs](../../compliance/create-activity-alerts.md).
