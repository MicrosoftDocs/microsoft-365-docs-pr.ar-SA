...
![نقاط النهاية لبيئة تقييم Defender باستخدام دليل اختبار اختبار المؤسسة الذي تم محاكاته.](../../media/eval-defender-investigate-respond/eval-defender-eval-investigate-respond-endpoints-tlg.png)
...
3. سيظهر الحادث الجديد للهجوم الذي تم محاكاته في قائمة انتظار الأحداث.
    ...
    ![مثال على قائمة انتظار الحادث.](../../media/mtp/fig2.png)
...
![مثال على التنبيهات التي تم إنشاؤها.](../../media/mtp/fig6.png)
...
![مثال على التنبيه لحقن التعليمات البرمجية التي قد تكون ضارة.](../../media/mtp/fig7.png)
...
![مثال على التنبيه للسلوك غير المتوقع بواسطة عملية يتم تشغيلها بدون وسيطات سطر الأوامر.](../../media/mtp/fig8.png)

يعرض الشكل التالي صفحة تفاصيل عنوان IP المحددة (النقر فوق عنوان IP في شجرة عملية التنبيه).

![مثال لصفحة تفاصيل عنوان IP.](../../media/mtp/fig9.png)
...
![مثال لتنبيه Microsoft Defender for Identity ل استطلاع عنوان IP والمستخدم.](../../media/mtp/fig10.png)
...
![مثال على المخطط الزمني للجهاز مع السلوكيات.](../../media/mtp/fig11.png)
...
![مثال على شجرة المعالجة للسلوك المحدد لإنشاء ملف PowerShell.](../../media/mtp/fig12.png)
...
![مثال لصفحة مستخدم Defender for Cloud Apps.](../../media/mtp/fig13.png)
...
![مثال على عمليات التحقيق التلقائية المتعلقة بالحادث.](../../media/mtp/fig14.png)
...
![مثال لصفحة تفاصيل التحقيق.](../../media/mtp/fig15.png)
...
![مثال لصفحة الأحداث مع لوحة إدارة الحادث المفتوحة حيث يمكنك حل الحادث.](../../media/mtp/fig16.png)
...
[![جرب Microsoft 365 Defender الاستجابة للحوادث.](../../media/eval-defender-investigate-respond/eval-defender-eval-investigate-respond-step2.png)](eval-defender-investigate-respond-additional.md)
