...
يمكنك الوصول إلى تحليلات التهديدات إما من الجانب العلوي الأيسر من شريط التنقل في مدخل الأمان Microsoft 365، أو من بطاقة لوحة معلومات مخصصة تعرض أهم التهديدات لمؤسستك، سواء من حيث التأثير أو من حيث التعرض.
...
![لقطة شاشة مع تمييز "Settings" و"Microsoft 365 Defender" باللون الأحمر](../../media/threat-analytics/ta_create_notification_0.png)

2. اختر **تحليلات المخاطر** **الخاصة بإشعارات** >  البريد الإلكتروني، وحدد الزر **، + إنشاء قاعدة إعلام**. ستظهر قائمة منبثقة.
...
![لقطة شاشة لقائمة قواعد إعلام البريد الإلكتروني ضمن شاشة الإعدادات](../../media/threat-analytics/ta_create_notification_7.png)

## <a name="additional-report-details-and-limitations"></a>تفاصيل التقرير وقيوده الإضافية

> [!NOTE]
> كجزء من تجربة الأمان الموحدة، تتوفر الآن تحليلات التهديدات ليس فقط Microsoft Defender لنقطة النهاية، ولكن أيضا لحاملي تراخيص Microsoft Defender ل Office E5.
>
> إذا كنت لا تستخدم مدخل أمان Microsoft 365 (Microsoft 365 Defender)، يمكنك أيضا الاطلاع على تفاصيل التقرير (بدون بيانات Microsoft Defender ل Office) في مدخل مركز حماية Microsoft Defender (Microsoft Defender لنقطة النهاية).
...
- لعرض التنبيهات أو الحوادث أو بيانات الأصول المتأثرة، تحتاج إلى الحصول على أذونات ل Microsoft Defender ل Office أو Microsoft Defender لنقطة النهاية بيانات التنبيهات أو كليهما.
- لعرض محاولات البريد الإلكتروني التي تم منعها، يجب أن يكون لديك أذونات لبيانات تتبع Microsoft Defender ل Office.
...
- تستند الإحصائيات المتعلقة بالحماية من الفيروسات إلى إعدادات برنامج الحماية من الفيروسات من Microsoft Defender. يمكن أن تظهر الأجهزة التي تحتوي على حلول الحماية من الفيروسات من جهة خارجية على أنها "مكشوفة".
