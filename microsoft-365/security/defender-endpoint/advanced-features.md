...
1. في جزء التنقل، حدد **الميزات**\> المتقدمة **لنقاط النهاية** **للإعدادات**\>.
...
## <a name="enable-edr-in-block-mode"></a>تمكين EDR في وضع الحظر

يوفر الكشف عن نقطة النهاية والاستجابة لها (EDR) في وضع الحظر الحماية من البيانات الاصطناعية الضارة، حتى عندما يكون برنامج الحماية من الفيروسات من Microsoft Defender قيد التشغيل في الوضع السلبي. عند تشغيل EDR في وضع الحظر، يحظر البيانات الاصطناعية الضارة أو السلوكيات التي يتم اكتشافها على جهاز. يعمل EDR في وضع الحظر خلف الكواليس لمعالجة البيانات الاصطناعية الضارة التي تم اكتشافها بعد الاختراق.
...
1. في جزء التنقل، حدد **"** \> إعدادات **Endpoints** **General** \> **Advanced features** \> \> **Allow or block file**".
...
> [!NOTE]
> عندما يتم عزل جهاز عن الشبكة، توجد نافذة منبثقة حيث يمكنك اختيار تمكين اتصالات Outlook وSkype التي تسمح بالاتصالات للمستخدم أثناء قطع اتصاله بالشبكة. ينطبق هذا الإعداد على اتصال Skype وOutlook عندما تكون الأجهزة في وضع العزل.
...
## <a name="share-endpoint-alerts-with-microsoft-purview-compliance-portal"></a>مشاركة تنبيهات نقطة النهاية باستخدام مدخل التوافق في Microsoft Purview

إعادة توجيه تنبيهات أمان نقطة النهاية وحالة الفرز الخاصة بها إلى مدخل التوافق في Microsoft Purview، ما يسمح لك بتحسين نهج إدارة المخاطر الداخلية باستخدام التنبيهات ومعالجة المخاطر الداخلية قبل أن تسبب ضررا. تتم معالجة البيانات التي تمت إعادة توجيهها وتخزينها في نفس موقع بيانات Office 365.
...
## <a name="authenticated-telemetry"></a>بيانات تتبع الاستخدام المصادق عليها

يمكنك **تشغيل** بيانات تتبع الاستخدام المصادق عليها لمنع انتحال بيانات تتبع الاستخدام إلى لوحة المعلومات.
...
- بيئة Microsoft Intune نشطة، مع أجهزة Windows المدارة من Intune [Azure AD الانضمام](/azure/active-directory/devices/concept-azure-ad-join/).
