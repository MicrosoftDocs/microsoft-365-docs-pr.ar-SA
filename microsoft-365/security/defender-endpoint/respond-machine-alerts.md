...
> [!IMPORTANT]
> هذه الإجراءات غير مدعومة حاليا للأجهزة التي تعمل macOS أو Linux. استخدم الاستجابة المباشرة لتشغيل الإجراء. لمزيد من المعلومات حول الاستجابة المباشرة، راجع [التحقيق في الكيانات على الأجهزة باستخدام الاستجابة المباشرة](live-response.md)
...
> [!IMPORTANT]
> - هذا الإجراء غير مدعوم حاليا macOS وLinux. استخدم الاستجابة المباشرة لتشغيل الإجراء. لمزيد من المعلومات حول الاستجابة المباشرة، راجع [التحقيق في الكيانات على الأجهزة باستخدام الاستجابة المباشرة](live-response.md)
...
> [!IMPORTANT]
> - يتوفر هذا الإجراء للأجهزة الموجودة على Windows 10 والإصدار 1709 أو الإصدارات الأحدث Windows 11 Windows Server 2019 أو الإصدارات الأحدث. 
...
> [!IMPORTANT]
> - عزل الأجهزة عن الشبكة غير مدعوم حاليا للأجهزة التي تعمل macOS أو Linux. استخدم الاستجابة المباشرة لتشغيل الإجراء. لمزيد من المعلومات حول الاستجابة المباشرة، راجع [التحقيق في الكيانات على الأجهزة باستخدام الاستجابة المباشرة](live-response.md).
> - يتوفر العزل الكامل للأجهزة التي تعمل Windows 11، Windows 10، والإصدار 1703 أو أحدث، Windows Server 2022، Windows Server 2019، Windows Server 2016.
...
> [!NOTE]
> يتم دعم حظر الاتصال الوارد والصادر مع جهاز 'مضمن' على أجهزة Microsoft Defender لنقطة النهاية Windows 10 Windows Server 2019+ المضمنة.
