...
> [!IMPORTANT]
> هذه الإجراءات غير مدعومة حاليا للأجهزة التي تعمل بنظام التشغيل macOS أو Linux. استخدم الاستجابة المباشرة لتشغيل الإجراء. لمزيد من المعلومات حول الاستجابة المباشرة، راجع [التحقيق في الكيانات على الأجهزة باستخدام الاستجابة المباشرة](live-response.md)
