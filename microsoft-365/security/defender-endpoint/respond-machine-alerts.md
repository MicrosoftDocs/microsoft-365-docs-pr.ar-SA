...
|مجلد|الوصف|
|---|---|
|عمليات التشغيل التلقائي|يحتوي على مجموعة من الملفات التي يمثل كل منها محتوى سجل نقطة إدخال البدء التلقائي المعروفة (ASEP) للمساعدة في تحديد استمرار المهاجم على الجهاز. <p> <div class="alert"><b>ملاحظه:</b> إذا لم يتم العثور على مفتاح التسجيل، فسيحتوي الملف على الرسالة التالية: "خطأ: تعذر على النظام العثور على مفتاح التسجيل أو القيمة المحددة."<div>|
