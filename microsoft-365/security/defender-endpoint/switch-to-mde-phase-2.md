...
|Microsoft Endpoint Configuration Manager|راجع [إنشاء سياسات مكافحة البرامج الضارة ونشرها Endpoint Protection إدارة التكوين](/mem/configmgr/protect/deploy-use/endpoint-antimalware-policies). <br/><br/> عند إنشاء سياسات الحماية من البرامج الضارة وتكوينها، تأكد من مراجعة إعدادات الحماية في الوقت الحقيقي [](/mem/configmgr/protect/deploy-use/endpoint-antimalware-policies#real-time-protection-settings) وتمكين الحظر [من النظرة الأولى](configure-block-at-first-sight-microsoft-defender-antivirus.md).
