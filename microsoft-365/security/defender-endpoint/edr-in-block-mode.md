...
|نظام التشغيل|يجب أن تعمل الأجهزة على أحد الإصدارات التالية من Windows: <br/>- Windows 10 (كل الإصدارات)<br/>- Windows Server أو الإصدار 1803 أو الأحدث<br/>- Windows Server 2019<br/>- Windows Server 2022<br/>- Windows Server 2016 (فقط عندما برنامج الحماية من الفيروسات من Microsoft Defender في الوضع النشط)|
|Microsoft Defender لنقطة النهاية|يجب أن تكون الأجهزة مجهزه في Defender لنقطة النهاية. راجع [الحد الأدنى لمتطلبات Microsoft Defender لنقطة النهاية](minimum-requirements.md).|
...
### <a name="is-edr-in-block-mode-supported-on-windows-server-2016"></a>هل الكشف التلقائي والاستجابة على النقط النهائية وضع الحظر مدعوما على Windows Server 2016؟
...
>[!NOTE]
>Windows Server 2016 Windows Server 2012 R2 باستخدام الإرشادات الموجودة في [خوادم Windows Onboard](configure-server-endpoints.md) لكي تعمل هذه الميزة. 
