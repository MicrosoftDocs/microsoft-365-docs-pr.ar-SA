---
title: استكشاف مشاكل تشغيل الحافظة وإصلاحها المتعلقة بإدارة الأمان Microsoft Defender لنقطة النهاية
description: استكشاف المشاكل التي قد تنشأ أثناء تشغيل الأجهزة وإصلاحها باستخدام إدارة الأمان Microsoft Defender لنقطة النهاية.
...
ms.locfileid: "64467918"
---
# <a name="troubleshoot-onboarding-issues-related-to-security-management-for-microsoft-defender-for-endpoint"></a>استكشاف مشاكل تشغيل الحافظة وإصلاحها المتعلقة بإدارة الأمان Microsoft Defender لنقطة النهاية
...
- [إدارة Microsoft Defender لنقطة النهاية على الأجهزة التي إدارة نقاط النهاية من Microsoft](/mem/intune/protect/mde-security-integration)
- [Microsoft Defender لنقطة النهاية](https://go.microsoft.com/fwlink/?linkid=2154037)
- [Microsoft 365 Defender](https://go.microsoft.com/fwlink/?linkid=2118804)

إدارة الأمان Microsoft Defender لنقطة النهاية هي إمكانية للأجهزة التي لا يديرها إدارة نقاط النهاية من Microsoft، إما Microsoft Intune أو Microsoft Endpoint Configuration Manager، لتلقي تكوينات الأمان Microsoft Defender لنقطة النهاية مباشرة من إدارة نقاط النهاية.
لمزيد من المعلومات حول إدارة الأمان Microsoft Defender لنقطة النهاية، راجع إدارة Microsoft Defender لنقطة النهاية [على الأجهزة التي إدارة نقاط النهاية من Microsoft](/mem/intune/protect/mde-security-integration).

للحصول على إرشادات إدارة الأمان Microsoft Defender لنقطة النهاية التهيئة، راجع Microsoft Defender لنقطة النهاية [إدارة تكوين الأمان](security-config-management.md)

تم تصميم هذا التكاتف من النهاية إلى النهاية بحيث لا يحتاج إلى أي احتكاك ولا يتطلب إدخال المستخدم. ومع ذلك، إذا واجهت مشاكل أثناء التكهو، يمكنك عرض الأخطاء في النظام الأساسي Microsoft Defender لنقطة النهاية وإصلاحها.

> [!NOTE]
> إذا كنت تواجه مشاكل في تدفق المستلزمات للأجهزة الجديدة، فراجع Microsoft Defender لنقطة النهاية الأساسية وتأكد من اتباع إرشادات اللحق.[](/mem/intune/protect/mde-security-integration#prerequisites)

لمزيد من المعلومات حول محلل العميل، راجع استكشاف الأخطاء وإصلاحها في صحة المستشعر [باستخدام Microsoft Defender لنقطة النهاية العميل](/microsoft-365/security/defender-endpoint/overview-client-analyzer).
...
## <a name="troubleshoot-errors-from-the-microsoft-defender-for-endpoint-portal"></a>استكشاف الأخطاء من مدخل Microsoft Defender لنقطة النهاية وإصلاحها

من خلال Microsoft Defender لنقطة النهاية، يمكن لمسؤولي الأمان الآن استكشاف الأخطاء في إدارة الأمان وإصلاحها Microsoft Defender لنقطة النهاية التشغيل.
...
لرؤية قائمة بكل الأجهزة التي فشلت فيها "إدارة الأمان" Microsoft Defender لنقطة النهاية عملية الضم، يمكنك تصفية الجدول حسب **MDE-Error**.
...
## <a name="run-microsoft-defender-for-endpoint-client-analyzer-on-windows"></a>تشغيل Microsoft Defender لنقطة النهاية العميل على Windows

فكر في تشغيل "محلل العملاء" على نقاط النهاية التي فشلت في إكمال "إدارة الأمان" Microsoft Defender لنقطة النهاية التكميل. لمزيد من المعلومات حول محلل العميل، راجع استكشاف الأخطاء وإصلاحها في صحة المستشعر [باستخدام Microsoft Defender لنقطة النهاية العميل](overview-client-analyzer.md).

يمكن أن يوفر ملف إخراج "محلل العميل" (MDE Client Analyzer Results.htm) معلومات أساسية حول استكشاف الأخطاء وإصلاحها:

- التحقق من أن نظام تشغيل الجهاز في نطاق إدارة الأمان لتدفق Microsoft Defender لنقطة النهاية في **القسم "تفاصيل الجهاز العامة**"
...
على سبيل المثال، كجزء من تدفق إعداد إدارة الأمان، من المطلوب أن يطابق "مستأجر Azure Active Directory" في مستأجر Microsoft Defender لنقطة النهاية مع "مستأجر SCP" الذي يظهر في القسم "تفاصيل إدارة تكوين الجهاز" **للتقارير.** إذا كان ذلك ذا صلة، سيوصي إخراج التقرير بتنفيذ عملية التحقق هذه.

:::image type="content" source="images/detailed-results.png" alt-text="الصفحة التي تعرض النتائج المفصلة" lightbox="images/detailed-results.png"
...
3. سيتم **عرض نافذة تحرير** قاعدة المزامنة الواردة. قم بتحديث وصف القاعدة لتلاحظ أنه Windows Server 2012R2 باستخدام هذه القاعدة. اترك كل الخيارات الأخرى بدون تغيير باستثناء قيمة الأسبقية. أدخل قيمة الأسبقية التي تكون أعلى من القيمة من القاعدة الأصلية (كما هو مشاهد في قائمة القواعد).
   ...
   :::image type="content" source="images/ee0f29162bc3f2fbe666c22f14614c45.png" alt-text="صفحة تحرير قاعدة المزامنة الواردة التي تقوم بإدخال القيم فيها" lightbox="images/ee0f29162bc3f2fbe666c22f14614c45.png":::
