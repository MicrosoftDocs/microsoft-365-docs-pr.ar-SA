...
> [!NOTE]
> ناقش متطلبات الأهلية مع موفر خدمة Microsoft الفنية وفريق الحساب قبل التقدم إلى خدمة تتبع التهديدات المدارة في إشعارات هجمات نقطة النهاية.

تأكد من نشر Defender لنقطة النهاية في بيئتك مع الأجهزة المسجلة، وليس فقط على إعداد المختبر.

إذا كنت أحد عملاء Defender لنقطة النهاية، فستحتاج إلى تقديم طلب للحصول على **إعلامات هجوم نقطة النهاية** للحصول على رؤى وتحليلات خاصة للمساعدة في تحديد التهديدات الأكثر أهمية، حتى تتمكن من الاستجابة لها بسرعة. اتصل بفريق حسابك أو ممثل Microsoft للاشتراك **في خبراء المخاطر في Microsoft - خبراء عند الطلب** للرجوع إلى خبراء التهديدات لدينا حول عمليات الكشف والخصوم ذات الصلة.
...
1. من جزء التنقل، انتقل إلى **الإعدادات > الميزات المتقدمة > العامة > إعلامات هجوم نقطة النهاية**.
...
عند الموافقة، ستتلقى رسالة بريد إلكتروني ترحيبية وسترى تغيير الزر **"تطبيق** " على زر التبديل "قيد التشغيل". في حالة رغبتك في إخراج نفسك من خدمة إعلامات الهجوم لنقطة النهاية، مرر زر التبديل "إيقاف التشغيل" وانقر فوق **"حفظ التفضيلات** " في أسفل الصفحة.
...
لتلقي إعلامات هجوم نقطة النهاية عبر البريد الإلكتروني، قم بإنشاء قاعدة إعلام بالبريد الإلكتروني.
...
## <a name="view-the-endpoint-attack-notifications"></a>عرض إعلامات هجوم نقطة النهاية
...
- اكتشفنا رسالة بريد إلكتروني للتصيد الاحتيالي قامت بتسليم مستند Word ضار إلى مستخدم. تسبب مستند Word الضار في سلسلة من الأحداث المشبوهة، والتي أدت إلى تشغيل تنبيهات متعددة لإشعارات هجوم نقطة النهاية للبرامج الضارة [اسم البرامج الضارة]. هل لديك أي معلومات حول هذه البرامج الضارة؟ إذا كان الجواب نعم، هل يمكنك إرسال ارتباط إلي؟
...
- هل يمكن لفريق الاستجابة للحوادث مساعدتنا في معالجة إعلامات هجوم نقطة النهاية التي تلقيناها؟
- تلقيت إعلامات هجوم نقطة النهاية هذه من خبراء المخاطر في Microsoft. ليس لدينا فريق الاستجابة للحوادث الخاص بنا. ماذا يمكننا أن نفعل الآن، وكيف يمكننا احتواء الحادث؟
- تلقيت إعلامات هجوم نقطة النهاية من خبراء المخاطر في Microsoft. ما هي البيانات التي يمكنك توفيرها لنا والتي يمكننا تمريرها إلى فريق الاستجابة للحوادث لدينا؟
