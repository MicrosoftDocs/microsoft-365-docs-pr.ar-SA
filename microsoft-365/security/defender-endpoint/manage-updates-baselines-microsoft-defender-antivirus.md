...
<br/><br/>
<details>
<summary>مايو 2022 (النظام الأساسي: 4.18.2205.7 | المحرك: 1.1.19300.2)</summary>

&ensp;إصدار تحديث التحليل الذكي لمخاطر الأمان: **1.369.88.0**<br/>
&ensp;تم الإصدار: **22 يونيو 2022**<br/>
&ensp;النظام الأساسي: **4.18.2205.7**<br/>
&ensp;المحرك: **1.1.19300.2**<br/>
&ensp;مرحلة الدعم: **تحديثات الأمان والتحديثات الهامة**<br/>

إصدار المحرك: 1.1.19300.2<br/>
إصدار تحديث التحليل الذكي لمخاطر الأمان: 1.369.88.0<br/>
...
- تمت إضافة تصحيح لـ [للكشف عن ASR LSASS](attack-surface-reduction-rules-reference.md)
...
*قد يواجه العملاء الذين طبقوا تحديث محرّك Microsoft Defender بتاريخ مارس 2022 (**1.1.19100.5**) استخدام عالٍ للموارد (وحدة المعالجة المركزية و/أو الذاكرة). أصدرت Microsoft تحديثاً (**1.1.19200.5**) يعالج الأخطاء الموجودة في الإصدار السابق. يوصى العملاء بالتحديث إلى تحديث إصدار محرّك مكافحة الفيروسات (**1.1.19200.5**). لضمان حل أي مشاكل متعلقة بالأداء بالكامل، من المستحسن إعادة تمهيد الأجهزة برمجياً بعد تطبيق التحديث.*
...
&ensp;إصدار الحزمة: **20220629.5**<br/>
&ensp;إصدار النظام الأساسي: **4.18.2205.7**<br/>
&ensp;إصدار المحرّك: **1.1.19300.2**<br/>
&ensp;إصدار التوقيع: **1.369.220.0**<br/>
