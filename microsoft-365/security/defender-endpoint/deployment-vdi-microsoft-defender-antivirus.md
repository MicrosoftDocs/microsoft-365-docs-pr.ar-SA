---
title: دليل نشر البنية الأساسية لسطح المكتب الظاهري ل Microsoft Defender Antivirus
...
4. قم بتوسيع الشجرة إلى **مكونات** \> Windows التحديثات **Microsoft Defender Antivirus** \> **Security Intelligence**.
...
لا يزال وقت بدء الفحص نفسه يستند إلى نهج الفحص المجدول (**ScheduleDay** و **ScheduleTime** و **ScheduleQuickScanTime**). ستؤدي العشوائية إلى بدء برنامج الحماية من الفيروسات من Microsoft Defender عملية فحص على كل جهاز ضمن نافذة مدتها أربع ساعات من الوقت المحدد لإجراء الفحص المجدول.
...
1. في محرر نهج المجموعة، انتقل إلى **القوالب** \> الإدارية **لمكونات** \> **Microsoft Defender Antivirus** \> **Scan**.
...
في بعض الأحيان، قد يتم إرسال إعلامات برنامج الحماية من الفيروسات من Microsoft Defender إلى جلسات عمل متعددة أو الاستمرار فيها. لتقليل هذه المشكلة، يمكنك تأمين واجهة مستخدم Microsoft Defender Antivirus. يصف الإجراء التالي كيفية منع الإعلامات باستخدام نهج المجموعة.

1. في محرر نهج المجموعة، انتقل إلى واجهة **عميل Microsoft** **Defender Antivirus** \> **لمكونات** \> Windows.
...
1. في محرر نهج المجموعة، انتقل إلى **مكونات** \> Windows التحديثات Microsoft **Defender Antivirus** \> **Security Intelligence**.
...
يمكنك أيضا تعطيل `ScanOnlyIfIdle` الخيار في برنامج الحماية من الفيروسات من Microsoft Defender عن طريق التكوين عبر نهج مجموعة المجال أو المحلي. وهذا يمنع منافسة وحدة المعالجة المركزية الهامة في البيئات عالية الكثافة.
...
1. في محرر نهج المجموعة، انتقل إلى Microsoft **Defender Antivirus** \> **Scan** **لمكونات** \> Windows.
...
يخفي هذا النهج واجهة مستخدم Microsoft Defender Antivirus بالكامل عن المستخدمين النهائيين في مؤسستك.
