# [Microsoft Defender لنقطة النهاية](index.yml)
...
#### [بدء العمل](mde-plan1-getting-started.md)
#### [الصيانة والعمليات](mde-p1-maintenance-operations.md)
### [Microsoft Defender for Endpoint لعملاء الحكومة الأمريكية](gov.md)
...
### [المرحلة 3: Onboard]()
#### [نظرة عامة على ال متن الطائرة](onboarding.md)
...
## [أدلة الترحيل](migration-guides.md)
### [الانتقال إلى Defender لنقطة النهاية](switch-to-mde-overview.md)
#### [المرحلة 1: التحضير](switch-to-mde-phase-1.md)
#### [المرحلة الثانية: الإعداد](switch-to-mde-phase-2.md)
#### [المرحلة 3: Onboard](switch-to-mde-phase-3.md)
...
#### [استخدام إدارة التكوين](manage-mde-post-migration-configuration-manager.md)
...
## [تكوين أجهزة التهيئة واللوح]()
### [الأجهزة المجهزة وتكوين قدرات نقطة النهاية ل Microsoft Defender](onboard-configure.md)


### [Microsoft Defender لنقطة النهاية على Windows و Windows Server]()
#### [أدوات وأساليب ال Windows نقاط النهاية](configure-endpoints.md)
#### [أجهزة Windows وخادمات Windows الأجهزة]()
...
#### [الأجهزة المجهزة بدون اتصال بالإنترنت](onboard-offline-machines.md)
#### [تشغيل اختبار الكشف على جهاز تم تشغيله حديثا](run-detection-test.md)
...
#### [Microsoft Defender ل Endpoint على macOS]()
##### [نظرة عامة حول Microsoft Defender لنقطة النهاية على macOS](microsoft-defender-endpoint-mac.md)
##### [الجديد](mac-whatsnew.md)

##### [نشر]()
###### [Microsoft Intune يستند إلى](mac-install-with-intune.md)
###### [النشر Pro JAMF]()
####### [نشر Microsoft Defender ل Endpoint على macOS باستخدام Jamf Pro](mac-install-with-jamf.md)
####### [تسجيل الدخول إلى Jamf Pro](mac-install-jamfpro-login.md)
####### [إعداد مجموعات الأجهزة](mac-jamfpro-device-groups.md)
####### [إعداد السياسات](mac-jamfpro-policies.md)
####### [تسجيل الأجهزة](mac-jamfpro-enroll-devices.md)

###### [النشر باستخدام نظام مختلف لإدارة أجهزة المحمول (MDM)](mac-install-with-other-mdm.md)
...
#### [Microsoft Defender ل Endpoint على Linux]()
##### [نظرة عامة حول Microsoft Defender لنقطة النهاية على Linux](microsoft-defender-endpoint-linux.md)
##### [الجديد](linux-whatsnew.md)
##### [نشر]()
###### [النشر اليدوي](linux-install-manually.md)
###### [النشر المستند إلى المهينة](linux-install-with-puppet.md)
###### [نشر مستند إلى غير قابل للطي](linux-install-with-ansible.md)
...
###### [جدولة تحديث ل Microsoft Defender ل Endpoint (Linux)](linux-update-MDE-Linux.md)
...
####### [تكوين Microsoft Defender للإشارات إلى مخاطر نقطة النهاية باستخدام نهج حماية التطبيق](android-configure-mam.md)

###### [الخصوصية]()
####### [Microsoft Defender لنقطة النهاية على نظام التشغيل Android - معلومات الخصوصية](android-privacy.md)

###### [استكشاف الأخطاء وإصلاحها]()
####### [استكشاف المشاكل وإصلاحها](android-support-signin.md)

##### [Microsoft Defender لنقطة النهاية على نظام التشغيل iOS]()
...
###### [نشر]()
####### [نشر Microsoft Defender لنقطة النهاية على نظام التشغيل iOS عبر Intune](ios-install.md)
####### [نشر Microsoft Defender لنقطة النهاية على نظام التشغيل iOS للأجهزة غير التي تم نشرها](ios-install-unmanaged.md)
...
### [إدارة إعدادات تكوين Microsoft Defender لنقطة النهاية على الأجهزة التي تستخدم إدارة نقاط النهاية من Microsoft](security-config-management.md)

### [استكشاف مشاكل الحافظة وإصلاحها]()
#### [استكشاف الأخطاء وإصلاحها أثناء ال متنها](troubleshoot-onboarding.md)
...
#### [إدارة الأجهزة]()
##### [أجهزة التكهين](onboard-configure.md)
##### [أجهزة إيقاف التشغيل](offboard-machines.md)
##### [التأكد من تكوين أجهزتك بشكل صحيح](configure-machines.md)
##### [مراقبة االتدبور على الجهاز وزياته](configure-machines-onboarding.md)

#### [تكوين مركز حماية Microsoft Defender المنطقة الزمنية](time-settings.md)

## [الكشف عن التهديدات وحماية نقاط النهاية]()
### [التهديدات & إدارة الثغرات الأمنية]()
#### [نظرة عامة](next-gen-threat-and-vuln-mgt.md)
#### [بدء العمل]()
##### [الأذونات & الأساسية](tvm-prerequisites.md)
...
##### [التخطيط للبرامج التي تنتهي الدعم](tvm-end-of-support-software.md)
##### [الحد من الثغرات في اليوم الصفري](tvm-zero-day-vulnerabilities.md)
#### [فهم نقاط الضعف على أجهزتك]()
...
### [إعداد تقارير جدار حماية المضيف في Microsoft Defender لنقطة النهاية](host-firewall-reporting.md)

### [الحد من سطح الهجوم]()
#### [نظرة عامة حول الحد من سطح الهجوم](overview-attack-surface-reduction.md)
#### [قواعد الحد من سطح الهجوم (ASR)]()
##### [التعرف على قواعد ASR](attack-surface-reduction.md)
...
##### [أفضل معا: برنامج الحماية من الفيروسات من Microsoft Defender Office 365](office-365-microsoft-defender-antivirus.md)
...
#### [تكوين عمليات برنامج الحماية من الفيروسات من Microsoft Defender ضوئية](schedule-antivirus-scans.md)
...
#### [البحث عن أسماء الكشف عن البرامج الضارة ل Microsoft Defender لنقطة النهاية](find-defender-malware-name.md)

#### [الحصول على تحديثات الحماية من الفيروسات و مكافحة البرامج الضارة](manage-updates-baselines-microsoft-defender-antivirus.md)
...
##### [استخدم إعدادات نهج المجموعة لإدارة برنامج الحماية من الفيروسات من Microsoft Defender](use-group-policy-microsoft-defender-antivirus.md)
...
##### [تحديد ما إذا كان يمكن للمستخدمين تعديل إعدادات نهج برنامج الحماية من الفيروسات من Microsoft Defender محليا أم لا](configure-local-policy-overrides-microsoft-defender-antivirus.md)
...
#### [عمليات المسح والوساطة](review-scan-results-microsoft-defender-antivirus.md)
...
#### [برنامج الحماية من الفيروسات من Microsoft Defender استثناءات](configure-exclusions-microsoft-defender-antivirus.md)
##### [الاستثناءات استنادا إلى ملحق الملف وموقع المجلد](configure-extension-file-exclusions-microsoft-defender-antivirus.md)
...
##### [استكشاف مشاكل الأداء وإصلاحها](troubleshoot-performance-issues.md)
##### [راجع سجلات الأحداث ورموز الأخطاء لا استكشاف المشاكل المتعلقة بالأحداث وإصلاحها برنامج الحماية من الفيروسات من Microsoft Defender](troubleshoot-microsoft-defender-antivirus.md)
...
###### [تحليل معمق](respond-file-alerts.md#deep-analysis)
...
#### [إعداد التقارير]()
##### [Power BI - كيفية استخدام API - نماذج](api-power-bi.md)
...
#### [ملاحظات حول إصدار API](api-release-notes.md)
#### [Microsoft Defender ل API لنقطة النهاية]()
##### [بدء العمل]()
###### [ترخيص Microsoft Defender ل API (API) لنقطة النهاية ولشروطه](api-terms-of-use.md)
###### [الوصول إلى واجهات برمجة تطبيقات Microsoft Defender لنقطة النهاية](apis-intro.md)
###### [مرحبا بالعالم](api-hello-world.md)
...
##### [مخطط واجهات برمجة التطبيقات ل Microsoft Defender لنقطة النهاية]()
###### [واجهات برمجة تطبيقات نقطة النهاية المدعومة من Microsoft Defender](exposed-apis-list.md)
###### [رموز أخطاء REST API الشائعة](common-errors.md)
...
####### [الحصول على معلومات التنبيه حسب الم ID](get-alert-info-by-id.md)
...
####### [تقييم مخزون البرامج](get-assessment-software-inventory.md)
...
####### [Upload مكتبة الاستجابة المباشرة](upload-library.md)
...
####### [الحصول على جهاز بواسطة الم ID](get-machine-by-id.md)
...
####### [جهاز Offboard](offboard-machine-api.md)
...
####### [الحصول على توصية بواسطة الم ID](get-recommendation-by-id.md)
...
####### [الحصول على البرامج حسب الم ID](get-software-by-id.md)
...
####### [الحصول على ثغرة أمنية بواسطة الم ID](get-vulnerability-by-id.md)
...
##### [دفق البيانات الخام](raw-data-export.md)
##### [دفق أحداث الصيد المتقدمة إلى مركز أحداث Azure](raw-data-export-event-hub.md)
##### [دفق أحداث الصيد المتقدمة إلى حساب التخزين](raw-data-export-storage.md)

#### [تكامل SIEM]()
##### [دمج أدوات SIEM مع Microsoft Defender لنقطة النهاية](configure-siem.md)
##### [استكشاف مشاكل تكامل أداة SIEM وإصلاحها](troubleshoot-siem.md)

#### [الشركاء & واجهات برمجة التطبيقات]()
##### [تطبيقات الشركاء](partner-applications.md)
##### [التطبيقات المتصلة](connected-applications.md)
##### [مستكشف API](api-explorer.md)
...
#### [كن أحد شركاء Microsoft Defender for Endpoint](get-started-partner-integration.md)
### [عمليات التكامل]()
#### [عمليات تكامل Microsoft Defender لنقطة النهاية](threat-protection-integration.md)
#### [حماية المستخدمين والبيانات والأجهزة باستخدام الوصول الشرطي](conditional-access.md)
#### [نظرة عامة حول تكامل تطبيقات السحابة ل Microsoft Defender](microsoft-cloud-app-security-integration.md)

### [حماية المعلومات في Windows عامة]()
#### [Windows التكامل](information-protection-in-windows-overview.md)

### [الوصول إلى مركز مجتمع Microsoft Defender لنقطة النهاية](community.md)
...
#### [مراجعة أحداث المستشعر والأخطاء على الأجهزة باستخدام "عارض الأحداث"](event-error-codes.md)
...
### [استكشاف مشاكل خدمة Microsoft Defender لنقطة النهاية وإصلاحها]()
#### [استكشاف مشاكل الخدمة وإصلاحها](troubleshoot-mdatp.md)
#### [الاتصال بدعم نقطة النهاية ل Microsoft Defender](contact-support.md)
...
# [Microsoft 365 Defender المستندات]()
