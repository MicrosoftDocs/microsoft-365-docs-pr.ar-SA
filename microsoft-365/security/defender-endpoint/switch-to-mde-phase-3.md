---
title: التبديل إلى Microsoft Defender ل Endpoint - Onboard
...
keywords: الترحيل، Microsoft Defender ل Endpoint، edr
...
| [![المرحلة 1: التحضير3.](images/phase-diagrams/prepare.png)](switch-to-mde-phase-1.md)<br/>[المرحلة 1: التحضير](switch-to-mde-phase-1.md) | [![المرحلة الثانية: إعداد](images/phase-diagrams/setup.png)](switch-to-mde-phase-2.md)<br/>[المرحلة الثانية: إعداد](switch-to-mde-phase-2.md) | ![المرحلة 3: Onboard](images/phase-diagrams/onboard.png)<br/>المرحلة 3: Onboard |
|--|--|--|
|| |*أنت هنا!* |
...
> [!NOTE]
> إذا حدث خطأ ما أثناء التكوين، فشاهد استكشاف مشاكل [تشغيل نقطة النهاية وإصلاحها في Microsoft Defender](troubleshoot-onboarding.md). تصف هذه المقالة كيفية حل مشاكل التكوين والأخطاء الشائعة في نقاط النهاية.
...
| macOS (راجع [متطلبات النظام](microsoft-defender-endpoint-mac.md) | [برنامج نصي محلي](mac-install-manually.md)<br/><br/>[إدارة نقاط النهاية من Microsoft](mac-install-with-intune.md)<br/><br/>[JAMF Pro](mac-install-with-jamf.md)<br/><br/>[إدارة أجهزة المحمول](mac-install-with-other-mdm.md)   |
...
>
> - [تفضيلات نهج المجموعة](/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/dn581922(v=ws.11))
...
> - [حزمة في "إدارة التكوين"](/mem/configmgr/apps/deploy-use/packages-and-programs)
