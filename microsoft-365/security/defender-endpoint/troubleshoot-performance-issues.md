...
description: استكشاف الأخطاء المتعلقة باستخدام CPU العالي المرتبط لخدمة الحماية في الوقت الحقيقي وإصلاحها في Microsoft Defender لنقطة النهاية.
...
إذا كان النظام لديك تواجه مشاكل عالية في استخدام وحدة المعالجة المركزية (CPU) أو الأداء ذات الصلة بالخدمة في الوقت Microsoft Defender لنقطة النهاية، يمكنك إرسال تذكرة إلى دعم Microsoft. اتبع الخطوات في [تجميع برنامج الحماية من الفيروسات من Microsoft Defender التشخيصية](collect-diagnostic-data.md).
...
إذا كان بإمكانك تحديد البرامج التي تؤثر على أداء النظام بسهولة، فاذهب إلى مركز قاعدة معارف أو مركز الدعم الخاص بمورد البرنامج. ابحث إذا كانت لديهم توصيات حول استثناءات برنامج الحماية من الفيروسات. إذا لم يكن موقع ويب الخاص بالمورد يحتوي عليها، يمكنك فتح تذكرة دعم معه ومطالبته بنشر تذكرة دعم.
...
2. لإزالة علامة الملف على الويب:
    ...
    :::image type="content" source="images/procmon-motw.png" alt-text="الصفحة &quot;إزالة MOTW&quot;" lightbox="images/procmon-motw.png":::
...
6. يمكنك تشغيل ProcMon من خلال طريقتين.
    1. انقر **بضغطةProcMon.exe** وحدد **تشغيل كمسؤول**.
        ...
        :::image type="content" source="images/procmon-magglass-stop.png" alt-text="الشرطة المائلة الحمراء" lightbox="images/procmon-magglass-stop.png":::
...
7. بعد اتباع أحد الإجراءات في الخطوة 6، سترى بعد ذلك خيارا لتعيين عوامل التصفية. حدد **موافق**. يمكنك دائما تصفية النتائج بعد اكتمال الالتقاط.
   ...
   :::image type="content" source="images/procmon-filter-options.png" alt-text="الصفحة التي يتم اختيار &quot;استبعاد النظام&quot; عليها ك &quot;تصفية اسم العملية&quot;" lightbox="images/procmon-filter-options.png":::
...
4. بعد ذلك، قم [بتنزيل ملف Microsoft Defender لنقطة النهاية التحليل](https://github.com/YongRhee-MDE/Scripts/blob/master/MDAV.wprp) واحفظه `MDAV.wprp` كمجلد مثل `C:\temp`.
...
7. بعد ذلك، سترى مجموعة ملفات تعريف جديدة ضمن قياسات  مخصصة *Microsoft Defender لنقطة النهاية تحليل* أسفلها.

   :::image type="content" source="images/wpr-infile.png" alt-text="في ملف" lightbox="images/wpr-infile.png":::
...
8. لاستخدام ملف تعريف Microsoft Defender لنقطة النهاية المخصص في واجهة مستخدم WPR:

    1. تأكد من عدم تحديد أي ملفات تعريف ضمن *مجموعات* فرز المستوى الأول وتحليل *الموارد* *وتحليل السيناريو* .
    2. حدد **قياسات مخصصة**.
    3. حدد **Microsoft Defender لنقطة النهاية التحليل**.
...
10. حدد **بدء**.
    ...
    :::image type="content" source="images/wpr-09.png" alt-text="صفحة معلومات نظام التسجيل" lightbox="images/wpr-09.png":::
...
13. تعبئة **اكتب وصفا مفصلا للمشكلة:** بمعلومات حول المشكلة وكيفية إعادة إنتاج المشكلة.
    ...
    :::image type="content" source="images/wpr-12.png" alt-text="الجزء الذي تقوم بتعبئته" lightbox="images/wpr-12.png":::
...
14. انتظر أثناء دمج عملية التتبع.
    ...
    :::image type="content" source="images/wpr-13.png" alt-text="التتبع العام لجمع WPR" lightbox="images/wpr-13.png":::

15. بعد حفظ عملية التتبع، حدد **فتح مجلد**.

    :::image type="content" source="images/wpr-14.png" alt-text="الصفحة التي تعرض الإعلام الذي يفيد بحفظ تتبع WPR" lightbox="images/wpr-14.png":::
...
1. قم **[Microsoft Defender لنقطة النهاية تحليل تتبعات](https://github.com/YongRhee-MDE/Scripts/blob/master/MDAV.wprp)** `MDAV.wprp` الأداء إلى ملف مسمى في دليل محلي مثل `C:\traces`.
...
4. عند المطالبة غير المرتفعة، يمكنك تشغيل الأمر التالي لبدء Microsoft Defender لنقطة النهاية تتبع الأداء:
