---
title: الحصول على API إحصائيات الملفات
description: تعرف على كيفية استخدام API للحصول على إحصائيات الملف لاسترداد إحصائيات الملف المعطى في Microsoft Defender لنقطة النهاية.
keywords: apis، api للرسم البياني، apis المعتمدة، الحصول، ملف، إحصائيات
...
ms.locfileid: "63575834"
---
# <a name="get-file-statistics-api"></a>الحصول على API إحصائيات الملفات
...
استرداد إحصائيات الملف المعطى.

## <a name="limitations"></a>القيود

1. قيود السعر ل API هذه هي 100 مكالمة في الدقيقة و1500 مكالمة في الساعة.
2. الحد الأقصى لقيمة هو `lookbackhours` 720 ساعة (30 يوما).
...
إذا نجح الملف وكان موجودا - 200 موافق مع البيانات الإحصائية في الجسم. إذا لم يكن الملف موجودا - 404 لم يتم العثور عليه.
