...
keywords: microsoft، defender، Microsoft Defender لنقطة النهاية، ios، التطبيق، التثبيت، النشر، إزالة التثبيت، intune
...
> [!NOTE]
> Microsoft Defender لنقطة النهاية على iOS في [Apple App Store](https://aka.ms/mdatpiosappstore).
...
1. في [مركز إدارة Microsoft Endpoint،](https://go.microsoft.com/fwlink/?linkid=2109431) انتقل إلى **تطبيق متجر AppsiOS** -> **/iPadOSAddiOS** ->  ->  وانقر فوق **تحديد**.
    ...
    > :::image type="content" source="images/ios-deploy-1.png" alt-text="علامة التبويب &quot;إضافة تطبيقات&quot; في إدارة نقاط النهاية من Microsoft إدارة" lightbox="images/ios-deploy-1.png":::

1. في الصفحة **إضافة تطبيق**، انقر فوق البحث **في** **App Store وا اكتب** Microsoft Defender لنقطة النهاية في شريط البحث. في المقطع نتائج البحث، *انقر فوق Microsoft Defender لنقطة النهاية* وانقر فوق **تحديد**.
...
1. في المقطع **الواجبات** ، انتقل إلى المقطع **مطلوب** وحدد **إضافة مجموعة**. يمكنك بعد ذلك اختيار مجموعة (مجموعة) المستخدمين التي تريد استهداف Defender ل Endpoint على تطبيق iOS. انقر **فوق تحديد** ثم **فوق التالي**.
    ...
    > [!div class="mx-imgBorder"]
    > :::image type="content" source="images/ios-deploy-2.png" alt-text="علامة التبويب &quot;إضافة مجموعة&quot; في إدارة نقاط النهاية من Microsoft الإدارة" lightbox="images/ios-deploy-2.png":::
...
يحتوي Microsoft Defender لنقطة النهاية على تطبيق iOS على قدرة متخصصة على أجهزة iOS/iPadOS التي تم تحسينها، نظرا لإمكانيات الإدارة المتزايدة التي يوفرها النظام الأساسي على هذه الأنواع من الأجهزة. كما يمكن أن يوفر حماية **ويب بدون إعداد VPN محلي على الجهاز**. يمنح ذلك المستخدمين تجربة سلسة مع الحماية من التصيد الاحتيالي وهجمة أخرى مستندة إلى الويب.
...
1. في الصفحة *إنشاء نهج تكوين التطبيق* ، قم بتوفير المعلومات التالية:
    ...
    - التطبيق المستهدف: **Microsoft Defender لنقطة النهاية** من القائمة
...
## <a name="zero-touch-onboarding-of-microsoft-defender-for-endpoint-preview"></a>المعاينة بدون لمس Microsoft Defender لنقطة النهاية (معاينة)
...
بمجرد إنجاز التكوين أعلاه ومزامنته مع الجهاز، يتم اتخاذ الإجراءات التالية على جهاز (أجهزة) iOS المستهدفة:
    - Microsoft Defender لنقطة النهاية سيتم نشره وإلوحاء بصمت وسيرى الجهاز في مدخل Defender for Endpoint.
...
1. بمجرد تثبيت Defender for Endpoint على نظام التشغيل iOS على الجهاز، سترى أيقونة التطبيق.
    ...
    :::image type="content" source="images/41627a709700c324849bf7e13510c516.png" alt-text="يتم إنشاء وصف الهاتف الذكي تلقائيا" lightbox="images/41627a709700c324849bf7e13510c516.png":::
...
## <a name="configure-microsoft-defender-for-endpoint-for-supervised-mode"></a>تكوين Microsoft Defender لنقطة النهاية "الوضع غير المهيأ"

يحتوي Microsoft Defender لنقطة النهاية على تطبيق iOS على قدرة متخصصة على أجهزة iOS/iPadOS التي تم تحسينها، نظرا لإمكانيات الإدارة المتزايدة التي يوفرها النظام الأساسي على هذه الأنواع من الأجهزة. للاستفادة من هذه الإمكانات، يحتاج تطبيق Defender for Endpoint إلى معرفة ما إذا كان الجهاز في "الوضع غير الآمن".

### <a name="configure-supervised-mode-via-intune"></a>تكوين "الوضع غير المهيئ" عبر Intune

يسمح لك Intune بتكوين تطبيق Defender ل iOS من خلال نهج تكوين التطبيق.

   > [!NOTE]
   > ينطبق نهج تكوين التطبيق هذا للأجهزة المدارة فقط على الأجهزة المدارة ويجب أن يكون مستهدفا لجميع أجهزة iOS المدارة كأفضل ممارسة.

1. سجل الدخول إلى إدارة نقاط النهاية من Microsoft [إدارة التطبيقات](https://go.microsoft.com/fwlink/?linkid=2109431) واذهب إلى **إضافة** \> سياسات **تكوين** \> تطبيقات **التطبيقات**. انقر فوق **الأجهزة المدارة**.

    > [!div class="mx-imgBorder"]
    > :::image type="content" source="images/ios-deploy-4.png" alt-text="الخيار &quot;الأجهزة المدارة&quot;" lightbox="images/ios-deploy-4.png":::
...
1. في الصفحة *إنشاء نهج تكوين التطبيق* ، قم بتوفير المعلومات التالية:
    ...
    > [!div class="mx-imgBorder"]
    > :::image type="content" source="images/ios-deploy-5.png" alt-text="الحقول الأساسية لن نهج تكوين التطبيق" lightbox="images/ios-deploy-5.png":::
