---
title: الحصول على نشاط إصلاحي واحد بواسطة الم ID
description: إرجاع معلومات لنشاط الإصلاح المحدد.
...
ms.locfileid: "63574279"
---
# <a name="get-one-remediation-activity-by-id"></a>الحصول على نشاط إصلاحي واحد بواسطة الم ID
...
إرجاع معلومات لنشاط الإصلاح المحدد. يقدم الأعمدة نفسها التي يعرضها [الحصول](get-remediation-all-activities.md) على كل نشاط المعالجة"، ولكن يرجع النتائج لنشاط الإصلاح _المحدد فقط_.

[تعرف على المزيد حول أنشطة الإصلاح](tvm-remediation.md).

## <a name="list-a-specified-remediation-activity-for-id"></a>سرد نشاط إصلاح محدد ل (الم ID)
...
العنوان|سلسلة|عنوان نشاط الإصلاح هذا|Microsoft Silverlight
