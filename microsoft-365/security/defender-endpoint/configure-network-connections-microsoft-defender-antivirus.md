...
|خدمة Microsoft Update (MU) Windows Update (WU) <p>ستسمح هذه الخدمات بتحديثات معلومات الأمان و المنتج.|`*.update.microsoft.com` <p> `*.delivery.mp.microsoft.com`<p> `*.windowsupdate.com` <p> لمزيد من المعلومات، راجع [نقاط نهاية الاتصال Windows Update](/windows/privacy/manage-windows-1709-endpoints#windows-update)|
...
:::image type="content" source="../../media/wdav-bafs-edge.png" alt-text="الإعلام بأنه تم العثور على البرامج الضارة في Edge" lightbox="../../media/wdav-bafs-edge.png":::

تحدث رسالة مماثلة إذا كنت تستخدم Internet Explorer:

:::image type="content" source="../../media/wdav-bafs-ie.png" alt-text="إعلام Microsoft Defender AV بأنه تم العثور على البرامج الضارة" lightbox="../../media/wdav-bafs-ie.png":::
...
- [تكوين إعدادات اتصال الإنترنت ووكيل الجهاز Microsoft Defender لنقطة النهاية](configure-proxy-internet.md)
