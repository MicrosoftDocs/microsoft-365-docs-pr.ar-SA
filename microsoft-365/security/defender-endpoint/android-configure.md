...
6. لتمكين الخصوصية، أدخل قيمة عدد صحيح ك 1 وقم بتعيين هذا النهج للمستخدمين. بشكل افتراضي، يتم تعيين هذه القيمة إلى 0 ل MDE في ملف تعريف العمل و1 ل MDE على ملف التعريف الشخصي.
