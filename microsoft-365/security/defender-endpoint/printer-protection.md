---
title: Microsoft Defender لنقطة النهاية حماية الطابعة للتحكم في الجهاز
description: Microsoft Defender لنقطة النهاية حماية الطابعة للتحكم في الجهاز الأشخاص من الطباعة عبر طابعات غير خاصة بالشركة أو طابعة USB غير معتمدة.
...
Microsoft Defender لنقطة النهاية حماية الطابعة للتحكم في الجهاز الأشخاص من الطباعة عبر طابعات غير خاصة بالشركة أو طابعة USB غير معتمدة.
...
1. تم تثبيت Windows التالية.
    - بالنسبة Windows 1809: Windows Update [KB5003217](https://support.microsoft.com/topic/may-20-2021-kb5003217-os-build-17763-1971-preview-08687c95-0740-421b-a205-54aa2c716b46)
    - بالنسبة Windows 1909: تثبيت [Windows Update KB5003212](https://support.microsoft.com/topic/may-20-2021-kb5003212-os-build-18363-1593-preview-05381524-8380-4b30-b783-e330cad3d4a1)
    - بالنسبة Windows 2004 أو أي وقت لاحق

2. إذا كنت تخطط لنشر النهج عبر نهج المجموعة، فيجب أن يكون الجهاز منضما إلى Microsoft Defender لنقطة النهاية منضما إليه؛ وإذا كنت تخطط لنشر النهج عبر إدارة نقاط النهاية من Microsoft، فيجب أن يكون الجهاز منضما باستخدام Microsoft Intune.
...
:::image type="content" source="../../media/customeditrow.png" alt-text="الصفحة المخصصة" lightbox="../../media/customeditrow.png":::
...
:::image type="content" source="../../media/editrow.png" alt-text="جزء تحرير الصف" lightbox="../../media/editrow.png":::
...
### <a name="scenario-1-block-people-from-printing-via-any-non-corporate-printer-using-group-policy"></a>السيناريو 1: منع الأشخاص من الطباعة عبر أي طابعة غير الشركة باستخدام نهج المجموعة
...
- تطبيق النهج على المستخدم:
  ...
  قوالب تكوين \> المستخدم الإدارية لوحة التحكم \> \> الطابعات: تمكين التحكم في الجهاز قيود الطباعة

:::image type="content" source="../../media/enable-device-ctrl-printing-restrictions.png" alt-text="الجزء &quot;تمكين قيود الطباعة للتحكم في الجهاز&quot;" lightbox="../../media/enable-device-ctrl-printing-restrictions.png":::

### <a name="scenario-2-allow-specific-approved-usb-printers-using-group-policy"></a>السيناريو 2: السماح بطابعات USB معينة معتمدة باستخدام نهج المجموعة
...
- تطبيق النهج على المستخدم:
  ...
  قوالب تكوين \> المستخدم الإدارية لوحة التحكم \> \> الطابعات: قائمة أجهزة الطباعة المعتمدة المتصلة ب USB

:::image type="content" source="../../media/list-of-approved-connected-print-devices.png" alt-text="قائمة أجهزة الطباعة المعتمدة المتصلة ب USB" lightbox="../../media/list-of-approved-connected-print-devices.png":::

## <a name="view-device-control-printer-protection-data-in-microsoft-defender-for-endpoint-portal"></a>عرض بيانات حماية الطابعة للتحكم في الجهاز في Microsoft Defender لنقطة النهاية المدخل
...
```
 ...
 :::image type="content" source="../../media/device-control-advanced-hunting.png" alt-text="الصيد المتقدم" lightbox="../../media/device-control-advanced-hunting.png":::
...
```
 ...
 :::image type="content" source="https://user-images.githubusercontent.com/81826151/128954383-71df3009-77ef-40db-b575-79c73fda332b.png" alt-text="صفحة &quot;الصيد المتقدم&quot;" lightbox="https://user-images.githubusercontent.com/81826151/128954383-71df3009-77ef-40db-b575-79c73fda332b.png":::
