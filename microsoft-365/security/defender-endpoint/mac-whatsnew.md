...
- [أصبح عنصر تحكم الجهاز لنظام التشغيل macOS](mac-device-control-overview.md) متوفرا بشكل عام الآن
...
- تمت إزالة الحالات عندما كان Microsoft Defender لنقطة النهاية يقوم بتشغيل خطأ macOS 11 (Big Sur) الذي يظهر في إنذار kernel
...
- إضافة القدرة على تشغيل عمليات فحص مكافحة الفيروسات من القائمة السياقية لنظام التشغيل macOS. يمكنك الآن النقر بزر الماوس الأيمن فوق ملف أو مجلد في "الباحث" وتحديد **"فحص" باستخدام Microsoft Defender لنقطة النهاية**
