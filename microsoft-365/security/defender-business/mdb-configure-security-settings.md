...
| مركز إدارة إدارة نقاط النهاية من Microsoft ([https://endpoint.microsoft.com](https://endpoint.microsoft.com)) | 1. انتقل إلى [https://endpoint.microsoft.com](https://endpoint.microsoft.com) وسجل الدخول. أنت الآن في مركز إدارة إدارة نقاط النهاية.<br/><br/>2. حدد **أمان نقطة النهاية**.<br/><br/>3. حدد **جدار الحماية** لعرض النهج الخاصة بك في تلك الفئة. يتم سرد القواعد المخصصة التي تم تعريفها لحماية جدار الحماية كنهج منفصلة.<br/><br/>للحصول على المساعدة في إدارة إعدادات الأمان في Intune، ابدأ [بإدارة أمان نقطة النهاية في Microsoft Intune](/mem/intune/protect/endpoint-security). |
...
3. حدد فئات لحظرها. استخدم أيقونة التوسيع لتوسيع كل فئة أصل بالكامل وتحديد فئات محتوى ويب معينة. لإعداد نهج للتدقيق فقط لا يمنع أي مواقع ويب، لا تحدد أي فئات.
...
| اعداد | الوصف |
|:---|:---|
| **التحقيق التلقائي** <br/>(قيد التشغيل بشكل افتراضي) | مع إنشاء التنبيهات، يمكن أن تحدث تحقيقات تلقائية. يحدد كل تحقيق تلقائي ما إذا كان التهديد المكتشف يتطلب إجراء، ثم يتخذ (أو يوصي) إجراءات المعالجة (مثل إرسال ملف إلى العزل، أو إيقاف عملية، أو عزل جهاز، أو حظر عنوان URL). في أثناء تشغيل التحقيق، تتم إضافة أي تنبيهات أخرى ذات صلة تنشأ إلى التحقيق حتى يكتمل. إذا تمت رؤية كيان متأثر في مكان آخر، يوسع التحقيق التلقائي نطاقه ليشمل هذا الكيان، وتكرر عملية التحقيق.<br/><br/>يمكنك عرض التحقيقات على صفحة **الحوادث** . حدد حدثا، ثم حدد علامة التبويب **"التحقيقات** ".<br/><br/>بشكل افتراضي، يتم تشغيل قدرات التحقيق والاستجابة التلقائية، على نطاق المستأجر. **نوصي بالإبقاء على التحقيق التلقائي قيد التشغيل**. إذا أوقفت تشغيلها، فستتأثر الحماية في الوقت الحقيقي في برنامج الحماية من الفيروسات من Microsoft Defender، وسيتم تقليل مستوى الحماية العام. <br/><br/>[تعرف على المزيد حول التحقيقات التلقائية](../defender-endpoint/automated-investigations.md).   |
| **الاستجابة المباشرة**  | يتضمن Defender for Business الأنواع التالية من إجراءات الاستجابة اليدوية: <br/>- تشغيل فحص مكافحة الفيروسات<br/>- عزل الجهاز<br/>- إيقاف ملف وعزله<br/>- إضافة مؤشر لحظر ملف أو السماح به <br/><br/>[تعرف على المزيد حول إجراءات الاستجابة](../defender-endpoint/respond-machine-alerts.md). |
