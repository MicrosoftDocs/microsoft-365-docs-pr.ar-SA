...
|3|[تكوين Microsoft Defender لـ Office 365](#3-configure-microsoft-defender-for-office-365)|||![مضمن.](../media/d238e041-6854-4a78-9141-049224df0795.png)|
...
|11|[بدء العمل مع Microsoft Defender for Cloud Apps](#11-get-started-with-microsoft-defender-for-cloud-apps)|||![مضمن.](../media/d238e041-6854-4a78-9141-049224df0795.png)|
...
Microsoft Defender لـ Office 365، مضمنة مع Microsoft 365 E5 البريد Office 365 E5، مؤسستك من التهديدات الضارة التي تشكلها رسائل البريد الإلكتروني والربط (عناوين URL) وأدوات التعاون. قد يستغرق هذا الأمر عدة ساعات للتكوين.
...
للحصول على نظرة عامة، بما في ذلك ملخص الخطط[، راجع Defender لـ Office 365](./office-365-security/defender-for-office-365.md).
...
ستحتاج إلى العمل مع مسؤول Exchange Online ومسؤول SharePoint عبر الإنترنت لتكوين Defender لـ Office 365 أحمال العمل هذه:

- [Microsoft Defender لنقطة النهاية SharePoint OneDrive و Microsoft Teams](office-365-security/mdo-for-spo-odb-and-teams.md)

## <a name="4-configure-microsoft-defender-for-identity"></a>4: تكوين Microsoft Defender for Identity

[Microsoft Defender for Identity](/azure-advanced-threat-protection/what-is-atp) هو حل أمان مستند إلى السحابة ويرفع مستوى إشارات Active Directory محلي للتعرف على التهديدات المتقدمة والهويات المخلة والإجراءات الضارة الموجهة إلى مؤسستك والكشف عنها والتحقق منها. التركيز على هذا التالي لأنه يحمي البنية الأساسية المحلية والسحابية، وليس لديه تبعيات أو متطلبات أساسية، ويمكن أن يوفر فائدة فورية.

- راجع [Microsoft Defender for Identity Quickstarts](/azure-advanced-threat-protection/install-atp-step1) للحصول على الإعداد بسرعة
- شاهد [الفيديو: مقدمة حول Microsoft Defender for Identity](https://www.youtube.com/watch?reload=9&v=EGY2m8yU_KE)
- مراجعة المراحل [الثلاث من Microsoft Defender for Identity النشر](/azure-advanced-threat-protection/what-is-atp#whats-next)

## <a name="5-turn-on-microsoft-365-defender"></a>5: تشغيل Microsoft 365 Defender

الآن بعد أن Microsoft Defender لـ Office 365 Microsoft Defender for Identity، يمكنك عرض الإشارات المدمجة من هذه الإمكانات في لوحة معلومات واحدة. [Microsoft 365 Defender](./defender/microsoft-365-defender.md) بين التنبيهات، والحوادث، والتحري التلقائي والاستجابة، والصيد المتقدم عبر أحمال العمل (Microsoft Defender for Identity، Defender لـ Office 365، Microsoft Defender ل Endpoint، و Microsoft Defender for Cloud Apps) في جزء واحد في Microsoft 365 Defender <a href="https://go.microsoft.com/fwlink/p/?linkid=2077139" target="_blank">المدخل</a>.

:::image type="content" source="../media/top-ten-security-remote-work-mtp-dashboard.png" alt-text="لوحة Microsoft 365 Defender الرئيسية" lightbox="../media/top-ten-security-remote-work-mtp-dashboard.png":::

بعد تكوين واحدة أو أكثر من خدمات Defender لـ Office 365، قم تشغيل MTP. تضاف الميزات الجديدة باستمرار إلى MTP؛ يمكنك الاشتراك لتلقي ميزات المعاينة.
...
- [تعريف سياسات توافق الجهاز](./office-365-security/identity-access-policies.md#define-device-compliance-policies) — تتضمن الإعدادات المستحسنة Windows 10 الحماية من الفيروسات. إذا كان Microsoft 365 E5، فاستخدم Microsoft Defender لنقطة النهاية لمراقبة حالة أجهزة الموظفين. تأكد من أن سياسات التوافق الخاصة بأنظمت التشغيل الأخرى تتضمن برامج الحماية من الفيروسات ونقطة النهاية.
...
## <a name="11-get-started-with-microsoft-defender-for-cloud-apps"></a>11: بدء العمل باستخدام Microsoft Defender for Cloud Apps

[Microsoft Defender for Cloud Apps](/cloud-app-security) رؤية غنية والتحكم في تنقل البيانات وتحليلات معقدة لتحديد مكافحة الهجمات الإلكترونية عبر جميع خدمات السحابة. بمجرد بدء استخدام Defender for Cloud Apps، يتم تمكين سياسات الكشف عن الشذوذ تلقائيا، ولكن يكون ل Defender for Cloud Apps فترة تعلم أولية من سبعة أيام لا يتم خلالها رفع جميع تنبيهات الكشف عن الشذوذ.
...
تهانينا! لقد قمت بتنفيذ بعض من أهم حماية الأمان بسرعة وكانت مؤسستك أكثر أمانا. أنت الآن جاهز للمضي إلى أبعد من ذلك باستخدام قدرات الحماية من المخاطر (بما في ذلك Microsoft Defender لنقطة النهاية البيانات) وتصنيف البيانات والحماية وتأمين الحسابات الإدارية. للحصول على مجموعة أعمق ومنهجية من توصيات الأمان Microsoft 365، راجع Microsoft 365 الأمان لصانعي قرارات الأعمال [(BDMs).](Microsoft-365-security-for-bdm.md)
