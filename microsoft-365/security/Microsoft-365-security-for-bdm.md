...
![اتبع هذه الخطوات للحد من المخاطر التي تخطر على أعمالك.](../media/security/security-for-bdms-overview.png)
...
يوضح الرسم التخطيطي التالي هذه الإمكانات.
![الإمكانات الموصى بها للحماية من التهديدات المعروفة.](../media/m365-security-bdm-illustrations-known-threats.png)
...
|توصية  |E3  |E5  |
|---------|---------|---------|
|**تكوين Microsoft Defender Office 365**:<br>* خزينة المرفقات<br>* خزينة ارتباطات<br>* Microsoft Defender ل Endpoint SharePoint OneDrive و Microsoft Teams<br>* مكافحة التصيد الاحتيالي في Defender for Office 365 الحماية|         |![علامة الاختيار الخضراء.](../media/green-check-mark.png) |
|**تكوين قدرات Microsoft Defender لنقطة النهاية**:<br>* برنامج الحماية من الفيروسات لـ Windows Defender <br>* الحماية من استغلال <br> * تقليل مساحة الهجوم <br> * عزل مستند إلى الأجهزة <br>* الوصول إلى المجلدات الخاضعة للتحكم     |         |![علامة الاختيار الخضراء.](../media/green-check-mark.png) |
...
يوضح الرسم التخطيطي التالي هذه الإمكانات.
![الإمكانات الموصى بها للحماية من التهديدات غير المعروفة.](../media/m365-security-bdm-illustrations-unknown-threats.png)
