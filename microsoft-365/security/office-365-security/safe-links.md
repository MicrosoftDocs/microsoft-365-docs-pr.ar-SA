...
|قيمة|نتيجة|
|---|---|
|`contoso.com` <p> أو <p> `*contoso.com*`|يحظر المجال والمجالات الفرعية والمسارات. على سبيل المثال، `https://www.contoso.com`، `https://sub.contoso.com`، ويتم `https://contoso.com/abc` حظرها.|
