...
- **تشغيل: تتحقق "الارتباطات الآمنة" من قائمة الارتباطات الضارة المعروفة عندما ينقر المستخدمون فوق الارتباطات في البريد الإلكتروني**: قم بتشغيل مسح الارتباطات الآمنة أو إيقاف تشغيله في رسائل البريد الإلكتروني. يتم تحديد القيمة الموصى بها (تشغيل)، وتؤدي إلى الإجراءات التالية:
  ...
  - **لا تقم بإعادة كتابة عناوين URL، قم بالتحقق عبر واجهة برمجة تطبيقات SafeLinks فقط**: إذا تم تحديد هذا الإعداد (تشغيل)، فلن يتم تضمين عنوان URL. يتم استدعاء الارتباطات الآمنة حصريا عبر واجهات برمجة التطبيقات في وقت النقر فوق URL بواسطة عملاء Outlook الذين يدعمونها. يتم تحديد قيمة التوصية (تشغيل).
