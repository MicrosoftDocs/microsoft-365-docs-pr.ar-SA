...
## <a name="report-questionable-email-to-microsoft"></a>إرسال تقرير بالبريد الإلكتروني مشكوك فيه إلى Microsoft
...
2. في الصفحة **"عمليات الإرسال"** ، تحقق من تحديد علامة التبويب **"رسائل البريد الإلكتروني** " استنادا إلى نوع المحتوى الذي تريد الإبلاغ به، ثم انقر فوق " ![إرسال إلى Microsoft" للتحليل.](../../media/m365-cc-sc-create-icon.png) **إرسال إلى Microsoft للتحليل**.

3. في " **إضافة معرف رسالة الشبكة" أو تحميل قسم ملف البريد الإلكتروني** ، استخدم أحد الخيارات التالية:
...
4. في **مربع اختيار مستلم لديه مشكلة** ، حدد المستلم الذي تريد تشغيل فحص النهج مقابله. سيحدد فحص النهج ما إذا كان البريد الإلكتروني قد تجاوز الفحص بسبب نهج المستخدم أو المؤسسة.

5. في القسم **"تحديد سبب الإرسال إلى Microsoft** "، حدد أحد الخيارات التالية:
...
## <a name="report-questionable-urls-to-microsoft"></a>الإبلاغ عن عناوين URL مشكوك فيها إلى Microsoft

1. في مدخل Microsoft 365 Defender، <https://security.microsoft.com>انتقل إلى صفحة **عمليات الإرسال** في **Actions & عمليات الإرسال**\>. للانتقال مباشرة إلى صفحة **عمليات الإرسال** ، استخدم <https://security.microsoft.com/reportsubmission>.

2. في الصفحة **"عمليات الإرسال"** ، تحقق من تحديد علامة تبويب **عناوين URL** استنادا إلى نوع المحتوى الذي تريد الإبلاغ به، ثم انقر فوق " ![إرسال إلى Microsoft" للتحليل.](../../media/m365-cc-sc-create-icon.png) **إرسال إلى Microsoft للتحليل**.

3. في مربع **URL** الذي يظهر، أدخل عنوان URL الكامل (على سبيل المثال، `https://www.fabrikam.com/marketing.html`).
...
5. عند الانتهاء، انقر فوق **"إرسال**".
 ...
 > [!NOTE]
 > لا تتوفر عمليات إرسال URL في السحب التي لا تسمح للبيانات بترك البيئة. ستكون القدرة على تحديد عنوان URL رمادية اللون.

## <a name="report-questionable-email-attachment-to-microsoft"></a>الإبلاغ عن مرفق بريد إلكتروني مشكوك فيه إلى Microsoft

1. في مدخل Microsoft 365 Defender، <https://security.microsoft.com>انتقل إلى صفحة **عمليات الإرسال** في **Actions & عمليات الإرسال**\>. للانتقال مباشرة إلى صفحة **عمليات الإرسال** ، استخدم <https://security.microsoft.com/reportsubmission>.

2. في الصفحة **"عمليات الإرسال"** ، تحقق من تحديد علامة التبويب **"مرفقات البريد الإلكتروني** " استنادا إلى نوع المحتوى الذي تريد الإبلاغ به، ثم انقر فوق " ![إرسال إلى Microsoft" للتحليل.](../../media/m365-cc-sc-create-icon.png) **إرسال إلى Microsoft للتحليل**.

3. في المقطع **"ملف"** الذي يظهر، انقر فوق **"استعراض الملفات**". في مربع الحوار الذي يتم فتحه، ابحث عن الملف وحدده، ثم انقر فوق **"فتح**".
...
2. في الصفحة **"عمليات الإرسال"** ، تحقق من تحديد علامة التبويب **"رسائل البريد الإلكتروني** ".
   ...
   - يمكنك فرز الإدخالات بالنقر فوق رأس عمود متوفر. انقر فوق **"تخصيص الأعمدة** " لتحديد الأعمدة التي تحتاجها. يمكن تحديد كافة الأعمدة وإظهارها في شبكة الإرسال. يتم وضع علامة نجمية على القيم الافتراضية (*):
     - **اسم الإرسال**<sup>\*</sup>
     - **المرسل**<sup>\*</sup>
     - **المستلم**
...
2. في الصفحة **"عمليات الإرسال"** ، حدد علامة تبويب **الرسائل التي أبلغ عنها المستخدم** .
   ...
   - لتصدير الإدخالات، انقر فوق **"تصدير**". في مربع الحوار الذي يظهر، احفظ ملف .csv.
   - لإعلام المستخدمين مسؤول [مراجعة الرسائل التي تم الإبلاغ عنها](admin-review-reported-message.md)
...
لعرض التنبيه المقابل لإرسالات البريد الإلكتروني للمسؤول، حدد علامة التبويب **"رسائل البريد الإلكتروني** "، ثم انقر نقرا مزدوجا فوق الرسالة لفتح القائمة المنبثقة للإرسال. حدد **تنبيه "عرض** " على الخيار **"فتح كيان البريد الإلكتروني** ".
