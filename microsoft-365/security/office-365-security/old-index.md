---
title: Office 365 عامة حول الأمان، Microsoft Defender Office 365 و EOP و MSDO
ms.author: tracyp
author: msfttracyp
manager: dansimp
ms.date: 08/13/2020
...
![يوفر كل من EOP و Microsoft Defender Office 365 والأمان، من الحماية والكشف للتحقق والاستجابة. يجب إعداد تكوين مصادقة البريد الإلكتروني (على الأقل DKIM و DMARC) ل EOP وللقيم.](../../media/tp_EOPATPP1P2Take6.gif#lightbox)
...
في Microsoft Defender Office 365 P2، تسمى أداة الصيد **الأساسية "** مستكشف التهديدات" بدلا من الكشف في الوقت الحقيقي. إذا رأيت "مستكشف التهديدات" عند الانتقال إلى Defender for Cloud، تكون في Microsoft Defender Office 365 P2.
...
استخدام ["محاكي الهجوم" في Microsoft Defender Office 365](attack-simulator.md)
