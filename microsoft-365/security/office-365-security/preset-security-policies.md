...
3. يبدأ معالج **تطبيق الحماية القياسية** أو **تطبيق الحماية الصارمة** في قائمة منبثقة. في **حماية EOP التي تنطبق على** الصفحة، حدد المستلمين الداخليين الذين تنطبق [حماية EOP](#policies-in-preset-security-policies) على (شروط المستلمين):
   - **المستخدمون**
   - **المجموعات**
   - **المجالات**
...
4. في المؤسسات Microsoft Defender لـ Office 365، يتم نقلك إلى **حماية Defender لـ Office 365 تنطبق على** الصفحة لتحديد المستلمين الداخليين الذين تنطبق حماية [Microsoft Defender لـ Office 365](#policies-in-preset-security-policies) على (المستلمين) الشروط).
