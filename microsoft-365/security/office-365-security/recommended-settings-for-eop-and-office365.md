...
|**وضع الاختبار** (_TestModeAction_)|**بلا**|**بلا**|**بلا**|هذا الإعداد هو جزء من ASF. لمزيد من المعلومات، راجع [إعدادات ASF في قسم نهج مكافحة البريد العشوائي](#asf-settings-in-anti-spam-policies) في هذه المقالة.|
...
|**إضافة المرسلين والمجالات الموثوق بها** <br/><br/> _الendenders المستثناة_ <br/><br/> _ExcludedDomains_|بلا|بلا|بلا|استنادا إلى مؤسستك، نوصي بإضافة المرسلين أو المجالات التي تم تعريفها بشكل غير صحيح على أنها محاولات انتحال.|
