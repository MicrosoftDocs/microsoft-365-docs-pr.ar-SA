...
|---|:---:|:---:|:---:|---|
|**ارتباطات الصور إلى المواقع البعيدة** <br><br> _IncreaseScoreWithImageLinks_|قباله|قباله|قباله||
|**عنوان IP رقمي في URL** <br><br> _IncreaseScoreWithNumericIps_|قباله|قباله|قباله||
|**إعادة توجيه URL إلى منفذ آخر** <br><br> _IncreaseScoreWithRedirectToOtherPort_|قباله|قباله|قباله||
|**ارتباطات إلى مواقع ويب .biz أو .info** <br><br> _IncreaseScoreWithBizOrInfoUrls_|قباله|قباله|قباله||
|**رسائل فارغة** <br><br> _MarkAsSpamEmptyMessages_|قباله|قباله|قباله||
|**تضمين العلامات في HTML** <br><br> _MarkAsSpamEmbedTagsInHtml_|قباله|قباله|قباله||
|**JavaScript أو VBScript في HTML** <br><br> _MarkAsSpamJavaScriptInHtml_|قباله|قباله|قباله||
|**علامات النموذج في HTML** <br><br> _MarkAsSpamFormTagsInHtml_|قباله|قباله|قباله||
|**وضع إطار أو علامات iframe في HTML** <br><br> _MarkAsSpamFramesInHtml_|قباله|قباله|قباله||
|**أخطاء ويب في HTML** <br><br> _MarkAsSpamWebBugsInHtml_|قباله|قباله|قباله||
|**علامات الكائن في HTML** <br><br> _MarkAsSpamObjectTagsInHtml_|قباله|قباله|قباله||
|**الكلمات الحساسة** <br><br> _MarkAsSpamSensitiveWordList_|قباله|قباله|قباله||
|**سجل SPF: فشل ثابت** <br><br> _MarkAsSpamSpfRecordHardFail_|قباله|قباله|قباله||
|**فشل ثابت في تصفية معرف المرسل** <br><br> _MarkAsSpamFromAddressAuthFail_|قباله|قباله|قباله||
|**البريد الاحتياطي** <br><br> _MarkAsSpamNdrBackscatter_|قباله|قباله|قباله||
|**وضع الاختبار** <br><br> _TestModeAction_)|None|None|None|بالنسبة لإعدادات ASF التي تدعم **الاختبار** كإجراء، يمكنك تكوين إجراء وضع الاختبار إلى **بلا**، **أو إضافة نص X-Header افتراضي**، أو **إرسال رسالة مخفية** (`None`، أو، `AddXHeader`أو `BccMessage`). لمزيد من المعلومات، راجع [تمكين إعدادات ASF أو تعطيلها أو اختبارها](advanced-spam-filtering-asf-options.md#enable-disable-or-test-asf-settings).|
...
|**إظهار تلميح أمان جهة الاتصال الأول** <br><br> _EnableFirstContactSafetyTips_|غير محدد <br><br> `$false`|غير محدد <br><br> `$false`|غير محدد <br><br> `$false`|لمزيد من المعلومات، راجع [تلميح أمان الاتصال الأول](set-up-anti-phishing-policies.md#first-contact-safety-tip).|
...
|**إذا تم الكشف عن الرسالة كمستخدم منتحل** <br><br> _TargetedUserProtectionAction_|**عدم تطبيق أي إجراء** <br><br> `NoAction`|**عزل الرسالة** <br><br> `Quarantine`|**عزل الرسالة** <br><br> `Quarantine`||
|**إذا تم الكشف عن الرسالة كمجال منتحل** <br><br> _TargetedDomainProtectionAction_|**عدم تطبيق أي إجراء** <br><br> `NoAction`|**عزل الرسالة** <br><br> `Quarantine`|**عزل الرسالة** <br><br> `Quarantine`||
...
|**إظهار تلميح أمان انتحال المستخدم** <br><br> _EnableSimilarUsersSafetyTips_|قباله <br><br> `$false`|المحدد <br><br> `$true`|المحدد <br><br> `$true`||
|**إظهار تلميح أمان انتحال المجال** <br><br> _EnableSimilarDomainsSafetyTips_|قباله <br><br> `$false`|المحدد <br><br> `$true`|المحدد <br><br> `$true`||
|**إظهار تلميح أمان انتحال المستخدم للأحرف غير العادية** <br><br> _EnableUnusualCharactersSafetyTips_|قباله <br><br> `$false`|المحدد <br><br> `$true`|المحدد <br><br> `$true`||
...
|---|:---:|:---:|:---:|:---:|---|
|**استجابة البرامج الضارة غير المعروفة لمرفقات آمنة** <br><br> _التمكين_ _والإجراء_|**قباله** <br><br> `-Enable $false` و `-Action Block`|**حظر** <br><br> `-Enable $true` و `-Action Block`|**حظر** <br><br> `-Enable $true` و `-Action Block`|**حظر** <br><br> `-Enable $true` و `-Action Block`|عندما تكون المعلمة _Enable_ $false، لا يهم قيمة معلمة _الإجراء_ .|
|**نهج العزل** (_QuarantineTag_)|AdminOnlyAccessPolicy|AdminOnlyAccessPolicy|AdminOnlyAccessPolicy|AdminOnlyAccessPolicy| <br><br> تستخدم نهج الأمان القياسية والضيقة المحددة مسبقا نهج العزل الافتراضي (AdminOnlyAccessPolicy مع عدم وجود إعلامات عزل) كما هو موضح في الجدول [هنا](quarantine-policies.md#step-2-assign-a-quarantine-policy-to-supported-features). <br><br> عند إنشاء نهج مرفقات آمنة جديد، تعني القيمة الفارغة أن نهج العزل الافتراضي يستخدم لتعريف القدرات التاريخية للرسائل التي تم عزلها بواسطة "المرفقات الآمنة" (AdminOnlyAccessPolicy بدون إعلامات العزل). <br><br> يمكن للمسؤولين إنشاء وتحديد نهج العزل المخصصة التي تحدد المزيد من القدرات للمستخدمين. لمزيد من المعلومات، راجع [نهج العزل](quarantine-policies.md).|
|**إعادة توجيه المرفق مع المرفقات المكتشفة** : **تمكين إعادة التوجيه** <br><br> _اعاده توجيه_ <br><br> _عنوان إعادة التوجيه_|غير محدد ولم يتم تحديد عنوان بريد إلكتروني. <br><br> `-Redirect $false` <br><br> _RedirectAddress_ فارغ (`$null`)|غير محدد ولم يتم تحديد عنوان بريد إلكتروني. <br><br> `-Redirect $false` <br><br> _RedirectAddress_ فارغ (`$null`)|تحديد عنوان بريد إلكتروني وتحديده. <br><br> `$true` <br><br> عنوان بريد إلكتروني|تحديد عنوان بريد إلكتروني وتحديده. <br><br> `$true` <br><br> عنوان بريد إلكتروني|إعادة توجيه الرسائل إلى مسؤول أمان للمراجعة. <br><br> **ملاحظة**: لم يتم تكوين هذا الإعداد في نهج الأمان **القياسية** أو **الصارمة** أو **المضمنة المعينة** مسبقا. تشير القيم **القياسية** **والضيقة** إلى قيمنا **الموصى بها** في نهج المرفقات الآمنة الجديدة التي تقوم بإنشائها.|
|**تطبيق استجابة الكشف عن المرفقات الآمنة إذا تعذر اكتمال الفحص (مهلة أو أخطاء)** <br><br> _ActionOnError_|المحدد <br><br> `$true`|المحدد <br><br> `$true`|المحدد <br><br> `$true`|المحدد <br><br> `$true`||
...
|**تشغيل: تتحقق "الارتباطات الآمنة" من قائمة الارتباطات الضارة المعروفة عندما ينقر المستخدمون فوق الارتباطات في البريد الإلكتروني** <br><br> _EnableSafeLinksForEmail_|غير محدد <br><br> `$false`|المحدد <br><br> `$true`|المحدد <br><br> `$true`|المحدد <br><br> `$true`||
|**تطبيق الارتباطات الآمنة على رسائل البريد الإلكتروني المرسلة داخل المؤسسة** <br><br> _EnableForInternalSenders_|غير محدد <br><br> `$false`|المحدد <br><br> `$true`|المحدد <br><br> `$true`|المحدد <br><br> `$true`||
...
|**تشغيل: تتحقق "الارتباطات الآمنة" من قائمة الارتباطات الضارة المعروفة عندما ينقر المستخدمون فوق الارتباطات في تطبيقات Microsoft Office** <br><br> _EnableSafeLinksForO365Clients_|غير محدد <br><br> `$false`|المحدد <br><br> `$true`|المحدد <br><br> `$true`|المحدد <br><br> `$true`|استخدم "الارتباطات الآمنة" في تطبيقات Office 365 المدعومة لسطح المكتب والجوال (iOS وAndroid). لمزيد من المعلومات، راجع [إعدادات الارتباطات الآمنة لتطبيقات Office](safe-links.md#safe-links-settings-for-office-apps).|
...
|**الاعلام**||||||
|**كيف تريد إعلام المستخدمين؟** <br><br> _نص التعليق المخصص_ <br><br> _UseTranslatedNotificationText_|**استخدام نص الإعلام الافتراضي** <br><br> فارغ (`$null`) <br><br> `$false`|**استخدام نص الإعلام الافتراضي** <br><br> فارغ (`$null`) <br><br> `$false`|**استخدام نص الإعلام الافتراضي** <br><br> فارغ (`$null`) <br><br> `$false`|**استخدام نص الإعلام الافتراضي** <br><br> فارغ (`$null`) <br><br> `$false`|ليس لدينا توصية محددة لهذا الإعداد. <br><br> يمكنك تحديد **استخدام نص الإعلام المخصص** (`-CustomNotificationText "<Custom text>"`) لإدخال نص إعلام مخصص واستخدامه. إذا قمت بتحديد نص مخصص، يمكنك أيضا تحديد **"استخدام Microsoft Translator" للترجمة التلقائية** (`-UseTranslatedNotificationText $true`) لترجمة النص تلقائيا إلى لغة المستخدم.|
