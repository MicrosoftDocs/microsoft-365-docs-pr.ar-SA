---
title: حمولات للتدريب على محاكاة الهجوم
ms.author: chrisda
author: chrisda
manager: dansimp
audience: ITPro
...
ms.locfileid: "65840180"
---
# <a name="payloads-for-attack-simulation-training-in-defender-for-office-365"></a>حمولات لتدريب محاكاة الهجوم في Defender لـ Office 365
...
- **المعدل المخترق (٪)**: بالنسبة إلى الحمولات المضمنة، هذه القيمة هي متوسط معدل الاختراق المتوقع لمحاكاة تدريب محاكاة الهجوم التي تستخدم نفس نوع الحمولة عبر جميع المؤسسات Microsoft 365 الأخرى.
