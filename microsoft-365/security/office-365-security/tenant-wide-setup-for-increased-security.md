...
- seo-marvel-apr2020
- admindeeplinkSPO
description: يرشدك هذا الموضوع خلال التكوين الموصى به للإعدادات على مستوى المستأجر التي تؤثر على أمان بيئة Microsoft 365.
ms.technology: mdo
...
يرشدك هذا الموضوع خلال التكوين الموصى به للإعدادات على مستوى المستأجر التي تؤثر على أمان بيئة Microsoft 365. قد تتطلب احتياجات الأمان الخاصة بك أمانا أكثر أو أقل. استخدم هذه التوصيات كنقطة بداية.
...
|**المرفقات الآمنة في Defender لـ Office 365**|لا|تكوين الإعدادات العمومية للمرفقات الآمنة وإنشاء نهج "المرفقات الآمنة" كما هو موضح هنا: [تكوين إعدادات "المرفقات الآمنة" في Microsoft Defender لـ Office 365](protect-against-threats.md#safe-attachments-policies-in-microsoft-defender-for-office-365). <p> مزيد من المعلومات: <ul><li>[إعدادات المرفقات الآمنة الموصى بها](recommended-settings-for-eop-and-office365.md#safe-attachments-settings)</li><li>[المرفقات الآمنة في Microsoft Defender لـ Office 365](safe-attachments.md)</li><li>[إعداد نهج المرفقات الآمنة](set-up-safe-attachments-policies.md)</li><li>[المرفقات الآمنة لـ SharePoint وOneDrive وMicrosoft Teams](mdo-for-spo-odb-and-teams.md)</li><li>[أمان المستندات في Microsoft 365 E5](safe-docs.md)</li></ul>|
|**الارتباطات الآمنة في Microsoft Defender لـ Office 365**|لا|إنشاء نهج ارتباطات آمنة كما هو موضح هنا: [تكوين إعدادات الارتباطات الآمنة في Microsoft Defender لـ Office 365](protect-against-threats.md#safe-links-policies-in-microsoft-defender-for-office-365). <p> مزيد من المعلومات: <ul><li>[إعدادات الارتباطات الآمنة الموصى بها](recommended-settings-for-eop-and-office365.md#safe-links-settings)</li><li>[إعداد نهج الارتباطات الآمنة](set-up-safe-links-policies.md)</li><li>[الارتباطات الآمنة في Microsoft Defender لـ Office 365](safe-links.md)</li></ul>|
...
توصيات Microsoft لتكوين مواقع فريق SharePoint بمستويات حماية متزايدة، بدءا من حماية الأساس. لمزيد من المعلومات، راجع [توصيات النهج لتأمين مواقع SharePoint وملفاته](sharepoint-file-access-policies.md).
...
يتضمن مركز إدارة SharePoint ومركز إدارة OneDrive for Business الإعدادات نفسها. تنطبق الإعدادات في أي من مركزي الإدارة على كليهما.
...
راجع: [المواقع المسماة في Azure Active Directory](/azure/active-directory/conditional-access/location-condition)
...
في هذه الأثناء، استخدم أحد الأساليب التالية لإنجاز ذلك ل SharePoint Online OneDrive for Business:
...
توفر هذه المقالات والدلائل معلومات توجيهية إضافية لتأمين بيئة Microsoft 365:
