---
title: إمكانات الاستجابة & المخاطر - Microsoft Defender لـ Office 365 2
f1.keywords:
- NOCSH
ms.author: tracyp
author: msfttracyp
...
ms.custom:
- seo-marvel-apr2020
description: تعرف على قدرات الاستجابة والتحري عن المخاطر Microsoft Defender لـ Office 365 الخطة.
ms.technology: mdo
...
تساعد قدرات الاستجابة والتحري [](defender-for-office-365.md) Microsoft Defender لـ Office 365 في حماية محللي الأمان والمسؤولين في مؤسساتهم Microsoft 365 لمستخدمي الأعمال من خلال:
...
:::image type="content" source="../../media/7a7cecee-17f0-4134-bcb8-7cee3f3c3890.png" alt-text="صفحة &quot;مستكشف التهديدات&quot;" lightbox="../../media/7a7cecee-17f0-4134-bcb8-7cee3f3c3890.png":::
...
:::image type="content" source="../../media/acadd4c7-d2de-4146-aeb8-90cfad805a9c.png" alt-text="قائمة أحداث التهديدات الحالية في Office 365" lightbox="../../media/acadd4c7-d2de-4146-aeb8-90cfad805a9c.png":::
...
:::image type="content" source="../../media/e0f46454-fa38-40f0-a120-b595614d1d22.png" alt-text="صفحة المراجعة في مركز & الأمان" lightbox="../../media/e0f46454-fa38-40f0-a120-b595614d1d22.png":::
...
كجزء من Microsoft Defender لـ Office 365 الخطة 2، يمكن لمحللو الأمان مراجعة التفاصيل حول خطر معروف. هذا مفيد لتحديد ما إذا كان هناك المزيد من الإجراءات/الخطوات الوقائية التي يمكن اتخاذها للحفاظ على أمان المستخدمين.
...
Microsoft 365 قدرات الاستجابة والتحري عن المخاطر في Microsoft Defender لـ Office 365 الخطة 2، المضمنة في Enterprise E5 أو كعينة إضافية لاشتراكات معينة. لمعرفة المزيد، راجع Defender لـ Office 365 [الخطة 1 الخطة 2](defender-for-office-365.md#microsoft-defender-for-office-365-plan-1-and-plan-2).

## <a name="required-roles-and-permissions"></a>الأدوار والأذونات المطلوبة

Microsoft Defender لـ Office 365 التحكم بالوصول المستند إلى الدور. يتم تعيين الأذونات من خلال أدوار معينة في Azure Active Directory أو مركز مسؤولي Microsoft 365 أو مدخل Microsoft 365 Defender.
...
|دمج Microsoft Defender لـ Office 365 2 مع Microsoft Defender لنقطة النهاية <p> دمج Microsoft Defender لـ Office 365 2 مع خادم SIEM|إما دور **المسؤول** العام أو مسؤول  الأمان المعين في Azure Active Directory (<https://portal.azure.com>) أو مركز مسؤولي Microsoft 365 ().<https://admin.microsoft.com> <p> --- **بالإضافة إلى** --- <p> دور مناسب تم تعيينه في تطبيقات إضافية (مثل مركز حماية Microsoft Defender [](/windows/security/threat-protection/microsoft-defender-atp/user-roles) خادم SIEM).|
