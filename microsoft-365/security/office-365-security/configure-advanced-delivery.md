...
- خصيصا لمحاكاة التصيد الاحتيالي من جهة خارجية:
  ...
  - لا تحظر [الارتباطات الآمنة في Defender لـ Office 365](safe-links.md) عناوين URL المحددة في هذه الرسائل أو تحجبها في وقت النقر. لا تزال عناوين URL ملتفة، ولكن لم يتم حظرها.
  - لا تخلط [المرفقات الآمنة في Defender لـ Office 365](safe-attachments.md) المرفقات في هذه الرسائل.
...
2. في صفحة **التسليم المتقدم** ، تحقق من تحديد علامة تبويب **علبة بريد SecOps** ، ثم نفذ إحدى الخطوات التالية:
   ...
   - إذا لم تكن هناك علب بريد SecOps مكونة، فانقر فوق **"إضافة**".
...
3. في القائمة المنبثقة **"تحرير محاكاة التصيد الاحتيالي لجهة خارجية** " التي يتم فتحها، قم بتكوين الإعدادات التالية:
   ...
   > [!NOTE]
   > لتكوين محاكاة تصيد احتيالي لجهة خارجية في التسليم المتقدم، تحتاج إلى توفير المعلومات التالية:
   >
