...
الخطوات اللازمة لإعداد ميزات أمان EOP ومقارنة الأمان المضاف الذي تحصل عليه في Microsoft Defender Office 365، راجع الحماية [من التهديدات](protect-against-threats.md). تتوفر الإعدادات الموصى بها لمميزات EOP في الإعدادات المستحسنة ل [EOP و Microsoft Defender Office 365 الأمان](recommended-settings-for-eop-and-office365.md).
...
- للحصول على القيم المستحسنة لنهج الحماية، راجع الإعدادات المستحسنة ل [EOP و Microsoft Defender Office 365 الأمان](recommended-settings-for-eop-and-office365.md).
...
|سياسات الأمان التي تم الإعداد المسبق لها|[سياسات الأمان المحددة مسبقا في EOP و Microsoft Defender Office 365](preset-security-policies.md) <p> [محلل التكوين لنهج الحماية في EOP و Microsoft Defender Office 365](configuration-analyzer-for-security-policies.md)|
...
|تشفير الرسائل من Office 365 المتوفرة كعناية إضافية|لمزيد من المعلومات، راجع [التشفير في Office 365](../../compliance/encryption.md).|
|||
