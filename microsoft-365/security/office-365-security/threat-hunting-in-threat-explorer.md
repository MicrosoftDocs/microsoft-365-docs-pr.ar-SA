---
title: التهديد بالصيد في "مستكشف التهديدات" ل Microsoft Defender Office 365
f1.keywords:
- NOCSH
ms.author: dansimp
author: MSFTTracyp
...
ms.locfileid: "63574305"
---
# <a name="threat-hunting-in-threat-explorer-for-microsoft-defender-for-office-365"></a>التهديد بالصيد في "مستكشف التهديدات" ل Microsoft Defender Office 365
...
إذا كانت مؤسستك تملك [Microsoft Defender Office 365](defender-for-office-365.md)، وكان لديك الأذونات، يمكنك استخدام "المستكشف" أو الكشف في  الوقت الحقيقي  للكشف عن التهديدات و إصلاحها.[](#required-licenses-and-permissions)
...
في Microsoft Defender Office 365، هناك خطتان للاشتراك — الخطة 1 الخطة 2. توجد أدوات البحث عن المخاطر التي يتم تشغيلها يدويا في كلتا الخطتين، وأسماء مختلفة وإمكانات مختلفة.

تستخدم "Office 365"، الخطة 1، الكشف في الوقت الحقيقي، وهي مجموعة فرعية من أداة الصيد "مستكشف التهديدات *" (* تسمى أيضا *المستكشف) في* الخطة 2. في هذه السلسلة من المقالات، تم إنشاء معظم الأمثلة باستخدام "مستكشف التهديدات" الكامل. يجب على المسؤولين اختبار أي خطوات في الكشف في الوقت الحقيقي لمعرفة مكان تطبيقها.
...
> ![عرض منسدل في "مستكشف التهديدات".](../../media/view-drop-down.png)
...
> [!div class="mx-imgBorder"]
> ![الزر "مرسل" في "مستكشف التهديدات".](../../media/sender-drop-down.png)
...
> [!div class="mx-imgBorder"]
> ![تصفية متقدمة في "مستكشف التهديدات".](../../media/advanced-filter.png)
...
> [!div class="mx-imgBorder"]
> ![النتائج من استعلام.](../../media/threat-explorer-chart-table.png)

استخدم **زر خيارات العمود** للحصول على نوع المعلومات على الجدول الأكثر فائدة:

> [!div class="mx-imgBorder"]
> ![الزر "خيارات العمود" تم تمييزه.](../../media/threat-explorer-column-options.png)

> [!div class="mx-imgBorder"]
> ![الخيارات المتوفرة في الأعمدة.](../../media/column-options.png)
...
> [!div class="mx-imgBorder"]
> ![خريطة أصول البريد الإلكتروني.](../../media/threat-explorer-email-origin-map.png)

> [!div class="mx-imgBorder"]
> ![خيارات عرض الحملة.](../../media/threat-explorer-campaign-display.png)
...
> [!div class="mx-imgBorder"]
> ![صفحة كيان البريد الإلكتروني.](../../media/threat-explorer-email-entity-page.png)
...
> [!div class="mx-imgBorder"]
> ![علامة التبويب "تحليل" لصفحة كيان البريد الإلكتروني.](../../media/threat-explorer-analysis-tab.png)
...
> [!div class="mx-imgBorder"]
> ![الزر "إجراءات" في "مستكشف التهديدات".](../../media/threat-explorer-email-actions-button.png)
...
> [!div class="mx-imgBorder"]
> ![منسدل الإجراءات.](../../media/threat-explorer-email-actions-drop-down.png)
