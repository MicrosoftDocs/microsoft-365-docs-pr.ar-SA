---
title: صفحات تسجيل الدخول في التدريب على محاكاة الهجوم
ms.author: chrisda
author: chrisda
manager: dansimp
audience: ITPro
...
ms.locfileid: "66493920"
---
# <a name="login-pages-in-attack-simulation-training"></a>صفحات تسجيل الدخول في التدريب على محاكاة الهجوم
...
- **صفحات تسجيل الدخول العمومية**: تحتوي على صفحات تسجيل الدخول المضمنة وغير القابلة للتعديل. هناك أربع صفحات تسجيل دخول مضمنة مترجمة إلى 12 لغة:
...
- **علامة التبويب "معاينة** ": عرض صفحة تسجيل الدخول حيث سيتمكن المستخدمون من رؤيتها. تتوفر ارتباطات **الصفحة 1** **والصفحة 2** في أسفل الصفحة لصفحات تسجيل الدخول المخصصة المكونة من صفحتين.
...
يمكنك إنشاء صفحات تسجيل دخول مخصصة في المواقع التالية:
   ...
   > [!NOTE]
   > الأيقونة " ![إنشاء جديد".](../../media/m365-cc-sc-create-icon.png) يتوفر **إنشاء جديد** أيضا أثناء إنشاء أتمتة الحمولة والحمولة. لمزيد من المعلومات، راجع المواضيع التالية:
   >
   > - [إنشاء حمولات مخصصة لتدريب محاكاة الهجوم في Defender لـ Office 365](attack-simulation-training-payloads.md#create-payloads)
   > - [إنشاء أتمتة الحمولة للتدريب على محاكاة الهجوم](attack-simulation-training-payload-automations.md#create-payload-automations)
   >
