...
> [!NOTE]
>
> بعض الميزات الموضحة في هذه المقالة موجودة في المعاينة، وهي عرضة للتغيير، وغير متوفرة في كافة المؤسسات.
>
> إذا لم يكن لدى مؤسستك ميزات تزييف الهوية كما هو موضح في هذه المقالة، فراجع تجربة إدارة الانتحال القديمة في [إدارة المرسلين المخادعين باستخدام نهج التحليل الذكي المخادعة والرؤى الذكية المنتحلة في EOP](walkthrough-spoof-intelligence-insight.md).
