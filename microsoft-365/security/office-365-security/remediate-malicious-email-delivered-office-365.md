...
نظرا لأن إجراءات البريد الإلكتروني تنشئ تحقيقات تلقائية في الخلفية، فأنت بحاجة إلى تمكين *التحقيق التلقائي*. انتقل إلى **الميزات المتقدمة** **لنقاط** \> النهاية **الإعدادات** \> وقم بتشغيل **التحقيق التلقائي**.
...
يتم عرض جميع المعالجة (الموافقات المباشرة) التي تم إنشاؤها في المستكشف أو التتبع المتقدم أو من خلال التحقيق التلقائي في مركز الصيانة. يمكنك الوصول إليها عبر لوحة التنقل اليمنى ضمن **علامة التبويب** **"إجراءات" &** **"مركز**  ->  إجراءات الإرسال\>".
...
:::image type="content" source="../../media/microsoft-365-defender-action-center-history-panel.png" alt-text="يتم فتح &quot;مركز الصيانة&quot; مع الخيار &quot;نقل إلى علبة الوارد&quot;.":::
