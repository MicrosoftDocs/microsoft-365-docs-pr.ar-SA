...
لمزيد من المعلومات، راجع المقالة الخاصة بهذا الملصق: [إعداد البنية الأساسية للعمل المختلط باستخدام Microsoft 365](empower-people-to-work-remotely.md).
...
[نماذج معمارية لـ SharePoint وExchange وSkype for Business وLync](../enterprise/architectural-models-for-sharepoint-exchange-skype-for-business-and-lync.md)

[دليل مختبر اختبار اعتماد السحابة (TLGs)](../enterprise/cloud-adoption-test-lab-guides-tlgs.md)
