...
- zerotrust-solution
ms.custom: ''
description: حدد لوائح خصوصية البيانات والسيناريوهات ذات الصلة واستعدادك وأنواع المعلومات الحساسة الموجودة في بيئة Microsoft 365.
...
يعد تقييم لوائح خصوصية البيانات والمخاطر التي تخضع لها مؤسستك خطوة أولى قبل تنفيذ أي إجراءات تحسين ذات صلة، بما في ذلك الإجراءات التي يمكن تحقيقها باستخدام ميزات وخدمات Microsoft 365.
...
## <a name="regulation-mapping-to-microsoft-365-technical-control-categories"></a>تعيين اللوائح لفئات التحكم التقني في Microsoft 365
...
كنقطة بداية، من المهم جرد أنواع البيانات الشخصية الموجودة في بيئة Microsoft 365. استخدم هذه الفئات:
...
عادة ما يتم جمع الكثير من البيانات الشخصية التي تخضع لتنظيم خصوصية البيانات وتخزينها خارج Microsoft 365. يجب تصدير أي بيانات شخصية من تطبيقات الويب أو الجوال التي تواجه المستهلك من مثل هذه التطبيقات إلى Microsoft 365 لكي تخضع لفحص خصوصية البيانات داخل Microsoft 365.

قد يكون تعرض خصوصية البيانات في Microsoft 365 أكثر تقييدا بالنسبة إلى تطبيقات الويب وأنظمة CRM، والتي لا يعالجها هذا الحل.
...
على الرغم من أن توصية مجموعة عناصر التحكم القياسية أو المؤسسة الخارجية، مثل من Compliance Manager في Microsoft 365، قد تساعد في إبلاغ استراتيجية التحكم الخاصة بك، يجب أن يكون اختيارك للتنفيذ مدفوعا بالوعي بمخزون البيانات لتحديد مدى تعرضك للمخاطر الحقيقية.
...
تتضمن هذه الخطوة تحديد أنواع معلومات حساسة معينة تخضع لضوابط تنظيمية محددة، بالإضافة إلى حدوثها في بيئة Microsoft 365.
...
- من خلال مدخل توافق Microsoft 365 Purview، كما هو موضح في [مقالة Use Compliance Score و Compliance Manager](information-protection-deploy-compliance.md)
...
أداة مهمة لتحديد حدوث العناصر الحساسة في بيئتك هي [مستكشف المحتوى](../compliance/data-classification-content-explorer.md) الجديد في مركز إدارة Microsoft Purview. إنها أداة تلقائية للمسح الأولي والمستمر لاشتراكك بالكامل في Microsoft 365 لحدوث أنواع المعلومات الحساسة وعرض النتائج.
...
بالإضافة إلى الخطوات الأخرى التي تم تمييزها في هذه المقالة، يوفر هذا نقطة بداية لتحديد التعرض العام للمخاطر، والاستعداد، وموقع العناصر الحساسة للحماية من خلال تكوين ومراقبة Microsoft 365 المخطط لها.
