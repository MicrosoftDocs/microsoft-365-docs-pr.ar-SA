...
توفر هذه المقالة مرجعا للإعدادات المختلفة التي يمكن أن تؤثر على المشاركة مع أشخاص من خارج مؤسستك لأحمال العمل Microsoft 365: Teams مجموعات Microsoft 365 SharePoint OneDrive. توجد هذه الإعدادات في مراكز إدارة Azure Active directory وMicrosoft 365 والفرق وSharePoint.

## <a name="azure-active-directory"></a>Azure Active Directory

**دور المسؤول:** مسؤول عمومي

Azure Active Directory هي خدمة الدليل المستخدمة من قبل Microsoft 365. تؤثر إعدادات العلاقات التنظيمية ل Azure Active Directory مباشرة على المشاركة في Teams مجموعات Microsoft 365 SharePoint OneDrive.

> [!NOTE]
> تؤثر هذه الإعدادات فقط على SharePoint عند تكوين [تكامل SharePoint OneDrive مع Azure AD B2B](/sharepoint/sharepoint-azureb2b-integration-preview). يفترض الجدول أدناه أن هذا قد تم تكوينه.
...
![لقطة شاشة لصفحة الإعدادات العلاقات التنظيمية ل Azure Active Directory.](../media/azure-ad-organizational-relationships-settings.png)

| اعداد | الافتراضي | الوصف |
|:-----|:-----|:-----|
...
|إعدادات دعوة الضيف|يمكن لأي شخص في المؤسسة دعوة المستخدمين الضيوف بما في ذلك الضيوف وغير المسؤولين|تحديد ما إذا كان بإمكان الضيوف والأعضاء والمسؤولين دعوة الضيوف إلى المؤسسة. <p> يؤثر هذا الإعداد على تجارب مشاركة Microsoft 365 مثل Teams SharePoint.|
...
تنطبق الإعدادات الافتراضية على جميع مؤسسات Azure AD الخارجية باستثناء تلك التي لها إعدادات خاصة بالمؤسسة. يمكن تكوين الإعدادات لمؤسسة معينة على علامة التبويب **"إعدادات المؤسسة**". هناك إعدادات منفصلة للضيوف (تعاون B2B) [ومستخدمي الاتصال المباشر ل Azure AD B2B](/azure/active-directory/external-identities/b2b-direct-connect-overview).
...
تتحكم إعدادات الوصول الواردة في ما إذا كان يمكن للمستخدمين من مؤسسات Azure AD الخارجية الوصول إلى الموارد في مؤسستك.

| اعداد | الافتراضي | الوصف |
|:-----|:-----|:-----|
|تعاون B2B - المستخدمون والمجموعات الخارجية|الكل مسموح به|تحديد الأشخاص في مؤسسات Azure AD الأخرى التي يمكن منحها حق الوصول إلى الموارد في مؤسستك كضيوف.|
|تعاون B2B - التطبيقات|الكل مسموح به|تحديد التطبيقات التي يمكن منح ضيوف مؤسستك حق الوصول إليها.|
|الاتصال المباشر B2B - المستخدمون الخارجيون والمجموعات|تم حظر الكل|تحديد ما إذا كان يمكن منح الأشخاص في مؤسسات Azure AD الأخرى حق الوصول إلى الموارد في مؤسستك من خلال الاتصال المباشر B2B.|
...
|إعدادات الثقة|ذوي الاحتياجات الخاصه|تحديد ما إذا كانت نهج الوصول المشروط ستقبل مطالبات من مؤسسات Azure AD الأخرى عند وصول أشخاص من تلك المؤسسات إلى مواردك.|
...
|تعاون B2B - التطبيقات|الكل مسموح به|تحديد التطبيقات في مؤسسات Azure AD الأخرى التي يمكن منح المستخدمين حق الوصول إليها كضيوف.|
|الاتصال المباشر B2B - المستخدمون الخارجيون والمجموعات|تم حظر الكل|تحديد المستخدمين في مؤسستك الذين يمكن منحهم حق الوصول إلى الموارد في مؤسسات Azure AD الأخرى من خلال الاتصال المباشر B2B.|
|الاتصال المباشر B2B - التطبيقات|تم حظر الكل|تحديد التطبيقات في مؤسسات Azure AD الأخرى التي يمكن منح المستخدمين حق الوصول إليها من خلال الاتصال المباشر B2B.|
...
**التنقل:** [مركز مسؤولي Microsoft 365](https://admin.microsoft.com) >  **الإعدادات** >  **مراجع إعدادات** >  <a href="https://go.microsoft.com/fwlink/p/?linkid=2072756" target="_blank">**الأمان &** المشاركة في علامات تبويب</a> >  **الخصوصية**.
...
| اعداد | الافتراضي | الوصف |
|:-----|:-----|:-----|
|السماح للمستخدمين بإضافة ضيوف جدد إلى المؤسسة|في|عند التعيين إلى **"نعم**"، يمكن لأعضاء Azure AD دعوة الضيوف عبر Azure AD؛ عند التعيين إلى **"لا"**، لا يمكنهم ذلك. عند التعيين إلى **"نعم"**، يمكن لأعضاء المجموعة Microsoft 365 دعوة الضيوف بموافقة المالك؛ وعند التعيين إلى **"لا"**، يمكن لأعضاء المجموعة Microsoft 365 دعوة الضيوف بموافقة المالك ولكن يجب أن يكون المالكون مسؤولين عموميين للموافقة. <p> لاحظ أن **الأعضاء الذين يمكنهم الدعوة** يشيرون إلى الأعضاء في Azure AD (بدلا من الضيوف) وليس إلى أعضاء الموقع أو المجموعة في Microsoft 365. <p> هذا مطابق لإعداد **دعوة الأعضاء** في إعدادات علاقات Azure Active Directory Organizational.|

### <a name="microsoft-365-groups"></a>مجموعات Microsoft 365

**التنقل:** [إعدادات مركز مسؤولي Microsoft 365](https://admin.microsoft.com) >  **الإعدادات** >  **Org** > مجموعات Microsoft 365
...
يجب أن يكون مفتاح Teams الرئيسي للوصول إلى الضيف، **السماح بوصول الضيف في Teams**، **قيد التشغيل** حتى تتوفر إعدادات الضيف الأخرى.

**دور المسؤول:** مسؤول خدمة Teams

### <a name="guest-access"></a>وصول الضيف

**التنقل:** [الوصول إلى Teams admin](https://admin.teams.microsoft.com) **centerOrg-wide** >  <a href="https://go.microsoft.com/fwlink/p/?linkid=2173122" target="_blank">**SettingsGuest**</a> > 

![Screenshot of Teams guest access toggle.](../media/teams-guest-access-toggle.png)

| اعداد | الافتراضي | الوصف |
|:-----|:-----|:-----|
|السماح بوصول الضيف في Teams|في|تشغيل وصول الضيف أو إيقاف تشغيله Teams بشكل عام. قد يستغرق تطبيق هذا الإعداد 24 ساعة بمجرد تغييره.|
...
| اعداد | الافتراضي | الوصف |
|:-----|:-----|:-----|
|إجراء مكالمات خاصة|في|عند **التشغيل**، يمكن للضيوف إجراء مكالمات نظير إلى نظير في Teams؛ عند **إيقاف التشغيل**، لا يمكنهم إجراء ذلك.|

### <a name="guest-meeting"></a>اجتماع الضيف

**التنقل:** [الوصول إلى Teams admin](https://admin.teams.microsoft.com) **centerOrg-wide** >  <a href="https://go.microsoft.com/fwlink/p/?linkid=2173122" target="_blank">**SettingsGuest**</a> > 

![لقطة شاشة لإعدادات اجتماع الضيف Teams.](../media/teams-guest-meeting-settings.png)
...
![لقطة شاشة لإعدادات مراسلة الضيف Teams.](../media/teams-guest-messaging-settings.png)
...
**دور المسؤول:** مسؤول SharePoint

تؤثر هذه الإعدادات على كافة المواقع في المؤسسة. لا تؤثر على مجموعات Microsoft 365 أو Teams مباشرة، ومع ذلك نوصي بمحاذاة هذه الإعدادات مع إعدادات مجموعات Microsoft 365 Teams لتجنب مشاكل تجربة المستخدم. (على سبيل المثال، إذا تم السماح بمشاركة الضيف في Teams ولكن ليس SharePoint، فلن يتمكن الضيوف في Teams من الوصول إلى علامة التبويب "ملفات" لأنه يتم تخزين ملفات Teams في SharePoint.)

### <a name="sharepoint-and-onedrive-sharing-settings"></a>إعدادات مشاركة SharePoint OneDrive

نظرا لأن OneDrive عبارة عن تسلسل هرمي للمواقع داخل SharePoint، تؤثر إعدادات المشاركة على مستوى المؤسسة بشكل مباشر على OneDrive تماما كما تؤثر على مواقع SharePoint الأخرى.

**التنقل:** مركز إدارة SharePoint > <a href="https://go.microsoft.com/fwlink/?linkid=2185222" target="_blank">**المشاركة في**</a> **النهج** > 

![لقطة شاشة لإعدادات المشاركة على مستوى المؤسسة SharePoint.](../media/external-sharing.png)
...
### <a name="sharepoint-and-onedrive-advanced-sharing-settings"></a>SharePoint وإعدادات المشاركة المتقدمة OneDrive

**التنقل:** مركز إدارة SharePoint > <a href="https://go.microsoft.com/fwlink/?linkid=2185222" target="_blank">**المشاركة في**</a> **النهج** > 

![لقطة شاشة لإعدادات مشاركة إضافية على مستوى المؤسسة SharePoint.](../media/external-sharing.png)

| اعداد | الافتراضي | الوصف |
|:-----|:-----|:-----|
|تقييد المشاركة الخارجية حسب المجال|قباله|يسمح لك هذا الإعداد بتحديد قائمة بالمجالات المسموح بها أو المحظورة للمشاركة. عند تحديد المجالات المسموح بها، يمكن إرسال دعوات المشاركة إلى تلك المجالات فقط. عند تحديد المجالات التي تم رفضها، لا يمكن إرسال دعوات المشاركة إلى تلك المجالات. <p> يؤثر هذا الإعداد على كافة مواقع SharePoint والمواقع OneDrive في المؤسسة.|
|السماح فقط للمستخدمين في مجموعات أمان معينة بالمشاركة خارجيا|قباله|إذا كنت تريد تحديد الأشخاص الذين يمكنهم المشاركة مع الضيوف في SharePoint OneDrive، يمكنك القيام بذلك عن طريق قصر المشاركة على الأشخاص في مجموعات الأمان المحددة. لا تؤثر هذه الإعدادات على المشاركة عبر مجموعات Microsoft 365 أو Teams. يمكن للضيوف المدعوين عبر مجموعة أو فريق أيضا الوصول إلى الموقع المقترن، على الرغم من أنه لا يمكن مشاركة المستندات والمجلدات إلا من قبل الأشخاص في مجموعات الأمان المحددة. <p> لكل مجموعة محددة، يمكنك اختيار أي من هؤلاء المستخدمين يمكنه المشاركة مع ارتباطات "أي شخص".|
|يجب على الضيوف تسجيل الدخول باستخدام الحساب نفسه الذي يتم إرسال دعوات المشاركة إليه|قباله|يمنع الضيوف من استرداد دعوات مشاركة الموقع باستخدام عنوان بريد إلكتروني مختلف عن الدعوة التي تم إرسال الدعوة إليها. <p> لا يستخدم [SharePoint والتكامل OneDrive مع Azure AD B2B (معاينة)](/sharepoint/sharepoint-azureb2b-integration-preview) هذا الإعداد لأنه تتم إضافة جميع الضيوف إلى الدليل استنادا إلى عنوان البريد الإلكتروني الذي تم إرسال الدعوة إليه. لا يمكن استخدام عناوين البريد الإلكتروني البديلة للوصول إلى الموقع.|
...
### <a name="sharepoint-and-onedrive-file-and-folder-link-settings"></a>SharePoint وإعدادات ارتباطات الملفات والمجلدات OneDrive

عندما تتم مشاركة الملفات والمجلدات في SharePoint OneDrive، يتم إرسال ارتباط إلى المستلمين المشاركين مع أذونات للملف أو المجلد بدلا من منحهم حق الوصول المباشر إلى الملف أو المجلد بأنفسهم. تتوفر عدة أنواع من الارتباطات، ويمكنك اختيار نوع الارتباط الافتراضي المقدم للمستخدمين عند مشاركة ملف أو مجلد. يمكنك أيضا تعيين الأذونات وخيارات انتهاء الصلاحية لارتباطات *أي شخص* .

**التنقل:** مركز إدارة SharePoint > <a href="https://go.microsoft.com/fwlink/?linkid=2185222" target="_blank">**المشاركة في**</a> **النهج** > 

![لقطة شاشة SharePoint إعدادات مشاركة الملفات والمجلدات على مستوى المؤسسة.](../media/sharepoint-organization-files-folders-sharing-settings.png)
...
| اعداد | الافتراضي | الوصف |
|:-----|:-----|:-----|
|يمكن مشاركة محتوى الموقع مع|يختلف حسب نوع الموقع (راجع الجدول أدناه)|يشير إلى نوع المشاركة الخارجية المسموح بها لهذا الموقع. تخضع الخيارات المتوفرة هنا لإعدادات المشاركة على مستوى المؤسسة SharePoint.|
...
![لقطة شاشة SharePoint إعدادات مشاركة الارتباط على مستوى الموقع.](../media/sharepoint-site-link-sharing-settings.png)
...
[نظرة عامة على SharePoint والمشاركة الخارجية OneDrive](/sharepoint/external-sharing-overview)
