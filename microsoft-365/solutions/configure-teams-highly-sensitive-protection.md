---
title: تكوين الفرق مع حماية البيانات شديدة الحساسية
f1.keywords: NOCSH
ms.author: mikeplum
...
description: تعرف على كيفية نشر الفرق مع حماية البيانات شديدة الحساسية.
ms.openlocfilehash: b104828f5437b9389e83379984a40edf33340f33
ms.sourcegitcommit: 52eea2b65c0598ba4a1b930c58b42dbe62cdaadc
ms.translationtype: MT
ms.contentlocale: ar-SA
ms.lasthandoff: 04/19/2022
ms.locfileid: "64947550"
---
# <a name="configure-teams-with-protection-for-highly-sensitive-data"></a>تكوين الفرق مع حماية البيانات شديدة الحساسية

في هذه المقالة، ننظر في إعداد فريق لمستوى حماية حساس للغاية. تأكد من إكمال الخطوات في [نشر الفرق باستخدام الحماية الأساسية](configure-teams-baseline-protection.md) قبل اتباع الخطوات الواردة في هذه المقالة.

لهذا المستوى من الحماية، نقوم بإنشاء وصف الحساسية الذي يمكن استخدامه عبر مؤسستك للفرق والملفات شديدة الحساسية. لن يتمكن سوى أعضاء مؤسستك والضيوف الذين حددتهم من فك تشفير الملفات التي تستخدم هذه التسمية. إذا كنت بحاجة إلى المزيد من عزل الأذونات بحيث يمكن لأعضاء فريق معين فقط فك تشفير الملفات، فراجع  [نشر فريق مع عزل الأمان](secure-teams-security-isolation.md).

يوفر المستوى الحساس للغاية الحماية الإضافية التالية على المستوى الأساسي:

- وصف الحساسية للفريق الذي يسمح لك بتشغيل مشاركة الضيف أو إيقاف تشغيلها ويحظر الوصول إلى محتوى SharePoint للأجهزة غير المدارة. يمكن أيضا استخدام هذه التسمية لتصنيف الملفات وتشفيرها.
- نوع ارتباط مشاركة افتراضي أكثر تقييدا
- يمكن لمالكي الفريق فقط إنشاء قنوات خاصة.
- تم إيقاف تشغيل طلبات الوصول إلى موقع SharePoint المقترن.
...
استنادا إلى طبيعة عملك، قد ترغب أو لا ترغب في تمكين مشاركة الضيف للفرق التي تحتوي على بيانات حساسة للغاية. إذا كنت تخطط للتعاون مع أشخاص من خارج مؤسستك في الفريق، نوصي بتمكين مشاركة الضيف. تتضمن Microsoft 365 مجموعة متنوعة من ميزات الأمان والتوافق لمساعدتك على مشاركة المحتوى الحساس بشكل آمن. يعد هذا الخيار بشكل عام أكثر أمانا من إرسال المحتوى عبر البريد الإلكتروني مباشرة إلى أشخاص من خارج مؤسستك.
...
بالنسبة لمستوى الحماية الحساس للغاية، سنستخدم وصف الحساسية لتصنيف الفريق. يمكن أيضا استخدام هذه التسمية لتصنيف الملفات الفردية وتشفيرها في هذه الفرق أو في مواقع ملفات أخرى مثل SharePoint أو OneDrive. 
...
4. امنح التسمية اسما. نقترح **أن تكون حساسة للغاية**، ولكن يمكنك اختيار اسم مختلف إذا كان هذا الاسم قيد الاستخدام بالفعل.
...
7. في صفحة **"اختيار إعدادات الحماية للملفات ورسائل البريد الإلكتروني** "، حدد **"تشفير الملفات ورسائل البريد الإلكتروني**"، ثم انقر فوق **"التالي**".
8. في صفحة **التشفير** ، اختر **تكوين إعدادات التشفير**.
9. ضمن **تعيين أذونات لمستخدمين ومجموعات معينة**، انقر فوق **"تعيين أذونات**".
10. انقر فوق **"إضافة كافة المستخدمين والمجموعات في مؤسستك**".
11. إذا كان هناك ضيوف يجب أن يتوفر لديهم أذونات لفك تشفير الملفات، فانقر فوق **"إضافة مستخدمين أو مجموعات** " وأضفهم.
12.  انقر فوق **"حفظ"**، ثم انقر فوق **"التالي**".
13. في الصفحة *"تسمية تلقائية للملفات ورسائل البريد الإلكتروني**"، انقر فوق **"التالي**".
14. في صفحة **"تعريف إعدادات الحماية للمجموعات والمواقع** "، حدد **إعدادات الخصوصية والوصول إلى المستخدم الخارجي** **والوصول إلى الجهاز وإعدادات المشاركة الخارجية** وانقر فوق **"التالي**".
15. في صفحة **"تعريف الخصوصية" وإعدادات وصول المستخدم الخارجي** ، ضمن **"الخصوصية**"، حدد الخيار **"خاص** ".
16. إذا كنت تريد السماح بوصول الضيف، ضمن **وصول المستخدم الخارجي**، فحدد **السماح لمالكي المجموعة Microsoft 365 بإضافة أشخاص من خارج مؤسستك إلى المجموعة كضيوف**.
17. انقر فوق **التالي**.
18. في الصفحة **"تعريف المشاركة الخارجية وإعدادات الوصول إلى الجهاز**"، حدد **"التحكم في المشاركة الخارجية" من مواقع SharePoint المسماة**.
19. ضمن **"المحتوى" يمكن مشاركته،** اختر **ضيوفا جددا وموجودين** إذا كنت تسمح بوصول الضيف أو **الأشخاص الموجودين في مؤسستك فقط** إذا لم يكن الأمر متوفرا.
20. ضمن **Access من الأجهزة غير المدارة**، اختر **"حظر الوصول**". (إذا كنت تسمح للضيوف ولم يكن لديهم أجهزة مدارة، فقد ترغب في اختيار **السماح بالوصول المحدود على الويب فقط**.)
21. انقر فوق **التالي**.
...
يتم إجراء تكوين إضافي للسيناريو عالي الحساسية في موقع SharePoint المقترن بالفريق، لذا فإن الخطوة التالية هي إنشاء فريق.
...
4. في قائمة **الحساسية** ، اختر التسمية **شديدة الحساسية** التي قمت بإنشائها للتو.
...
لا تحتوي [القنوات المشتركة](/MicrosoftTeams/shared-channels) على إعدادات على مستوى الفريق. ستتوفر إعدادات القناة المشتركة التي تقوم بتكوينها في مركز إدارة Teams وAzure AD لجميع الفرق بغض النظر عن الحساسية.

## <a name="sharepoint-settings"></a>إعدادات SharePoint

في كل مرة تقوم فيها بإنشاء فريق جديد باستخدام التسمية شديدة الحساسية، هناك خطوتان للقيام بذلك في SharePoint:

- قم بتحديث إعدادات مشاركة الضيف للموقع في مركز إدارة SharePoint لتحديث ارتباط المشاركة الافتراضي إلى *الأشخاص الذين تتوفر لهم إمكانية الوصول الموجودة*.
...
6. ضمن **"أذونات المشاركة"**، اختر **فقط مالكي الموقع الذين يمكنهم مشاركة الملفات والمجلدات والموقع**.
